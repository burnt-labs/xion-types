...
enum Ibc_Core_Channel_V2_PacketStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Ibc_Core_Channel_V2_PacketStatus] = [
    .unspecified,
    .success,
    .failure,
    .async,
...
struct Ibc_Core_Channel_V2_Packet: Sendable {
...
struct Ibc_Core_Channel_V2_Payload: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Ibc_Core_Channel_V2_Acknowledgement: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Ibc_Core_Channel_V2_RecvPacketResult: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
