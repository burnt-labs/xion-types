...
struct Feeabstraction_Feeabs_V1beta1_EpochInfo: Sendable {
...
struct Feeabstraction_Feeabs_V1beta1_ExponentialBackoff: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Feeabstraction_Feeabs_V1beta1_EpochInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Feeabstraction_Feeabs_V1beta1_EpochInfo, rhs: Feeabstraction_Feeabs_V1beta1_EpochInfo) -> Bool {
...
extension Feeabstraction_Feeabs_V1beta1_ExponentialBackoff: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".ExponentialBackoff"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "jump"),
    2: .standard(proto: "future_epoch"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.jump) }()
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.futureEpoch) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.jump != 0 {
      try visitor.visitSingularInt64Field(value: self.jump, fieldNumber: 1)
    }
    if self.futureEpoch != 0 {
      try visitor.visitSingularInt64Field(value: self.futureEpoch, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Feeabstraction_Feeabs_V1beta1_ExponentialBackoff, rhs: Feeabstraction_Feeabs_V1beta1_ExponentialBackoff) -> Bool {
    if lhs.jump != rhs.jump {return false}
    if lhs.futureEpoch != rhs.futureEpoch {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
