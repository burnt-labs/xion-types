...
struct Xion_Indexer_Feegrant_V1_QueryAllowanceRequest: Sendable {
...
/// method.
struct Xion_Indexer_Feegrant_V1_QueryAllowanceResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// method.
struct Xion_Indexer_Feegrant_V1_QueryAllowancesRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// method.
struct Xion_Indexer_Feegrant_V1_QueryAllowancesResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Xion_Indexer_Feegrant_V1_QueryAllowancesByGranterRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Query/AllowancesByGranter RPC method.
struct Xion_Indexer_Feegrant_V1_QueryAllowancesByGranterResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "xion.indexer.feegrant.v1"

extension Xion_Indexer_Feegrant_V1_QueryAllowanceRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Xion_Indexer_Feegrant_V1_QueryAllowanceRequest, rhs: Xion_Indexer_Feegrant_V1_QueryAllowanceRequest) -> Bool {
...
extension Xion_Indexer_Feegrant_V1_QueryAllowanceResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Xion_Indexer_Feegrant_V1_QueryAllowanceResponse, rhs: Xion_Indexer_Feegrant_V1_QueryAllowanceResponse) -> Bool {
...
extension Xion_Indexer_Feegrant_V1_QueryAllowancesRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Xion_Indexer_Feegrant_V1_QueryAllowancesRequest, rhs: Xion_Indexer_Feegrant_V1_QueryAllowancesRequest) -> Bool {
    if lhs.grantee != rhs.grantee {return false}
...
extension Xion_Indexer_Feegrant_V1_QueryAllowancesResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Xion_Indexer_Feegrant_V1_QueryAllowancesResponse, rhs: Xion_Indexer_Feegrant_V1_QueryAllowancesResponse) -> Bool {
...
extension Xion_Indexer_Feegrant_V1_QueryAllowancesByGranterRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Xion_Indexer_Feegrant_V1_QueryAllowancesByGranterRequest, rhs: Xion_Indexer_Feegrant_V1_QueryAllowancesByGranterRequest) -> Bool {
    if lhs.granter != rhs.granter {return false}
    if lhs._pagination != rhs._pagination {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Xion_Indexer_Feegrant_V1_QueryAllowancesByGranterResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Xion_Indexer_Feegrant_V1_QueryAllowancesByGranterResponse, rhs: Xion_Indexer_Feegrant_V1_QueryAllowancesByGranterResponse) -> Bool {
    if lhs.allowances != rhs.allowances {return false}
    if lhs._pagination != rhs._pagination {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
