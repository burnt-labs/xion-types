...
struct Xion_Feeabs_V1beta1_GenesisState: Sendable {
  ...
  var epochs: [Xion_Feeabs_V1beta1_EpochInfo] = []
...
extension Xion_Feeabs_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Xion_Feeabs_V1beta1_GenesisState, rhs: Xion_Feeabs_V1beta1_GenesisState) -> Bool {
