...
struct Xion_Feeabs_V1beta1_EpochInfo: Sendable {
...
struct Xion_Feeabs_V1beta1_ExponentialBackoff: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Xion_Feeabs_V1beta1_EpochInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Xion_Feeabs_V1beta1_EpochInfo, rhs: Xion_Feeabs_V1beta1_EpochInfo) -> Bool {
...
extension Xion_Feeabs_V1beta1_ExponentialBackoff: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Xion_Feeabs_V1beta1_ExponentialBackoff, rhs: Xion_Feeabs_V1beta1_ExponentialBackoff) -> Bool {
