...
extension Cosmos_Autocli_V1_ServiceCommandDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularStringField(value: &self.short) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.short.isEmpty {
      try visitor.visitSingularStringField(value: self.short, fieldNumber: 5)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
...
extension Cosmos_Autocli_V1_RpcCommandOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    12: .same(proto: "skip"),
    13: .standard(proto: "gov_proposal"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 13: try { try decoder.decodeSingularBoolField(value: &self.govProposal) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.govProposal != false {
      try visitor.visitSingularBoolField(value: self.govProposal, fieldNumber: 13)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Cosmos_Autocli_V1_RpcCommandOptions, rhs: Cosmos_Autocli_V1_RpcCommandOptions) -> Bool {
    ...
    if lhs.govProposal != rhs.govProposal {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
