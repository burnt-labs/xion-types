...
struct Osmosis_Tokenfactory_V1beta1_QueryParamsRequest: Sendable {
...
struct Osmosis_Tokenfactory_V1beta1_QueryParamsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Osmosis_Tokenfactory_V1beta1_QueryDenomAuthorityMetadataRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// DenomAuthorityMetadata gRPC query.
struct Osmosis_Tokenfactory_V1beta1_QueryDenomAuthorityMetadataResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Osmosis_Tokenfactory_V1beta1_QueryDenomsFromCreatorRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// DenomsFromCreator gRPC query.
struct Osmosis_Tokenfactory_V1beta1_QueryDenomsFromCreatorResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Osmosis_Tokenfactory_V1beta1_QueryDenomsFromAdminRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// DenomsFromAdmin gRPC query.
struct Osmosis_Tokenfactory_V1beta1_QueryDenomsFromAdminResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Osmosis_Tokenfactory_V1beta1_QueryDenomsFromAdminRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryDenomsFromAdminRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "admin"),
  ]
  ...
  static func ==(lhs: Osmosis_Tokenfactory_V1beta1_QueryDenomsFromAdminRequest, rhs: Osmosis_Tokenfactory_V1beta1_QueryDenomsFromAdminRequest) -> Bool {
...
extension Osmosis_Tokenfactory_V1beta1_QueryDenomsFromAdminResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".QueryDenomsFromAdminResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "denoms"),
  ]
  ...
  static func ==(lhs: Osmosis_Tokenfactory_V1beta1_QueryDenomsFromAdminResponse, rhs: Osmosis_Tokenfactory_V1beta1_QueryDenomsFromAdminResponse) -> Bool {
    if lhs.denoms != rhs.denoms {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
