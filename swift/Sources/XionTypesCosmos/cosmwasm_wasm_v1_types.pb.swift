...
extension Cosmwasm_Wasm_V1_ContractInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 8: try { try decoder.decodeSingularStringField(value: &self.ibc2PortID) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.ibc2PortID.isEmpty {
      try visitor.visitSingularStringField(value: self.ibc2PortID, fieldNumber: 8)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
