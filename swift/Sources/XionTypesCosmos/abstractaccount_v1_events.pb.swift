...
struct Abstractaccount_V1_EventAccountRegistered: Sendable {
...
extension Abstractaccount_V1_EventAccountRegistered: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".EventAccountRegistered"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "creator"),
    2: .standard(proto: "code_id"),
    3: .standard(proto: "contract_addr"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.contractAddr) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.contractAddr.isEmpty {
      try visitor.visitSingularStringField(value: self.contractAddr, fieldNumber: 3)
    }
  ...
  static func ==(lhs: Abstractaccount_V1_EventAccountRegistered, rhs: Abstractaccount_V1_EventAccountRegistered) -> Bool {
