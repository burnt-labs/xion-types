...
struct Cosmos_Base_Tendermint_V1beta1_GetSyncingResponse: Sendable {
  ...
  var earliestBlockHeight: Int64 = 0
...
struct Cosmos_Base_Tendermint_V1beta1_GetBlockResultsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cosmos_Base_Tendermint_V1beta1_GetLatestBlockResultsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cosmos_Base_Tendermint_V1beta1_GetBlockResultsResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var txsResults: [Tendermint_Abci_ExecTxResult] = []
  ...
  var finalizeBlockEvents: [Tendermint_Abci_Event] = []
...
struct Cosmos_Base_Tendermint_V1beta1_GetLatestBlockResultsResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmos_Base_Tendermint_V1beta1_GetSyncingResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    2: .standard(proto: "earliest_block_height"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularInt64Field(value: &self.earliestBlockHeight) }()
      case 3: try { try decoder.decodeSingularInt64Field(value: &self.latestBlockHeight) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.earliestBlockHeight != 0 {
      try visitor.visitSingularInt64Field(value: self.earliestBlockHeight, fieldNumber: 2)
    }
    if self.latestBlockHeight != 0 {
      try visitor.visitSingularInt64Field(value: self.latestBlockHeight, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Cosmos_Base_Tendermint_V1beta1_GetSyncingResponse, rhs: Cosmos_Base_Tendermint_V1beta1_GetSyncingResponse) -> Bool {
    ...
    if lhs.earliestBlockHeight != rhs.earliestBlockHeight {return false}
...
extension Cosmos_Base_Tendermint_V1beta1_GetBlockResultsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetBlockResultsRequest"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "height"),
  ]
  ...
  static func ==(lhs: Cosmos_Base_Tendermint_V1beta1_GetBlockResultsRequest, rhs: Cosmos_Base_Tendermint_V1beta1_GetBlockResultsRequest) -> Bool {
    if lhs.height != rhs.height {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Cosmos_Base_Tendermint_V1beta1_GetLatestBlockResultsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetLatestBlockResultsRequest"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  static func ==(lhs: Cosmos_Base_Tendermint_V1beta1_GetLatestBlockResultsRequest, rhs: Cosmos_Base_Tendermint_V1beta1_GetLatestBlockResultsRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension Cosmos_Base_Tendermint_V1beta1_GetBlockResultsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetBlockResultsResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "height"),
    2: .standard(proto: "txs_results"),
    3: .standard(proto: "finalize_block_events"),
    4: .standard(proto: "validator_updates"),
    5: .standard(proto: "consensus_param_updates"),
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.height) }()
      case 2: try { try decoder.decodeRepeatedMessageField(value: &self.txsResults) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.finalizeBlockEvents) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.validatorUpdates) }()
      case 5: try { try decoder.decodeSingularMessageField(value: &self._consensusParamUpdates) }()
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.txsResults.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.txsResults, fieldNumber: 2)
    }
    if !self.finalizeBlockEvents.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.finalizeBlockEvents, fieldNumber: 3)
    }
    if !self.validatorUpdates.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.validatorUpdates, fieldNumber: 4)
    }
  ...
  static func ==(lhs: Cosmos_Base_Tendermint_V1beta1_GetBlockResultsResponse, rhs: Cosmos_Base_Tendermint_V1beta1_GetBlockResultsResponse) -> Bool {
    if lhs.height != rhs.height {return false}
    if lhs.txsResults != rhs.txsResults {return false}
    if lhs.finalizeBlockEvents != rhs.finalizeBlockEvents {return false}
...
extension Cosmos_Base_Tendermint_V1beta1_GetLatestBlockResultsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GetLatestBlockResultsResponse"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "height"),
    2: .standard(proto: "txs_results"),
    3: .standard(proto: "finalize_block_events"),
  ...
  static func ==(lhs: Cosmos_Base_Tendermint_V1beta1_GetLatestBlockResultsResponse, rhs: Cosmos_Base_Tendermint_V1beta1_GetLatestBlockResultsResponse) -> Bool {
    if lhs.height != rhs.height {return false}
    if lhs.txsResults != rhs.txsResults {return false}
    if lhs.finalizeBlockEvents != rhs.finalizeBlockEvents {return false}
    if lhs.validatorUpdates != rhs.validatorUpdates {return false}
