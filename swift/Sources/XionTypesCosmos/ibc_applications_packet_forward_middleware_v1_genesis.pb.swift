...
struct Ibc_Applications_PacketForwardMiddleware_V1_GenesisState: Sendable {
  ...
  var inFlightPackets: Dictionary<String,Ibc_Applications_PacketForwardMiddleware_V1_InFlightPacket> = [:]
...
struct Ibc_Applications_PacketForwardMiddleware_V1_InFlightPacket: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
fileprivate let _protobuf_package = "ibc.applications.packet_forward_middleware.v1"

extension Ibc_Applications_PacketForwardMiddleware_V1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 2: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Ibc_Applications_PacketForwardMiddleware_V1_InFlightPacket>.self, value: &self.inFlightPackets) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.inFlightPackets.isEmpty {
      try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Ibc_Applications_PacketForwardMiddleware_V1_InFlightPacket>.self, value: self.inFlightPackets, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: Ibc_Applications_PacketForwardMiddleware_V1_GenesisState, rhs: Ibc_Applications_PacketForwardMiddleware_V1_GenesisState) -> Bool {
...
extension Ibc_Applications_PacketForwardMiddleware_V1_InFlightPacket: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Ibc_Applications_PacketForwardMiddleware_V1_InFlightPacket, rhs: Ibc_Applications_PacketForwardMiddleware_V1_InFlightPacket) -> Bool {
