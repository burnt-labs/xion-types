...
#import "cosmos/genutil/v1beta1/Genesis.pbobjc.h"
...
@dynamic genTxsArray, genTxsArray_Count;

typedef struct GenesisState__storage_ {
  uint32_t _has_storage_[1];
  NSMutableArray *genTxsArray;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = GenesisState_FieldNumber_GenTxsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GenesisState__storage_, genTxsArray),
