...
#import "cosmos/authz/v1beta1/Genesis.pbobjc.h"
...
@dynamic authorizationArray, authorizationArray_Count;

typedef struct GenesisState__storage_ {
  uint32_t _has_storage_[1];
  NSMutableArray *authorizationArray;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "authorizationArray",
        .dataTypeSpecific.clazz = GPBObjCClass(GrantAuthorization),
        .number = GenesisState_FieldNumber_AuthorizationArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GenesisState__storage_, authorizationArray),
