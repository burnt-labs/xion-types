...
#import "cosmos/tx/config/v1/Config.pbobjc.h"
...
@dynamic skipAnteHandler;
@dynamic skipPostHandler;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "skipAnteHandler",
        .dataTypeSpecific.clazz = Nil,
        .number = Config_FieldNumber_SkipAnteHandler,
        .hasIndex = 0,
      ...
      {
        .name = "skipPostHandler",
        .dataTypeSpecific.clazz = Nil,
        .number = Config_FieldNumber_SkipPostHandler,
        .hasIndex = 2,
