...
#import "cosmos/group/module/v1/Module.pbobjc.h"
...
@dynamic hasMaxExecutionPeriod, maxExecutionPeriod;
@dynamic maxMetadataLen;

typedef struct Module__storage_ {
  uint32_t _has_storage_[1];
  GPBDuration *maxExecutionPeriod;
  uint64_t maxMetadataLen;
} Module__storage_;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "maxExecutionPeriod",
        .dataTypeSpecific.clazz = GPBObjCClass(GPBDuration),
        .number = Module_FieldNumber_MaxExecutionPeriod,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(Module__storage_, maxExecutionPeriod),
      ...
      },
      {
        ...
        .number = Module_FieldNumber_MaxMetadataLen,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(Module__storage_, maxMetadataLen),
