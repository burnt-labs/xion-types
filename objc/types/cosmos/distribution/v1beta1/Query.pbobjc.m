...
GPBObjCClassDeclaration(QueryDelegatorStartingInfoRequest);
GPBObjCClassDeclaration(QueryDelegatorStartingInfoResponse);
...
GPBObjCClassDeclaration(QueryValidatorCurrentRewardsRequest);
GPBObjCClassDeclaration(QueryValidatorCurrentRewardsResponse);
...
GPBObjCClassDeclaration(QueryValidatorHistoricalRewardsRequest);
GPBObjCClassDeclaration(QueryValidatorHistoricalRewardsResponse);
...
@implementation QueryValidatorHistoricalRewardsRequest

@dynamic validatorAddress;
@dynamic period;

typedef struct QueryValidatorHistoricalRewardsRequest__storage_ {
  uint32_t _has_storage_[1];
  NSString *validatorAddress;
  uint64_t period;
} QueryValidatorHistoricalRewardsRequest__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "validatorAddress",
        .dataTypeSpecific.clazz = Nil,
        .number = QueryValidatorHistoricalRewardsRequest_FieldNumber_ValidatorAddress,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(QueryValidatorHistoricalRewardsRequest__storage_, validatorAddress),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
      {
        .name = "period",
        .dataTypeSpecific.clazz = Nil,
        .number = QueryValidatorHistoricalRewardsRequest_FieldNumber_Period,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(QueryValidatorHistoricalRewardsRequest__storage_, period),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeUInt64,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(QueryValidatorHistoricalRewardsRequest)
                                   messageName:@"QueryValidatorHistoricalRewardsRequest"
                               fileDescription:&QueryRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(QueryValidatorHistoricalRewardsRequest__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
...
@implementation QueryValidatorHistoricalRewardsResponse

@dynamic hasRewards, rewards;

typedef struct QueryValidatorHistoricalRewardsResponse__storage_ {
  uint32_t _has_storage_[1];
  ValidatorHistoricalRewards *rewards;
} QueryValidatorHistoricalRewardsResponse__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = QueryValidatorHistoricalRewardsResponse_FieldNumber_Rewards,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(QueryValidatorHistoricalRewardsResponse__storage_, rewards),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(QueryValidatorHistoricalRewardsResponse)
                                   messageName:@"QueryValidatorHistoricalRewardsResponse"
                               fileDescription:&QueryRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(QueryValidatorHistoricalRewardsResponse__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
...
@implementation QueryValidatorCurrentRewardsRequest

@dynamic validatorAddress;

typedef struct QueryValidatorCurrentRewardsRequest__storage_ {
  uint32_t _has_storage_[1];
  NSString *validatorAddress;
} QueryValidatorCurrentRewardsRequest__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "validatorAddress",
        .dataTypeSpecific.clazz = Nil,
        .number = QueryValidatorCurrentRewardsRequest_FieldNumber_ValidatorAddress,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(QueryValidatorCurrentRewardsRequest__storage_, validatorAddress),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(QueryValidatorCurrentRewardsRequest)
                                   messageName:@"QueryValidatorCurrentRewardsRequest"
                               fileDescription:&QueryRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(QueryValidatorCurrentRewardsRequest__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
...
@implementation QueryValidatorCurrentRewardsResponse

@dynamic hasRewards, rewards;

typedef struct QueryValidatorCurrentRewardsResponse__storage_ {
  uint32_t _has_storage_[1];
  ValidatorCurrentRewards *rewards;
} QueryValidatorCurrentRewardsResponse__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = QueryValidatorCurrentRewardsResponse_FieldNumber_Rewards,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(QueryValidatorCurrentRewardsResponse__storage_, rewards),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(QueryValidatorCurrentRewardsResponse)
                                   messageName:@"QueryValidatorCurrentRewardsResponse"
                               fileDescription:&QueryRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(QueryValidatorCurrentRewardsResponse__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
...
@implementation QueryDelegatorStartingInfoRequest

@dynamic delegatorAddress;
@dynamic validatorAddress;

typedef struct QueryDelegatorStartingInfoRequest__storage_ {
  uint32_t _has_storage_[1];
  NSString *delegatorAddress;
  NSString *validatorAddress;
} QueryDelegatorStartingInfoRequest__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "delegatorAddress",
        .dataTypeSpecific.clazz = Nil,
        .number = QueryDelegatorStartingInfoRequest_FieldNumber_DelegatorAddress,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(QueryDelegatorStartingInfoRequest__storage_, delegatorAddress),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
      {
        .name = "validatorAddress",
        .dataTypeSpecific.clazz = Nil,
        .number = QueryDelegatorStartingInfoRequest_FieldNumber_ValidatorAddress,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(QueryDelegatorStartingInfoRequest__storage_, validatorAddress),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(QueryDelegatorStartingInfoRequest)
                                   messageName:@"QueryDelegatorStartingInfoRequest"
                               fileDescription:&QueryRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(QueryDelegatorStartingInfoRequest__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
...
@implementation QueryDelegatorStartingInfoResponse

@dynamic hasStartingInfo, startingInfo;

typedef struct QueryDelegatorStartingInfoResponse__storage_ {
  uint32_t _has_storage_[1];
  DelegatorStartingInfo *startingInfo;
} QueryDelegatorStartingInfoResponse__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = QueryDelegatorStartingInfoResponse_FieldNumber_StartingInfo,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(QueryDelegatorStartingInfoResponse__storage_, startingInfo),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(QueryDelegatorStartingInfoResponse)
                                   messageName:@"QueryDelegatorStartingInfoResponse"
                               fileDescription:&QueryRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(QueryDelegatorStartingInfoResponse__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
