...
GPBObjCClassDeclaration(GetBlockResultsRequest);
GPBObjCClassDeclaration(GetBlockResultsResponse);
GPBObjCClassDeclaration(GetLatestBlockRequest);
GPBObjCClassDeclaration(GetLatestBlockResponse);
GPBObjCClassDeclaration(GetLatestBlockResultsRequest);
GPBObjCClassDeclaration(GetLatestBlockResultsResponse);
...
typedef struct GetSyncingResponse__storage_ {
  uint32_t _has_storage_[1];
  int64_t earliestBlockHeight;
  int64_t latestBlockHeight;
  ...
  if (!descriptor) {
    ...
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .dataTypeSpecific.clazz = Nil,
        .number = GetSyncingResponse_FieldNumber_EarliestBlockHeight,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(GetSyncingResponse__storage_, earliestBlockHeight),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeInt64,
      },
      {
        ...
        .dataTypeSpecific.clazz = Nil,
        .number = GetSyncingResponse_FieldNumber_LatestBlockHeight,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(GetSyncingResponse__storage_, latestBlockHeight),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeInt64,
      },
    };
...
@implementation GetBlockResultsRequest

@dynamic height;

typedef struct GetBlockResultsRequest__storage_ {
  uint32_t _has_storage_[1];
  int64_t height;
} GetBlockResultsRequest__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "height",
        .dataTypeSpecific.clazz = Nil,
        .number = GetBlockResultsRequest_FieldNumber_Height,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(GetBlockResultsRequest__storage_, height),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeInt64,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(GetBlockResultsRequest)
                                   messageName:@"GetBlockResultsRequest"
                               fileDescription:&QueryRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(GetBlockResultsRequest__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
...
@implementation GetLatestBlockResultsRequest


typedef struct GetLatestBlockResultsRequest__storage_ {
  uint32_t _has_storage_[1];
} GetLatestBlockResultsRequest__storage_;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    GPB_DEBUG_CHECK_RUNTIME_VERSIONS();
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(GetLatestBlockResultsRequest)
                                   messageName:@"GetLatestBlockResultsRequest"
                               fileDescription:&QueryRoot_FileDescription
                                        fields:NULL
                                    fieldCount:0
                                   storageSize:sizeof(GetLatestBlockResultsRequest__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
...
@implementation GetBlockResultsResponse

@dynamic height;
@dynamic txsResultsArray, txsResultsArray_Count;
@dynamic finalizeBlockEventsArray, finalizeBlockEventsArray_Count;
@dynamic validatorUpdatesArray, validatorUpdatesArray_Count;
@dynamic hasConsensusParamUpdates, consensusParamUpdates;
@dynamic appHash;

typedef struct GetBlockResultsResponse__storage_ {
  uint32_t _has_storage_[1];
  NSMutableArray *txsResultsArray;
  NSMutableArray *finalizeBlockEventsArray;
  NSMutableArray *validatorUpdatesArray;
  ConsensusParams *consensusParamUpdates;
  NSData *appHash;
  int64_t height;
} GetBlockResultsResponse__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "height",
        .dataTypeSpecific.clazz = Nil,
        .number = GetBlockResultsResponse_FieldNumber_Height,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(GetBlockResultsResponse__storage_, height),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeInt64,
      },
      {
        .name = "txsResultsArray",
        .dataTypeSpecific.clazz = GPBObjCClass(ExecTxResult),
        .number = GetBlockResultsResponse_FieldNumber_TxsResultsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GetBlockResultsResponse__storage_, txsResultsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "finalizeBlockEventsArray",
        .dataTypeSpecific.clazz = GPBObjCClass(Event),
        .number = GetBlockResultsResponse_FieldNumber_FinalizeBlockEventsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GetBlockResultsResponse__storage_, finalizeBlockEventsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        ...
        .number = GetBlockResultsResponse_FieldNumber_ValidatorUpdatesArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GetBlockResultsResponse__storage_, validatorUpdatesArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        ...
        .number = GetBlockResultsResponse_FieldNumber_ConsensusParamUpdates,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(GetBlockResultsResponse__storage_, consensusParamUpdates),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "appHash",
        .dataTypeSpecific.clazz = Nil,
        .number = GetBlockResultsResponse_FieldNumber_AppHash,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(GetBlockResultsResponse__storage_, appHash),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeBytes,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(GetBlockResultsResponse)
                                   messageName:@"GetBlockResultsResponse"
                               fileDescription:&QueryRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(GetBlockResultsResponse__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
...
@implementation GetLatestBlockResultsResponse
...
typedef struct GetLatestBlockResultsResponse__storage_ {
  uint32_t _has_storage_[1];
  NSMutableArray *txsResultsArray;
  NSMutableArray *finalizeBlockEventsArray;
  NSMutableArray *validatorUpdatesArray;
  ...
  NSData *appHash;
  int64_t height;
} GetLatestBlockResultsResponse__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "height",
        .dataTypeSpecific.clazz = Nil,
        .number = GetLatestBlockResultsResponse_FieldNumber_Height,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(GetLatestBlockResultsResponse__storage_, height),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeInt64,
      },
      {
        .name = "txsResultsArray",
        .dataTypeSpecific.clazz = GPBObjCClass(ExecTxResult),
        .number = GetLatestBlockResultsResponse_FieldNumber_TxsResultsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GetLatestBlockResultsResponse__storage_, txsResultsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "finalizeBlockEventsArray",
        .dataTypeSpecific.clazz = GPBObjCClass(Event),
        .number = GetLatestBlockResultsResponse_FieldNumber_FinalizeBlockEventsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GetLatestBlockResultsResponse__storage_, finalizeBlockEventsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "validatorUpdatesArray",
        .dataTypeSpecific.clazz = GPBObjCClass(ValidatorUpdate),
        .number = GetLatestBlockResultsResponse_FieldNumber_ValidatorUpdatesArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GetLatestBlockResultsResponse__storage_, validatorUpdatesArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "consensusParamUpdates",
        .dataTypeSpecific.clazz = GPBObjCClass(ConsensusParams),
        .number = GetLatestBlockResultsResponse_FieldNumber_ConsensusParamUpdates,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(GetLatestBlockResultsResponse__storage_, consensusParamUpdates),
        .flags = GPBFieldOptional,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "appHash",
        .dataTypeSpecific.clazz = Nil,
        .number = GetLatestBlockResultsResponse_FieldNumber_AppHash,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(GetLatestBlockResultsResponse__storage_, appHash),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeBytes,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(GetLatestBlockResultsResponse)
                                   messageName:@"GetLatestBlockResultsResponse"
                               fileDescription:&QueryRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(GetLatestBlockResultsResponse__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
