...
#import "cosmos/nft/v1beta1/Tx.pbobjc.h"
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = MsgSend_FieldNumber_ClassId,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(MsgSend__storage_, classId),
      ...
      },
      {
        .name = "id_p",
        .dataTypeSpecific.clazz = Nil,
        .number = MsgSend_FieldNumber_Id_p,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(MsgSend__storage_, id_p),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
      {
        .name = "sender",
        .dataTypeSpecific.clazz = Nil,
        .number = MsgSend_FieldNumber_Sender,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(MsgSend__storage_, sender),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
      {
        .name = "receiver",
        .dataTypeSpecific.clazz = Nil,
        .number = MsgSend_FieldNumber_Receiver,
        .hasIndex = 3,
        .offset = (uint32_t)offsetof(MsgSend__storage_, receiver),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
    };
