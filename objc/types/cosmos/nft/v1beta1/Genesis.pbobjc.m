...
#import "cosmos/nft/v1beta1/Genesis.pbobjc.h"
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = GenesisState_FieldNumber_ClassesArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GenesisState__storage_, classesArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "entriesArray",
        .dataTypeSpecific.clazz = GPBObjCClass(Entry),
        .number = GenesisState_FieldNumber_EntriesArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GenesisState__storage_, entriesArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
    };
...
typedef struct Entry__storage_ {
  uint32_t _has_storage_[1];
  NSString *owner;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = Entry_FieldNumber_Owner,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(Entry__storage_, owner),
      ...
      },
      {
        ...
        .number = Entry_FieldNumber_NftsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(Entry__storage_, nftsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(Entry)
                                   messageName:@"Entry"
                               fileDescription:&GenesisRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(Entry__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
