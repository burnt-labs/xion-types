...
typedef GPB_ENUM(MsgUnjail_FieldNumber) {
  MsgUnjail_FieldNumber_ValidatorAddr = 1,
};

/**
 * MsgUnjail defines the Msg/Unjail request type
 **/
GPB_FINAL @interface MsgUnjail : GPBMessage
 ...
 **/
GPB_FINAL @interface MsgUnjailResponse : GPBMessage
