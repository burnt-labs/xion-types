...
#import "cosmos/slashing/v1beta1/Tx.pbobjc.h"
...
GPBObjCClassDeclaration(MsgUnjail);
GPBObjCClassDeclaration(MsgUnjailResponse);
...
#pragma mark - MsgUnjail

@implementation MsgUnjail

@dynamic validatorAddr;

typedef struct MsgUnjail__storage_ {
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = MsgUnjail_FieldNumber_ValidatorAddr,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(MsgUnjail__storage_, validatorAddr),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(MsgUnjail)
                                   messageName:@"MsgUnjail"
                               fileDescription:&TxRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
                                   storageSize:sizeof(MsgUnjail__storage_)
...
#pragma mark - MsgUnjailResponse

@implementation MsgUnjailResponse


typedef struct MsgUnjailResponse__storage_ {
  uint32_t _has_storage_[1];
} MsgUnjailResponse__storage_;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    GPB_DEBUG_CHECK_RUNTIME_VERSIONS();
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(MsgUnjailResponse)
                                   messageName:@"MsgUnjailResponse"
                               fileDescription:&TxRoot_FileDescription
                                        fields:NULL
                                    fieldCount:0
                                   storageSize:sizeof(MsgUnjailResponse__storage_)
                                         flags:(GPBDescriptorInitializationFlags)(GPBDescriptorInitializationFlag_UsesClassRefs | GPBDescriptorInitializationFlag_Proto3OptionalKnown | GPBDescriptorInitializationFlag_ClosedEnumSupportKnown)];
    #if defined(DEBUG) && DEBUG
      NSAssert(descriptor == nil, @"Startup recursed!");
    #endif  // DEBUG
