 ...
 * file option.
 **/
+ (GPBExtensionDescriptor *)implementsInterface;
/** message_added_in is used to indicate from which version the message was added. */
+ (GPBExtensionDescriptor *)messageAddedIn;
/**
 ...
 **/
+ (GPBExtensionDescriptor *)acceptsInterface;
/**
 ...
 **/
+ (GPBExtensionDescriptor *)declareInterface;
/**
