    ...
    static GPBExtensionDescription descriptions[] = {
      {
        ...
        .singletonName = GPBStringifySymbol(CosmosRoot_methodAddedIn),
      ...
      },
      {
        ...
        .singletonName = GPBStringifySymbol(CosmosRoot_implementsInterface),
      ...
      {
        .defaultValue.valueString = nil,
        .singletonName = GPBStringifySymbol(CosmosRoot_messageAddedIn),
        .extendedClass.clazz = GPBObjCClass(GPBMessageOptions),
        .messageOrGroupClass.clazz = Nil,
        .enumDescriptorFunc = NULL,
        .fieldNumber = 93002,
      ...
      {
        .defaultValue.valueString = nil,
        .singletonName = GPBStringifySymbol(CosmosRoot_acceptsInterface),
      ...
      {
        .defaultValue.valueString = nil,
        .singletonName = GPBStringifySymbol(CosmosRoot_scalar),
        .extendedClass.clazz = GPBObjCClass(GPBFieldOptions),
        .messageOrGroupClass.clazz = Nil,
        .enumDescriptorFunc = NULL,
        .fieldNumber = 93002,
      ...
      {
        .defaultValue.valueString = nil,
        .singletonName = GPBStringifySymbol(CosmosRoot_fieldAddedIn),
        .extendedClass.clazz = GPBObjCClass(GPBFieldOptions),
        .messageOrGroupClass.clazz = Nil,
        .enumDescriptorFunc = NULL,
        .fieldNumber = 93003,
      ...
      {
        .defaultValue.valueMessage = nil,
        .singletonName = GPBStringifySymbol(CosmosRoot_declareInterface),
        .extendedClass.clazz = GPBObjCClass(GPBFileOptions),
        .messageOrGroupClass.clazz = GPBObjCClass(InterfaceDescriptor),
        .enumDescriptorFunc = NULL,
        .fieldNumber = 793021,
      ...
      {
        .defaultValue.valueMessage = nil,
        .singletonName = GPBStringifySymbol(CosmosRoot_declareScalar),
        .extendedClass.clazz = GPBObjCClass(GPBFileOptions),
        .messageOrGroupClass.clazz = GPBObjCClass(ScalarDescriptor),
        .enumDescriptorFunc = NULL,
        .fieldNumber = 793022,
        .dataType = GPBDataTypeMessage,
        .options = GPBExtensionRepeated,
      ...
      {
        .defaultValue.valueString = nil,
        .singletonName = GPBStringifySymbol(CosmosRoot_fileAddedIn),
        .extendedClass.clazz = GPBObjCClass(GPBFileOptions),
        .messageOrGroupClass.clazz = Nil,
        .enumDescriptorFunc = NULL,
        .fieldNumber = 793023,
