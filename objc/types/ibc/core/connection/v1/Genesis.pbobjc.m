...
@dynamic clientConnectionPathsArray, clientConnectionPathsArray_Count;
@dynamic nextConnectionSequence;
@dynamic hasParams, params;

typedef struct GenesisState__storage_ {
  uint32_t _has_storage_[1];
  NSMutableArray *connectionsArray;
  NSMutableArray *clientConnectionPathsArray;
  Params *params;
  uint64_t nextConnectionSequence;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = GenesisState_FieldNumber_ConnectionsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GenesisState__storage_, connectionsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        .name = "clientConnectionPathsArray",
        .dataTypeSpecific.clazz = GPBObjCClass(ConnectionPaths),
        .number = GenesisState_FieldNumber_ClientConnectionPathsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GenesisState__storage_, clientConnectionPathsArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
      {
        ...
        .number = GenesisState_FieldNumber_NextConnectionSequence,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(GenesisState__storage_, nextConnectionSequence),
