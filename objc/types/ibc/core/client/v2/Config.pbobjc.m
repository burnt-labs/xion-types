...
@dynamic allowedRelayersArray, allowedRelayersArray_Count;

typedef struct Config__storage_ {
  uint32_t _has_storage_[1];
  NSMutableArray *allowedRelayersArray;
} Config__storage_;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "allowedRelayersArray",
        .dataTypeSpecific.clazz = Nil,
        .number = Config_FieldNumber_AllowedRelayersArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(Config__storage_, allowedRelayersArray),
