...
#import "ibc/applications/transfer/v1/Genesis.pbobjc.h"
...
@dynamic totalEscrowedArray, totalEscrowedArray_Count;
...
typedef struct GenesisState__storage_ {
  ...
  Params *params;
  NSMutableArray *totalEscrowedArray;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = GenesisState_FieldNumber_PortId,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(GenesisState__storage_, portId),
      ...
      },
      {
        ...
        .number = GenesisState_FieldNumber_DenomsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GenesisState__storage_, denomsArray),
      ...
      {
        .name = "totalEscrowedArray",
        .dataTypeSpecific.clazz = GPBObjCClass(Coin),
        .number = GenesisState_FieldNumber_TotalEscrowedArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GenesisState__storage_, totalEscrowedArray),
        .flags = GPBFieldRepeated,
        .dataType = GPBDataTypeMessage,
      },
    };
