...
typedef GPB_ENUM(QueryInterchainAccountRequest_FieldNumber) {
  QueryInterchainAccountRequest_FieldNumber_Owner = 1,
  QueryInterchainAccountRequest_FieldNumber_ConnectionId = 2,
};

/**
 * QueryInterchainAccountRequest is the request type for the Query/InterchainAccount RPC method.
 **/
GPB_FINAL @interface QueryInterchainAccountRequest : GPBMessage
...
typedef GPB_ENUM(QueryInterchainAccountResponse_FieldNumber) {
  QueryInterchainAccountResponse_FieldNumber_Address = 1,
};

/**
 * QueryInterchainAccountResponse the response type for the Query/InterchainAccount RPC method.
 **/
GPB_FINAL @interface QueryInterchainAccountResponse : GPBMessage
