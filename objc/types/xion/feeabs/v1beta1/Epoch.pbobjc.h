 ...
 **/
GPB_FINAL @interface EpochRoot : GPBRootObject
@end
...
typedef GPB_ENUM(ExponentialBackoff_FieldNumber) {
  ExponentialBackoff_FieldNumber_Jump = 1,
  ExponentialBackoff_FieldNumber_FutureEpoch = 2,
};

/**
 * ExponentialBackoff defines backoff epoch
 **/
GPB_FINAL @interface ExponentialBackoff : GPBMessage

@property(nonatomic, readwrite) int64_t jump;

@property(nonatomic, readwrite) int64_t futureEpoch;
