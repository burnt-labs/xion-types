...
GPBEnumDescriptor *HostChainFeeAbsStatus_EnumDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    static const char *valueNames =
        "HostChainFeeAbsStatusUnspecified\000HostCha"
        "inFeeAbsStatusUpdated\000HostChainFeeAbsSta"
        "tusOutdated\000HostChainFeeAbsStatusFrozen\000";
    static const int32_t values[] = {
        HostChainFeeAbsStatus_HostChainFeeAbsStatusUnspecified,
        HostChainFeeAbsStatus_HostChainFeeAbsStatusUpdated,
        HostChainFeeAbsStatus_HostChainFeeAbsStatusOutdated,
        HostChainFeeAbsStatus_HostChainFeeAbsStatusFrozen,
    };
...
BOOL HostChainFeeAbsStatus_IsValidValue(int32_t value__) {
  switch (value__) {
    case HostChainFeeAbsStatus_HostChainFeeAbsStatusUnspecified:
    case HostChainFeeAbsStatus_HostChainFeeAbsStatusUpdated:
    case HostChainFeeAbsStatus_HostChainFeeAbsStatusOutdated:
    case HostChainFeeAbsStatus_HostChainFeeAbsStatusFrozen:
      return YES;
    default:
      return NO;
  }
