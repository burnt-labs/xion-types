...
typedef GPB_ENUM(GenesisState_FieldNumber) {
  ...
  GenesisState_FieldNumber_AudienceListArray = 2,
};
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<Audience*> *audienceListArray;
/** The number of items in @c audienceListArray without causing the container to be created. */
@property(nonatomic, readonly) NSUInteger audienceListArray_Count;
