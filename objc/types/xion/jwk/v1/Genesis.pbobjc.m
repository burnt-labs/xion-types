...
#import "xion/jwk/v1/Genesis.pbobjc.h"
...
@dynamic audienceListArray, audienceListArray_Count;

typedef struct GenesisState__storage_ {
  uint32_t _has_storage_[1];
  Params *params;
  NSMutableArray *audienceListArray;
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    static GPBMessageFieldDescription fields[] = {
      ...
      {
        .name = "audienceListArray",
        .dataTypeSpecific.clazz = GPBObjCClass(Audience),
        .number = GenesisState_FieldNumber_AudienceListArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GenesisState__storage_, audienceListArray),
