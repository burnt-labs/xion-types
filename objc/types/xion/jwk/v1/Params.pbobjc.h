...
typedef GPB_ENUM(Params_FieldNumber) {
  Params_FieldNumber_TimeOffset = 1,
  Params_FieldNumber_DeploymentGas = 2,
};
...
/** in nanoseconds */
@property(nonatomic, readwrite) uint64_t timeOffset;

/** gas to deploy a new project/audience */
@property(nonatomic, readwrite) uint64_t deploymentGas;
