...
#import "xion/mint/v1/Genesis.pbobjc.h"
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "minter",
        .dataTypeSpecific.clazz = GPBObjCClass(Minter),
        .number = GenesisState_FieldNumber_Minter,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(GenesisState__storage_, minter),
