...
#import "xion/v1/Genesis.pbobjc.h"
...
@dynamic platformMinimumsArray, platformMinimumsArray_Count;

typedef struct GenesisState__storage_ {
  uint32_t _has_storage_[1];
  uint32_t platformPercentage;
  NSMutableArray *platformMinimumsArray;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        ...
        .number = GenesisState_FieldNumber_PlatformPercentage,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(GenesisState__storage_, platformPercentage),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeUInt32,
      },
      {
        .name = "platformMinimumsArray",
        .dataTypeSpecific.clazz = GPBObjCClass(Coin),
        .number = GenesisState_FieldNumber_PlatformMinimumsArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(GenesisState__storage_, platformMinimumsArray),
