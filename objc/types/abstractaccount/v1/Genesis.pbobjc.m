...
#import "abstractaccount/v1/Genesis.pbobjc.h"
  ...
  if (!descriptor) {
    ...
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .number = GenesisState_FieldNumber_NextAccountId,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(GenesisState__storage_, nextAccountId),
