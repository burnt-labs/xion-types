...
GPBObjCClassDeclaration(GAPIHttp);
...
static GPBFileDescription GAPIHTTPRoot_FileDescription = {
  .package = "google.api",
  .prefix = "GAPI",
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(GAPIHttp)
                                   messageName:@"Http"
                               fileDescription:&GAPIHTTPRoot_FileDescription
                                        fields:fields
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(GAPIHttpRule)
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(GAPICustomHttpPattern)
