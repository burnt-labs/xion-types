...
export const StoreCodeProposal: MessageFns<StoreCodeProposal> = {
  ...
  fromJSON(object: any): StoreCodeProposal {
    return {
      ...
      runAs: isSet(object.runAs)
        ? globalThis.String(object.runAs)
        : isSet(object.run_as)
        ? globalThis.String(object.run_as)
        : "",
      wasmByteCode: isSet(object.wasmByteCode)
        ? bytesFromBase64(object.wasmByteCode)
        : isSet(object.wasm_byte_code)
      ...
      unpinCode: isSet(object.unpinCode)
        ...
        : isSet(object.unpin_code)
        ? globalThis.Boolean(object.unpin_code)
        : false,
  ...
  fromJSON(object: any): InstantiateContract2Proposal {
    return {
      ...
      fixMsg: isSet(object.fixMsg)
        ...
        : isSet(object.fix_msg)
        ? globalThis.Boolean(object.fix_msg)
        : false,
    };
  },
...
function createBaseMigrateContractProposal(): MigrateContractProposal {
  return { title: "", description: "", contract: "", codeId: Long.UZERO, msg: new Uint8Array(0) };
}
...
export const PinCodesProposal: MessageFns<PinCodesProposal> = {
  encode(message: PinCodesProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.codeIds) {
      writer.uint32(24).uint64(v!.toString());
    }
    return writer;
  },
  ...
  fromJSON(object: any): UpdateInstantiateConfigProposal {
    return {
      ...
      accessConfigUpdates: globalThis.Array.isArray(object?.accessConfigUpdates)
        ...
        : globalThis.Array.isArray(object?.access_config_updates)
