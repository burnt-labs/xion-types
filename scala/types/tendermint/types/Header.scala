...
final case class Header(
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 14 => _root_.scalapb.descriptors.PByteString(proposerAddress)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: tendermint.types.Header.type = tendermint.types.Header
    // @@protoc_insertion_point(GeneratedMessage[tendermint.types.Header])
}

object Header extends scalapb.GeneratedMessageCompanion[tendermint.types.Header] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[tendermint.types.Header] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): tendermint.types.Header = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[tendermint.types.Header] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      tendermint.types.Header(
        ...
        proposerAddress = __fieldsMap.get(scalaDescriptor.findFieldByNumber(14).get).map(_.as[_root_.com.google.protobuf.ByteString]).getOrElse(_root_.com.google.protobuf.ByteString.EMPTY)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = tendermint.types.TypesProto.javaDescriptor.getMessageTypes().get(3)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = tendermint.types.TypesProto.scalaDescriptor.messages(3)
  ...
  lazy val defaultInstance = tendermint.types.Header(
  ...
  implicit class HeaderLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, tendermint.types.Header]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, tendermint.types.Header](_l) {
  ...
  ): _root_.tendermint.types.Header = _root_.tendermint.types.Header(
    version,
    chainId,
    height,
    time,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[tendermint.types.Header])
}
