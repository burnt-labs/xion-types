...
final case class Block(
    ...
    def withHeader(__v: tendermint.types.Header): Block = copy(header = Option(__v))
    ...
    def companion: tendermint.types.Block.type = tendermint.types.Block
    // @@protoc_insertion_point(GeneratedMessage[tendermint.types.Block])
}

object Block extends scalapb.GeneratedMessageCompanion[tendermint.types.Block] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[tendermint.types.Block] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): tendermint.types.Block = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[tendermint.types.Block] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = tendermint.types.BlockProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = tendermint.types.BlockProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = tendermint.types.Block(
    header = _root_.scala.None,
    data = _root_.scala.None,
    evidence = _root_.scala.None,
    lastCommit = _root_.scala.None
  )
  implicit class BlockLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, tendermint.types.Block]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, tendermint.types.Block](_l) {
  ...
  ): _root_.tendermint.types.Block = _root_.tendermint.types.Block(
    header,
    data,
    evidence,
    lastCommit
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[tendermint.types.Block])
}
