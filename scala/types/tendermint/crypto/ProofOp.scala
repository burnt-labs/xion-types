...
final case class ProofOp(
    ...
    def companion: tendermint.crypto.ProofOp.type = tendermint.crypto.ProofOp
    // @@protoc_insertion_point(GeneratedMessage[tendermint.crypto.ProofOp])
}

object ProofOp extends scalapb.GeneratedMessageCompanion[tendermint.crypto.ProofOp] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[tendermint.crypto.ProofOp] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): tendermint.crypto.ProofOp = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[tendermint.crypto.ProofOp] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = tendermint.crypto.ProofProto.javaDescriptor.getMessageTypes().get(3)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = tendermint.crypto.ProofProto.scalaDescriptor.messages(3)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = tendermint.crypto.ProofOp(
    `type` = "",
    key = _root_.com.google.protobuf.ByteString.EMPTY,
    data = _root_.com.google.protobuf.ByteString.EMPTY
  )
  implicit class ProofOpLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, tendermint.crypto.ProofOp]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, tendermint.crypto.ProofOp](_l) {
  ...
  ): _root_.tendermint.crypto.ProofOp = _root_.tendermint.crypto.ProofOp(
    `type`,
    key,
    data
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[tendermint.crypto.ProofOp])
}
