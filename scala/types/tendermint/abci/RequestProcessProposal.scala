...
/** @param hash
  ...
  */
@SerialVersionUID(0L)
final case class RequestProcessProposal(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[RequestProcessProposal] {
    @transient
    ...
    def addTxs(__vs: _root_.com.google.protobuf.ByteString *): RequestProcessProposal = addAllTxs(__vs)
    def addAllTxs(__vs: Iterable[_root_.com.google.protobuf.ByteString]): RequestProcessProposal = copy(txs = txs ++ __vs)
    def withTxs(__v: _root_.scala.Seq[_root_.com.google.protobuf.ByteString]): RequestProcessProposal = copy(txs = __v)
    ...
    def clearProposedLastCommit: RequestProcessProposal = copy(proposedLastCommit = _root_.scala.None)
    def withProposedLastCommit(__v: tendermint.abci.CommitInfo): RequestProcessProposal = copy(proposedLastCommit = Option(__v))
    def clearMisbehavior = copy(misbehavior = _root_.scala.Seq.empty)
    def addMisbehavior(__vs: tendermint.abci.Misbehavior *): RequestProcessProposal = addAllMisbehavior(__vs)
    def addAllMisbehavior(__vs: Iterable[tendermint.abci.Misbehavior]): RequestProcessProposal = copy(misbehavior = misbehavior ++ __vs)
    def withMisbehavior(__v: _root_.scala.Seq[tendermint.abci.Misbehavior]): RequestProcessProposal = copy(misbehavior = __v)
    def withHash(__v: _root_.com.google.protobuf.ByteString): RequestProcessProposal = copy(hash = __v)
    def withHeight(__v: _root_.scala.Long): RequestProcessProposal = copy(height = __v)
    ...
    def clearTime: RequestProcessProposal = copy(time = _root_.scala.None)
    def withTime(__v: com.google.protobuf.timestamp.Timestamp): RequestProcessProposal = copy(time = Option(__v))
    def withNextValidatorsHash(__v: _root_.com.google.protobuf.ByteString): RequestProcessProposal = copy(nextValidatorsHash = __v)
    def withProposerAddress(__v: _root_.com.google.protobuf.ByteString): RequestProcessProposal = copy(proposerAddress = __v)
    def withUnknownFields(__v: _root_.scalapb.UnknownFieldSet) = copy(unknownFields = __v)
    def discardUnknownFields = copy(unknownFields = _root_.scalapb.UnknownFieldSet.empty)
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        case 1 => txs
        case 2 => proposedLastCommit.orNull
        case 3 => misbehavior
        case 4 => {
          val __t = hash
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 2 => proposedLastCommit.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
    ...
    def companion: tendermint.abci.RequestProcessProposal.type = tendermint.abci.RequestProcessProposal
    // @@protoc_insertion_point(GeneratedMessage[tendermint.abci.RequestProcessProposal])
}

object RequestProcessProposal extends scalapb.GeneratedMessageCompanion[tendermint.abci.RequestProcessProposal] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[tendermint.abci.RequestProcessProposal] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): tendermint.abci.RequestProcessProposal = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[tendermint.abci.RequestProcessProposal] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      tendermint.abci.RequestProcessProposal(
        ...
        proposedLastCommit = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).flatMap(_.as[_root_.scala.Option[tendermint.abci.CommitInfo]]),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = tendermint.abci.TypesProto.javaDescriptor.getMessageTypes().get(13)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = tendermint.abci.TypesProto.scalaDescriptor.messages(13)
  ...
  lazy val defaultInstance = tendermint.abci.RequestProcessProposal(
  ...
  implicit class RequestProcessProposalLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, tendermint.abci.RequestProcessProposal]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, tendermint.abci.RequestProcessProposal](_l) {
  ...
  final val PROPOSED_LAST_COMMIT_FIELD_NUMBER = 2
  ...
  ): _root_.tendermint.abci.RequestProcessProposal = _root_.tendermint.abci.RequestProcessProposal(
    txs,
    proposedLastCommit,
    misbehavior,
    hash,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[tendermint.abci.RequestProcessProposal])
}
