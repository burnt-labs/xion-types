...
final case class ExecTxResult(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ExecTxResult] {
    @transient
    ...
    def withCode(__v: _root_.scala.Int): ExecTxResult = copy(code = __v)
    def withData(__v: _root_.com.google.protobuf.ByteString): ExecTxResult = copy(data = __v)
    def withLog(__v: _root_.scala.Predef.String): ExecTxResult = copy(log = __v)
    def withInfo(__v: _root_.scala.Predef.String): ExecTxResult = copy(info = __v)
    def withGasWanted(__v: _root_.scala.Long): ExecTxResult = copy(gasWanted = __v)
    def withGasUsed(__v: _root_.scala.Long): ExecTxResult = copy(gasUsed = __v)
    def clearEvents = copy(events = _root_.scala.Seq.empty)
    def addEvents(__vs: tendermint.abci.Event *): ExecTxResult = addAllEvents(__vs)
    def addAllEvents(__vs: Iterable[tendermint.abci.Event]): ExecTxResult = copy(events = events ++ __vs)
    def withEvents(__v: _root_.scala.Seq[tendermint.abci.Event]): ExecTxResult = copy(events = __v)
    def withCodespace(__v: _root_.scala.Predef.String): ExecTxResult = copy(codespace = __v)
    ...
    def companion: tendermint.abci.ExecTxResult.type = tendermint.abci.ExecTxResult
    // @@protoc_insertion_point(GeneratedMessage[tendermint.abci.ExecTxResult])
}

object ExecTxResult extends scalapb.GeneratedMessageCompanion[tendermint.abci.ExecTxResult] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[tendermint.abci.ExecTxResult] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): tendermint.abci.ExecTxResult = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[tendermint.abci.ExecTxResult] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = tendermint.abci.TypesProto.javaDescriptor.getMessageTypes().get(39)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = tendermint.abci.TypesProto.scalaDescriptor.messages(39)
  ...
  lazy val defaultInstance = tendermint.abci.ExecTxResult(
    code = 0,
  ...
  implicit class ExecTxResultLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, tendermint.abci.ExecTxResult]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, tendermint.abci.ExecTxResult](_l) {
  ...
  def of(
    ...
    codespace: _root_.scala.Predef.String
  ): _root_.tendermint.abci.ExecTxResult = _root_.tendermint.abci.ExecTxResult(
    code,
    data,
    log,
    info,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[tendermint.abci.ExecTxResult])
}
