...
/** IdentifiedConnection defines a connection with additional connection
  ...
  */
@SerialVersionUID(0L)
final case class IdentifiedConnection(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[IdentifiedConnection] {
    @transient
    ...
    def withId(__v: _root_.scala.Predef.String): IdentifiedConnection = copy(id = __v)
    def withClientId(__v: _root_.scala.Predef.String): IdentifiedConnection = copy(clientId = __v)
    def clearVersions = copy(versions = _root_.scala.Seq.empty)
    def addVersions(__vs: ibc.core.connection.v1.Version *): IdentifiedConnection = addAllVersions(__vs)
    def addAllVersions(__vs: Iterable[ibc.core.connection.v1.Version]): IdentifiedConnection = copy(versions = versions ++ __vs)
    def withVersions(__v: _root_.scala.Seq[ibc.core.connection.v1.Version]): IdentifiedConnection = copy(versions = __v)
    def withState(__v: ibc.core.connection.v1.State): IdentifiedConnection = copy(state = __v)
    ...
    def clearCounterparty: IdentifiedConnection = copy(counterparty = _root_.scala.None)
    def withCounterparty(__v: ibc.core.connection.v1.Counterparty): IdentifiedConnection = copy(counterparty = Option(__v))
    def withDelayPeriod(__v: _root_.scala.Long): IdentifiedConnection = copy(delayPeriod = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => _root_.scalapb.descriptors.PRepeated(versions.iterator.map(_.toPMessage).toVector)
        case 4 => _root_.scalapb.descriptors.PEnum(state.scalaValueDescriptor)
        case 5 => counterparty.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
        case 6 => _root_.scalapb.descriptors.PLong(delayPeriod)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: ibc.core.connection.v1.IdentifiedConnection.type = ibc.core.connection.v1.IdentifiedConnection
    // @@protoc_insertion_point(GeneratedMessage[ibc.core.connection.v1.IdentifiedConnection])
}

object IdentifiedConnection extends scalapb.GeneratedMessageCompanion[ibc.core.connection.v1.IdentifiedConnection] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ibc.core.connection.v1.IdentifiedConnection] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ibc.core.connection.v1.IdentifiedConnection = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ibc.core.connection.v1.IdentifiedConnection] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      ibc.core.connection.v1.IdentifiedConnection(
        ...
        versions = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scala.Seq[ibc.core.connection.v1.Version]]).getOrElse(_root_.scala.Seq.empty),
        state = ibc.core.connection.v1.State.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(ibc.core.connection.v1.State.STATE_UNINITIALIZED_UNSPECIFIED.scalaValueDescriptor).number),
        counterparty = __fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).flatMap(_.as[_root_.scala.Option[ibc.core.connection.v1.Counterparty]]),
        delayPeriod = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scala.Long]).getOrElse(0L)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ibc.core.connection.v1.ConnectionProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ibc.core.connection.v1.ConnectionProto.scalaDescriptor.messages(1)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 3 => __out = ibc.core.connection.v1.Version
      case 5 => __out = ibc.core.connection.v1.Counterparty
    }
    __out
  }
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 4 => ibc.core.connection.v1.State
    }
  }
  lazy val defaultInstance = ibc.core.connection.v1.IdentifiedConnection(
    id = "",
    clientId = "",
  ...
  implicit class IdentifiedConnectionLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ibc.core.connection.v1.IdentifiedConnection]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ibc.core.connection.v1.IdentifiedConnection](_l) {
  ...
  final val COUNTERPARTY_FIELD_NUMBER = 5
  final val DELAY_PERIOD_FIELD_NUMBER = 6
  def of(
    id: _root_.scala.Predef.String,
    clientId: _root_.scala.Predef.String,
  ...
  ): _root_.ibc.core.connection.v1.IdentifiedConnection = _root_.ibc.core.connection.v1.IdentifiedConnection(
    id,
    clientId,
    versions,
    state,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[ibc.core.connection.v1.IdentifiedConnection])
}
