...
final case class QueryUnreceivedAcksRequest(
    ...
    def withPortId(__v: _root_.scala.Predef.String): QueryUnreceivedAcksRequest = copy(portId = __v)
    def withChannelId(__v: _root_.scala.Predef.String): QueryUnreceivedAcksRequest = copy(channelId = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => _root_.scalapb.descriptors.PRepeated(packetAckSequences.iterator.map(_root_.scalapb.descriptors.PLong(_)).toVector)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: ibc.core.channel.v1.QueryUnreceivedAcksRequest.type = ibc.core.channel.v1.QueryUnreceivedAcksRequest
    // @@protoc_insertion_point(GeneratedMessage[ibc.core.channel.v1.QueryUnreceivedAcksRequest])
}

object QueryUnreceivedAcksRequest extends scalapb.GeneratedMessageCompanion[ibc.core.channel.v1.QueryUnreceivedAcksRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ibc.core.channel.v1.QueryUnreceivedAcksRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ibc.core.channel.v1.QueryUnreceivedAcksRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ibc.core.channel.v1.QueryUnreceivedAcksRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      ibc.core.channel.v1.QueryUnreceivedAcksRequest(
        ...
        packetAckSequences = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scala.Seq[_root_.scala.Long]]).getOrElse(_root_.scala.Seq.empty)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ibc.core.channel.v1.QueryProto.javaDescriptor.getMessageTypes().get(22)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ibc.core.channel.v1.QueryProto.scalaDescriptor.messages(22)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = ibc.core.channel.v1.QueryUnreceivedAcksRequest(
    portId = "",
    channelId = "",
    packetAckSequences = _root_.scala.Seq.empty
  )
  implicit class QueryUnreceivedAcksRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ibc.core.channel.v1.QueryUnreceivedAcksRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ibc.core.channel.v1.QueryUnreceivedAcksRequest](_l) {
  ...
  final val PACKET_ACK_SEQUENCES_FIELD_NUMBER = 3
  def of(
    portId: _root_.scala.Predef.String,
    channelId: _root_.scala.Predef.String,
    packetAckSequences: _root_.scala.Seq[_root_.scala.Long]
  ): _root_.ibc.core.channel.v1.QueryUnreceivedAcksRequest = _root_.ibc.core.channel.v1.QueryUnreceivedAcksRequest(
    portId,
    channelId,
    packetAckSequences
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[ibc.core.channel.v1.QueryUnreceivedAcksRequest])
}
