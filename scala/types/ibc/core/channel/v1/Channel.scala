...
final case class Channel(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[Channel] {
    @transient
    ...
    def withState(__v: ibc.core.channel.v1.State): Channel = copy(state = __v)
    def withOrdering(__v: ibc.core.channel.v1.Order): Channel = copy(ordering = __v)
    ...
    def clearCounterparty: Channel = copy(counterparty = _root_.scala.None)
    def withCounterparty(__v: ibc.core.channel.v1.Counterparty): Channel = copy(counterparty = Option(__v))
    def clearConnectionHops = copy(connectionHops = _root_.scala.Seq.empty)
    def addConnectionHops(__vs: _root_.scala.Predef.String *): Channel = addAllConnectionHops(__vs)
    def addAllConnectionHops(__vs: Iterable[_root_.scala.Predef.String]): Channel = copy(connectionHops = connectionHops ++ __vs)
    def withConnectionHops(__v: _root_.scala.Seq[_root_.scala.Predef.String]): Channel = copy(connectionHops = __v)
    def withVersion(__v: _root_.scala.Predef.String): Channel = copy(version = __v)
    ...
    def companion: ibc.core.channel.v1.Channel.type = ibc.core.channel.v1.Channel
    // @@protoc_insertion_point(GeneratedMessage[ibc.core.channel.v1.Channel])
}

object Channel extends scalapb.GeneratedMessageCompanion[ibc.core.channel.v1.Channel] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ibc.core.channel.v1.Channel] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ibc.core.channel.v1.Channel = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ibc.core.channel.v1.Channel] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ibc.core.channel.v1.ChannelProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ibc.core.channel.v1.ChannelProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = ibc.core.channel.v1.Channel(
  ...
  implicit class ChannelLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ibc.core.channel.v1.Channel]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ibc.core.channel.v1.Channel](_l) {
  ...
  def of(
    ...
    version: _root_.scala.Predef.String
  ): _root_.ibc.core.channel.v1.Channel = _root_.ibc.core.channel.v1.Channel(
    state,
    ordering,
    counterparty,
    connectionHops,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[ibc.core.channel.v1.Channel])
}
