...
final case class PacketState(
    ...
    def withPortId(__v: _root_.scala.Predef.String): PacketState = copy(portId = __v)
    def withChannelId(__v: _root_.scala.Predef.String): PacketState = copy(channelId = __v)
    ...
    def companion: ibc.core.channel.v1.PacketState.type = ibc.core.channel.v1.PacketState
    // @@protoc_insertion_point(GeneratedMessage[ibc.core.channel.v1.PacketState])
}

object PacketState extends scalapb.GeneratedMessageCompanion[ibc.core.channel.v1.PacketState] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ibc.core.channel.v1.PacketState] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ibc.core.channel.v1.PacketState = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ibc.core.channel.v1.PacketState] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ibc.core.channel.v1.ChannelProto.javaDescriptor.getMessageTypes().get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ibc.core.channel.v1.ChannelProto.scalaDescriptor.messages(4)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = ibc.core.channel.v1.PacketState(
    portId = "",
    channelId = "",
    sequence = 0L,
    data = _root_.com.google.protobuf.ByteString.EMPTY
  )
  implicit class PacketStateLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ibc.core.channel.v1.PacketState]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ibc.core.channel.v1.PacketState](_l) {
  ...
  ): _root_.ibc.core.channel.v1.PacketState = _root_.ibc.core.channel.v1.PacketState(
    portId,
    channelId,
    sequence,
    data
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[ibc.core.channel.v1.PacketState])
}
