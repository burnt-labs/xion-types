...
final case class InFlightPacket(
    ...
    def companion: ibc.applications.packet_forward_middleware.v1.InFlightPacket.type = ibc.applications.packet_forward_middleware.v1.InFlightPacket
    // @@protoc_insertion_point(GeneratedMessage[ibc.applications.packet_forward_middleware.v1.InFlightPacket])
}

object InFlightPacket extends scalapb.GeneratedMessageCompanion[ibc.applications.packet_forward_middleware.v1.InFlightPacket] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ibc.applications.packet_forward_middleware.v1.InFlightPacket] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ibc.applications.packet_forward_middleware.v1.InFlightPacket = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ibc.applications.packet_forward_middleware.v1.InFlightPacket] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ibc.applications.packet_forward_middleware.v1.GenesisProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ibc.applications.packet_forward_middleware.v1.GenesisProto.scalaDescriptor.messages(1)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = ibc.applications.packet_forward_middleware.v1.InFlightPacket(
  ...
  implicit class InFlightPacketLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ibc.applications.packet_forward_middleware.v1.InFlightPacket]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ibc.applications.packet_forward_middleware.v1.InFlightPacket](_l) {
  ...
  ): _root_.ibc.applications.packet_forward_middleware.v1.InFlightPacket = _root_.ibc.applications.packet_forward_middleware.v1.InFlightPacket(
    originalSenderAddress,
    refundChannelId,
    refundPortId,
    packetSrcChannelId,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[ibc.applications.packet_forward_middleware.v1.InFlightPacket])
}
