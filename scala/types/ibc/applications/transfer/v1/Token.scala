...
final case class Token(
    ...
    def clearDenom: Token = copy(denom = _root_.scala.None)
    def withDenom(__v: ibc.applications.transfer.v1.Denom): Token = copy(denom = Option(__v))
    def withAmount(__v: _root_.scala.Predef.String): Token = copy(amount = __v)
    ...
    def companion: ibc.applications.transfer.v1.Token.type = ibc.applications.transfer.v1.Token
    // @@protoc_insertion_point(GeneratedMessage[ibc.applications.transfer.v1.Token])
}

object Token extends scalapb.GeneratedMessageCompanion[ibc.applications.transfer.v1.Token] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ibc.applications.transfer.v1.Token] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ibc.applications.transfer.v1.Token = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ibc.applications.transfer.v1.Token] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ibc.applications.transfer.v1.TokenProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ibc.applications.transfer.v1.TokenProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = ibc.applications.transfer.v1.Token(
    denom = _root_.scala.None,
    amount = ""
  )
  implicit class TokenLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ibc.applications.transfer.v1.Token]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ibc.applications.transfer.v1.Token](_l) {
  ...
  def of(
    ...
    amount: _root_.scala.Predef.String
  ): _root_.ibc.applications.transfer.v1.Token = _root_.ibc.applications.transfer.v1.Token(
    denom,
    amount
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[ibc.applications.transfer.v1.Token])
}
