...
final case class Header(
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => newPublicKey.map(_.toPMessage).getOrElse(_root_.scalapb.descriptors.PEmpty)
        case 4 => _root_.scalapb.descriptors.PString(newDiversifier)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: ibc.lightclients.solomachine.v3.Header.type = ibc.lightclients.solomachine.v3.Header
    // @@protoc_insertion_point(GeneratedMessage[ibc.lightclients.solomachine.v3.Header])
}

object Header extends scalapb.GeneratedMessageCompanion[ibc.lightclients.solomachine.v3.Header] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ibc.lightclients.solomachine.v3.Header] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ibc.lightclients.solomachine.v3.Header = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ibc.lightclients.solomachine.v3.Header] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      ibc.lightclients.solomachine.v3.Header(
        ...
        newPublicKey = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).flatMap(_.as[_root_.scala.Option[com.google.protobuf.any.Any]]),
        newDiversifier = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Predef.String]).getOrElse("")
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ibc.lightclients.solomachine.v3.SolomachineProto.javaDescriptor.getMessageTypes().get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ibc.lightclients.solomachine.v3.SolomachineProto.scalaDescriptor.messages(2)
  ...
  lazy val defaultInstance = ibc.lightclients.solomachine.v3.Header(
    timestamp = 0L,
    signature = _root_.com.google.protobuf.ByteString.EMPTY,
    newPublicKey = _root_.scala.None,
    newDiversifier = ""
  )
  implicit class HeaderLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ibc.lightclients.solomachine.v3.Header]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ibc.lightclients.solomachine.v3.Header](_l) {
  ...
  final val NEW_PUBLIC_KEY_FIELD_NUMBER = 3
  final val NEW_DIVERSIFIER_FIELD_NUMBER = 4
  def of(
    ...
    newDiversifier: _root_.scala.Predef.String
  ): _root_.ibc.lightclients.solomachine.v3.Header = _root_.ibc.lightclients.solomachine.v3.Header(
    timestamp,
    signature,
    newPublicKey,
    newDiversifier
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[ibc.lightclients.solomachine.v3.Header])
}
