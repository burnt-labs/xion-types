...
final case class ConsensusState(
    ...
    def companion: ibc.lightclients.solomachine.v3.ConsensusState.type = ibc.lightclients.solomachine.v3.ConsensusState
    // @@protoc_insertion_point(GeneratedMessage[ibc.lightclients.solomachine.v3.ConsensusState])
}

object ConsensusState extends scalapb.GeneratedMessageCompanion[ibc.lightclients.solomachine.v3.ConsensusState] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ibc.lightclients.solomachine.v3.ConsensusState] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ibc.lightclients.solomachine.v3.ConsensusState = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ibc.lightclients.solomachine.v3.ConsensusState] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ibc.lightclients.solomachine.v3.SolomachineProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ibc.lightclients.solomachine.v3.SolomachineProto.scalaDescriptor.messages(1)
  ...
  lazy val defaultInstance = ibc.lightclients.solomachine.v3.ConsensusState(
    publicKey = _root_.scala.None,
    diversifier = "",
    timestamp = 0L
  )
  implicit class ConsensusStateLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ibc.lightclients.solomachine.v3.ConsensusState]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ibc.lightclients.solomachine.v3.ConsensusState](_l) {
  ...
  ): _root_.ibc.lightclients.solomachine.v3.ConsensusState = _root_.ibc.lightclients.solomachine.v3.ConsensusState(
    publicKey,
    diversifier,
    timestamp
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[ibc.lightclients.solomachine.v3.ConsensusState])
}
