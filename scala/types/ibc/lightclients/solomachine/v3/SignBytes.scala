...
final case class SignBytes(
    ...
    def withPath(__v: _root_.com.google.protobuf.ByteString): SignBytes = copy(path = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => _root_.scalapb.descriptors.PByteString(path)
        case 5 => _root_.scalapb.descriptors.PByteString(data)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: ibc.lightclients.solomachine.v3.SignBytes.type = ibc.lightclients.solomachine.v3.SignBytes
    // @@protoc_insertion_point(GeneratedMessage[ibc.lightclients.solomachine.v3.SignBytes])
}

object SignBytes extends scalapb.GeneratedMessageCompanion[ibc.lightclients.solomachine.v3.SignBytes] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[ibc.lightclients.solomachine.v3.SignBytes] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): ibc.lightclients.solomachine.v3.SignBytes = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[ibc.lightclients.solomachine.v3.SignBytes] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      ibc.lightclients.solomachine.v3.SignBytes(
        ...
        path = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.com.google.protobuf.ByteString]).getOrElse(_root_.com.google.protobuf.ByteString.EMPTY),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ibc.lightclients.solomachine.v3.SolomachineProto.javaDescriptor.getMessageTypes().get(6)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ibc.lightclients.solomachine.v3.SolomachineProto.scalaDescriptor.messages(6)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = ibc.lightclients.solomachine.v3.SignBytes(
    sequence = 0L,
    timestamp = 0L,
    diversifier = "",
  ...
  implicit class SignBytesLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, ibc.lightclients.solomachine.v3.SignBytes]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, ibc.lightclients.solomachine.v3.SignBytes](_l) {
  ...
  ): _root_.ibc.lightclients.solomachine.v3.SignBytes = _root_.ibc.lightclients.solomachine.v3.SignBytes(
    sequence,
    timestamp,
    diversifier,
    path,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[ibc.lightclients.solomachine.v3.SignBytes])
}
