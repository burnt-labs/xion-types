...
final case class MintIncentiveTokens(
    ...
    def companion: xion.mint.v1.MintIncentiveTokens.type = xion.mint.v1.MintIncentiveTokens
    // @@protoc_insertion_point(GeneratedMessage[xion.mint.v1.MintIncentiveTokens])
}

object MintIncentiveTokens extends scalapb.GeneratedMessageCompanion[xion.mint.v1.MintIncentiveTokens] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[xion.mint.v1.MintIncentiveTokens] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): xion.mint.v1.MintIncentiveTokens = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[xion.mint.v1.MintIncentiveTokens] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = xion.mint.v1.EventProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = xion.mint.v1.EventProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = xion.mint.v1.MintIncentiveTokens(
    bondedRatio = "",
    inflation = "",
    annualProvisions = "",
    neededAmount = 0L,
  ...
  implicit class MintIncentiveTokensLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, xion.mint.v1.MintIncentiveTokens]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, xion.mint.v1.MintIncentiveTokens](_l) {
  ...
  ): _root_.xion.mint.v1.MintIncentiveTokens = _root_.xion.mint.v1.MintIncentiveTokens(
    bondedRatio,
    inflation,
    annualProvisions,
    neededAmount,
