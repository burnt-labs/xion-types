...
final case class Params(
    ...
    def companion: xion.mint.v1.Params.type = xion.mint.v1.Params
    // @@protoc_insertion_point(GeneratedMessage[xion.mint.v1.Params])
}

object Params extends scalapb.GeneratedMessageCompanion[xion.mint.v1.Params] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[xion.mint.v1.Params] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): xion.mint.v1.Params = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[xion.mint.v1.Params] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = xion.mint.v1.MintProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = xion.mint.v1.MintProto.scalaDescriptor.messages(1)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = xion.mint.v1.Params(
    mintDenom = "",
    inflationRateChange = "",
    inflationMax = "",
    inflationMin = "",
  ...
  implicit class ParamsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, xion.mint.v1.Params]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, xion.mint.v1.Params](_l) {
  ...
  ): _root_.xion.mint.v1.Params = _root_.xion.mint.v1.Params(
    mintDenom,
    inflationRateChange,
    inflationMax,
    inflationMin,
