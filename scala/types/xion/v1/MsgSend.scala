...
final case class MsgSend(
    ...
    def companion: xion.v1.MsgSend.type = xion.v1.MsgSend
    // @@protoc_insertion_point(GeneratedMessage[xion.v1.MsgSend])
}

object MsgSend extends scalapb.GeneratedMessageCompanion[xion.v1.MsgSend] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[xion.v1.MsgSend] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): xion.v1.MsgSend = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[xion.v1.MsgSend] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = xion.v1.TxProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = xion.v1.TxProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = xion.v1.MsgSend(
    fromAddress = "",
    toAddress = "",
    amount = _root_.scala.Seq.empty
  )
  implicit class MsgSendLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, xion.v1.MsgSend]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, xion.v1.MsgSend](_l) {
  ...
  ): _root_.xion.v1.MsgSend = _root_.xion.v1.MsgSend(
    fromAddress,
    toAddress,
    amount
  )
