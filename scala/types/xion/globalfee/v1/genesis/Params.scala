...
final case class Params(
    minimumGasPrices: _root_.scala.Seq[cosmos.base.v1beta1.coin.DecCoin] = _root_.scala.Seq.empty,
    ...
    def addMinimumGasPrices(__vs: cosmos.base.v1beta1.coin.DecCoin *): Params = addAllMinimumGasPrices(__vs)
    def addAllMinimumGasPrices(__vs: Iterable[cosmos.base.v1beta1.coin.DecCoin]): Params = copy(minimumGasPrices = minimumGasPrices ++ __vs)
    def withMinimumGasPrices(__v: _root_.scala.Seq[cosmos.base.v1beta1.coin.DecCoin]): Params = copy(minimumGasPrices = __v)
    ...
    def companion: xion.globalfee.v1.genesis.Params.type = xion.globalfee.v1.genesis.Params
    // @@protoc_insertion_point(GeneratedMessage[xion.globalfee.v1.Params])
}

object Params extends scalapb.GeneratedMessageCompanion[xion.globalfee.v1.genesis.Params] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[xion.globalfee.v1.genesis.Params] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): xion.globalfee.v1.genesis.Params = {
    val __minimumGasPrices: _root_.scala.collection.immutable.VectorBuilder[cosmos.base.v1beta1.coin.DecCoin] = new _root_.scala.collection.immutable.VectorBuilder[cosmos.base.v1beta1.coin.DecCoin]
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 10 =>
          __minimumGasPrices += _root_.scalapb.LiteParser.readMessage[cosmos.base.v1beta1.coin.DecCoin](_input__)
        case 18 =>
    ...
    xion.globalfee.v1.genesis.Params(
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[xion.globalfee.v1.genesis.Params] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      xion.globalfee.v1.genesis.Params(
        minimumGasPrices = __fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scala.Seq[cosmos.base.v1beta1.coin.DecCoin]]).getOrElse(_root_.scala.Seq.empty),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = xion.globalfee.v1.genesis.GenesisProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = xion.globalfee.v1.genesis.GenesisProto.scalaDescriptor.messages(1)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 1 => __out = cosmos.base.v1beta1.coin.DecCoin
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = xion.globalfee.v1.genesis.Params(
    minimumGasPrices = _root_.scala.Seq.empty,
    bypassMinFeeMsgTypes = _root_.scala.Seq.empty,
    maxTotalBypassMinFeeMsgGasUsage = 0L
  )
  implicit class ParamsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, xion.globalfee.v1.genesis.Params]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, xion.globalfee.v1.genesis.Params](_l) {
    def minimumGasPrices: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Seq[cosmos.base.v1beta1.coin.DecCoin]] = field(_.minimumGasPrices)((c_, f_) => c_.copy(minimumGasPrices = f_))
  ...
  def of(
    minimumGasPrices: _root_.scala.Seq[cosmos.base.v1beta1.coin.DecCoin],
    bypassMinFeeMsgTypes: _root_.scala.Seq[_root_.scala.Predef.String],
    maxTotalBypassMinFeeMsgGasUsage: _root_.scala.Long
  ): _root_.xion.globalfee.v1.genesis.Params = _root_.xion.globalfee.v1.genesis.Params(
    minimumGasPrices,
