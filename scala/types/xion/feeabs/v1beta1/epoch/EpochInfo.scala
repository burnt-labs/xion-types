...
final case class EpochInfo(
    ...
    def companion: xion.feeabs.v1beta1.epoch.EpochInfo.type = xion.feeabs.v1beta1.epoch.EpochInfo
    // @@protoc_insertion_point(GeneratedMessage[xion.feeabs.v1beta1.EpochInfo])
}

object EpochInfo extends scalapb.GeneratedMessageCompanion[xion.feeabs.v1beta1.epoch.EpochInfo] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[xion.feeabs.v1beta1.epoch.EpochInfo] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): xion.feeabs.v1beta1.epoch.EpochInfo = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[xion.feeabs.v1beta1.epoch.EpochInfo] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = xion.feeabs.v1beta1.epoch.EpochProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = xion.feeabs.v1beta1.epoch.EpochProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = xion.feeabs.v1beta1.epoch.EpochInfo(
    identifier = "",
  ...
  implicit class EpochInfoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, xion.feeabs.v1beta1.epoch.EpochInfo]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, xion.feeabs.v1beta1.epoch.EpochInfo](_l) {
  ...
  ): _root_.xion.feeabs.v1beta1.epoch.EpochInfo = _root_.xion.feeabs.v1beta1.epoch.EpochInfo(
    identifier,
    startTime,
    duration,
    currentEpoch,
