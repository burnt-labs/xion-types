...
final case class HostChainFeeAbsConfig(
    ...
    def withStatus(__v: xion.feeabs.v1beta1.HostChainFeeAbsStatus): HostChainFeeAbsConfig = copy(status = __v)
    ...
    def companion: xion.feeabs.v1beta1.HostChainFeeAbsConfig.type = xion.feeabs.v1beta1.HostChainFeeAbsConfig
    // @@protoc_insertion_point(GeneratedMessage[xion.feeabs.v1beta1.HostChainFeeAbsConfig])
}

object HostChainFeeAbsConfig extends scalapb.GeneratedMessageCompanion[xion.feeabs.v1beta1.HostChainFeeAbsConfig] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[xion.feeabs.v1beta1.HostChainFeeAbsConfig] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): xion.feeabs.v1beta1.HostChainFeeAbsConfig = {
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 32 =>
          __status = xion.feeabs.v1beta1.HostChainFeeAbsStatus.fromValue(_input__.readEnum())
        case tag =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[xion.feeabs.v1beta1.HostChainFeeAbsConfig] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = xion.feeabs.v1beta1.ProposalProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = xion.feeabs.v1beta1.ProposalProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 4 => xion.feeabs.v1beta1.HostChainFeeAbsStatus
    }
  }
  lazy val defaultInstance = xion.feeabs.v1beta1.HostChainFeeAbsConfig(
    ibcDenom = "",
  ...
  implicit class HostChainFeeAbsConfigLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, xion.feeabs.v1beta1.HostChainFeeAbsConfig]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, xion.feeabs.v1beta1.HostChainFeeAbsConfig](_l) {
    ...
    def status: _root_.scalapb.lenses.Lens[UpperPB, xion.feeabs.v1beta1.HostChainFeeAbsStatus] = field(_.status)((c_, f_) => c_.copy(status = f_))
  }
  ...
  def of(
    ...
    status: xion.feeabs.v1beta1.HostChainFeeAbsStatus
  ): _root_.xion.feeabs.v1beta1.HostChainFeeAbsConfig = _root_.xion.feeabs.v1beta1.HostChainFeeAbsConfig(
    ibcDenom,
    osmosisPoolTokenDenomIn,
    poolId,
    status
