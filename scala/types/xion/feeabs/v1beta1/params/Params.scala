...
package xion.feeabs.v1beta1.params
...
final case class Params(
    ...
    def companion: xion.feeabs.v1beta1.params.Params.type = xion.feeabs.v1beta1.params.Params
    // @@protoc_insertion_point(GeneratedMessage[xion.feeabs.v1beta1.Params])
}

object Params extends scalapb.GeneratedMessageCompanion[xion.feeabs.v1beta1.params.Params] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[xion.feeabs.v1beta1.params.Params] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): xion.feeabs.v1beta1.params.Params = {
    ...
    xion.feeabs.v1beta1.params.Params(
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[xion.feeabs.v1beta1.params.Params] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = xion.feeabs.v1beta1.params.ParamsProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = xion.feeabs.v1beta1.params.ParamsProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = xion.feeabs.v1beta1.params.Params(
  ...
  implicit class ParamsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, xion.feeabs.v1beta1.params.Params]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, xion.feeabs.v1beta1.params.Params](_l) {
  ...
  def of(
    ...
    ibcQueryIcqChannel: _root_.scala.Predef.String,
    osmosisCrosschainSwapAddress: _root_.scala.Predef.String
  ): _root_.xion.feeabs.v1beta1.params.Params = _root_.xion.feeabs.v1beta1.params.Params(
    nativeIbcedInOsmosis,
    osmosisQueryTwapPath,
    chainName,
    ibcTransferChannel,
