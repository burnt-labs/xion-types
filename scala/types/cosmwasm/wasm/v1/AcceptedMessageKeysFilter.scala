...
final case class AcceptedMessageKeysFilter(
    ...
    def companion: cosmwasm.wasm.v1.AcceptedMessageKeysFilter.type = cosmwasm.wasm.v1.AcceptedMessageKeysFilter
    // @@protoc_insertion_point(GeneratedMessage[cosmwasm.wasm.v1.AcceptedMessageKeysFilter])
}

object AcceptedMessageKeysFilter extends scalapb.GeneratedMessageCompanion[cosmwasm.wasm.v1.AcceptedMessageKeysFilter] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmwasm.wasm.v1.AcceptedMessageKeysFilter] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmwasm.wasm.v1.AcceptedMessageKeysFilter = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmwasm.wasm.v1.AcceptedMessageKeysFilter] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmwasm.wasm.v1.AuthzProto.javaDescriptor.getMessageTypes().get(9)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmwasm.wasm.v1.AuthzProto.scalaDescriptor.messages(9)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = cosmwasm.wasm.v1.AcceptedMessageKeysFilter(
    keys = _root_.scala.Seq.empty
  )
  implicit class AcceptedMessageKeysFilterLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmwasm.wasm.v1.AcceptedMessageKeysFilter]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmwasm.wasm.v1.AcceptedMessageKeysFilter](_l) {
  ...
  ): _root_.cosmwasm.wasm.v1.AcceptedMessageKeysFilter = _root_.cosmwasm.wasm.v1.AcceptedMessageKeysFilter(
    keys
  )
