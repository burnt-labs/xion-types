...
final case class ContractGrant(
    ...
    def companion: cosmwasm.wasm.v1.authz.ContractGrant.type = cosmwasm.wasm.v1.authz.ContractGrant
    // @@protoc_insertion_point(GeneratedMessage[cosmwasm.wasm.v1.ContractGrant])
}

object ContractGrant extends scalapb.GeneratedMessageCompanion[cosmwasm.wasm.v1.authz.ContractGrant] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmwasm.wasm.v1.authz.ContractGrant] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmwasm.wasm.v1.authz.ContractGrant = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmwasm.wasm.v1.authz.ContractGrant] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmwasm.wasm.v1.authz.AuthzProto.javaDescriptor.getMessageTypes().get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmwasm.wasm.v1.authz.AuthzProto.scalaDescriptor.messages(4)
  ...
  lazy val defaultInstance = cosmwasm.wasm.v1.authz.ContractGrant(
    contract = "",
    limit = _root_.scala.None,
    filter = _root_.scala.None
  )
  implicit class ContractGrantLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmwasm.wasm.v1.authz.ContractGrant]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmwasm.wasm.v1.authz.ContractGrant](_l) {
  ...
  ): _root_.cosmwasm.wasm.v1.authz.ContractGrant = _root_.cosmwasm.wasm.v1.authz.ContractGrant(
    contract,
    limit,
    filter
  )
