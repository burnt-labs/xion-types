...
final case class QueryContractsByCodeResponse(
    ...
    def withPagination(__v: cosmos.base.query.v1beta1.PageResponse): QueryContractsByCodeResponse = copy(pagination = Option(__v))
    ...
    def companion: cosmwasm.wasm.v1.QueryContractsByCodeResponse.type = cosmwasm.wasm.v1.QueryContractsByCodeResponse
    // @@protoc_insertion_point(GeneratedMessage[cosmwasm.wasm.v1.QueryContractsByCodeResponse])
}

object QueryContractsByCodeResponse extends scalapb.GeneratedMessageCompanion[cosmwasm.wasm.v1.QueryContractsByCodeResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmwasm.wasm.v1.QueryContractsByCodeResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmwasm.wasm.v1.QueryContractsByCodeResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmwasm.wasm.v1.QueryContractsByCodeResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmwasm.wasm.v1.QueryProto.javaDescriptor.getMessageTypes().get(5)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmwasm.wasm.v1.QueryProto.scalaDescriptor.messages(5)
  ...
  lazy val defaultInstance = cosmwasm.wasm.v1.QueryContractsByCodeResponse(
    contracts = _root_.scala.Seq.empty,
    pagination = _root_.scala.None
  )
  implicit class QueryContractsByCodeResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmwasm.wasm.v1.QueryContractsByCodeResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmwasm.wasm.v1.QueryContractsByCodeResponse](_l) {
  ...
  ): _root_.cosmwasm.wasm.v1.QueryContractsByCodeResponse = _root_.cosmwasm.wasm.v1.QueryContractsByCodeResponse(
    contracts,
    pagination
  )
