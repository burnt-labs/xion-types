...
final case class MsgExecuteContract(
    ...
    def addFunds(__vs: cosmos.base.v1beta1.Coin *): MsgExecuteContract = addAllFunds(__vs)
    def addAllFunds(__vs: Iterable[cosmos.base.v1beta1.Coin]): MsgExecuteContract = copy(funds = funds ++ __vs)
    def withFunds(__v: _root_.scala.Seq[cosmos.base.v1beta1.Coin]): MsgExecuteContract = copy(funds = __v)
    ...
    def companion: cosmwasm.wasm.v1.MsgExecuteContract.type = cosmwasm.wasm.v1.MsgExecuteContract
    // @@protoc_insertion_point(GeneratedMessage[cosmwasm.wasm.v1.MsgExecuteContract])
}

object MsgExecuteContract extends scalapb.GeneratedMessageCompanion[cosmwasm.wasm.v1.MsgExecuteContract] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmwasm.wasm.v1.MsgExecuteContract] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmwasm.wasm.v1.MsgExecuteContract = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmwasm.wasm.v1.MsgExecuteContract] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      cosmwasm.wasm.v1.MsgExecuteContract(
        ...
        funds = __fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).map(_.as[_root_.scala.Seq[cosmos.base.v1beta1.Coin]]).getOrElse(_root_.scala.Seq.empty)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmwasm.wasm.v1.TxProto.javaDescriptor.getMessageTypes().get(6)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmwasm.wasm.v1.TxProto.scalaDescriptor.messages(6)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 5 => __out = cosmos.base.v1beta1.Coin
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = cosmwasm.wasm.v1.MsgExecuteContract(
    sender = "",
    contract = "",
    msg = _root_.com.google.protobuf.ByteString.EMPTY,
    funds = _root_.scala.Seq.empty
  )
  implicit class MsgExecuteContractLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmwasm.wasm.v1.MsgExecuteContract]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmwasm.wasm.v1.MsgExecuteContract](_l) {
  ...
  ): _root_.cosmwasm.wasm.v1.MsgExecuteContract = _root_.cosmwasm.wasm.v1.MsgExecuteContract(
    sender,
    contract,
    msg,
    funds
