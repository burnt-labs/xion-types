...
object Http extends scalapb.GeneratedMessageCompanion[com.google.api.Http] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = com.google.api.HttpProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = com.google.api.HttpProto.scalaDescriptor.messages(0)
