...
object AnnotationsProto extends _root_.scalapb.GeneratedFileObject {
  ...
  val http: _root_.scalapb.GeneratedExtension[com.google.protobuf.descriptor.MethodOptions, _root_.scala.Option[com.google.api.HttpRule]] =
    _root_.scalapb.GeneratedExtension.forOptionalUnknownMessageField(72295728, _root_.scalapb.UnknownFieldSet.Field.lengthDelimitedLens)({__valueIn => _root_.scalapb.GeneratedExtension.readMessageFromByteString(com.google.api.HttpRule)(__valueIn)}, {(__valueIn: com.google.api.HttpRule) => __valueIn.toByteString})
}