...
final case class Params(
    ...
    def companion: abstractaccount.v1.params.Params.type = abstractaccount.v1.params.Params
    // @@protoc_insertion_point(GeneratedMessage[abstractaccount.v1.Params])
}

object Params extends scalapb.GeneratedMessageCompanion[abstractaccount.v1.params.Params] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[abstractaccount.v1.params.Params] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): abstractaccount.v1.params.Params = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[abstractaccount.v1.params.Params] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = abstractaccount.v1.params.ParamsProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = abstractaccount.v1.params.ParamsProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = abstractaccount.v1.params.Params(
    allowAllCodeIds = false,
    allowedCodeIds = _root_.scala.Seq.empty,
    maxGasBefore = 0L,
    maxGasAfter = 0L
  )
  implicit class ParamsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, abstractaccount.v1.params.Params]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, abstractaccount.v1.params.Params](_l) {
  ...
  ): _root_.abstractaccount.v1.params.Params = _root_.abstractaccount.v1.params.Params(
    allowAllCodeIds,
    allowedCodeIds,
    maxGasBefore,
    maxGasAfter
