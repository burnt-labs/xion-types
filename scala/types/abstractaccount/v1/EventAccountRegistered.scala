...
final case class EventAccountRegistered(
    ...
    def companion: abstractaccount.v1.EventAccountRegistered.type = abstractaccount.v1.EventAccountRegistered
    // @@protoc_insertion_point(GeneratedMessage[abstractaccount.v1.EventAccountRegistered])
}

object EventAccountRegistered extends scalapb.GeneratedMessageCompanion[abstractaccount.v1.EventAccountRegistered] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[abstractaccount.v1.EventAccountRegistered] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): abstractaccount.v1.EventAccountRegistered = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[abstractaccount.v1.EventAccountRegistered] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = abstractaccount.v1.EventsProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = abstractaccount.v1.EventsProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = abstractaccount.v1.EventAccountRegistered(
    creator = "",
    codeId = 0L,
    contractAddr = "",
    accountNumber = 0L
  )
  implicit class EventAccountRegisteredLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, abstractaccount.v1.EventAccountRegistered]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, abstractaccount.v1.EventAccountRegistered](_l) {
  ...
  ): _root_.abstractaccount.v1.EventAccountRegistered = _root_.abstractaccount.v1.EventAccountRegistered(
    creator,
    codeId,
    contractAddr,
    accountNumber
