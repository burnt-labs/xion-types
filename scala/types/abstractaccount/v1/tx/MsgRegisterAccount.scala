...
final case class MsgRegisterAccount(
    ...
    def addFunds(__vs: cosmos.base.v1beta1.coin.Coin *): MsgRegisterAccount = addAllFunds(__vs)
    def addAllFunds(__vs: Iterable[cosmos.base.v1beta1.coin.Coin]): MsgRegisterAccount = copy(funds = funds ++ __vs)
    def withFunds(__v: _root_.scala.Seq[cosmos.base.v1beta1.coin.Coin]): MsgRegisterAccount = copy(funds = __v)
    ...
    def companion: abstractaccount.v1.tx.MsgRegisterAccount.type = abstractaccount.v1.tx.MsgRegisterAccount
    // @@protoc_insertion_point(GeneratedMessage[abstractaccount.v1.MsgRegisterAccount])
}

object MsgRegisterAccount extends scalapb.GeneratedMessageCompanion[abstractaccount.v1.tx.MsgRegisterAccount] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[abstractaccount.v1.tx.MsgRegisterAccount] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): abstractaccount.v1.tx.MsgRegisterAccount = {
    ...
    abstractaccount.v1.tx.MsgRegisterAccount(
        sender = __sender,
        codeId = __codeId,
        msg = __msg,
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[abstractaccount.v1.tx.MsgRegisterAccount] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      abstractaccount.v1.tx.MsgRegisterAccount(
        ...
        funds = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Seq[cosmos.base.v1beta1.coin.Coin]]).getOrElse(_root_.scala.Seq.empty),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = abstractaccount.v1.tx.TxProto.javaDescriptor.getMessageTypes().get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = abstractaccount.v1.tx.TxProto.scalaDescriptor.messages(2)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 4 => __out = cosmos.base.v1beta1.coin.Coin
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = abstractaccount.v1.tx.MsgRegisterAccount(
    sender = "",
    codeId = 0L,
  ...
  implicit class MsgRegisterAccountLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, abstractaccount.v1.tx.MsgRegisterAccount]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, abstractaccount.v1.tx.MsgRegisterAccount](_l) {
  ...
  ): _root_.abstractaccount.v1.tx.MsgRegisterAccount = _root_.abstractaccount.v1.tx.MsgRegisterAccount(
    sender,
    codeId,
    msg,
    funds,
