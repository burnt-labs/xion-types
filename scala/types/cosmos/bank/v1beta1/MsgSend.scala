...
final case class MsgSend(
    ...
    def addAmount(__vs: cosmos.base.v1beta1.Coin *): MsgSend = addAllAmount(__vs)
    def addAllAmount(__vs: Iterable[cosmos.base.v1beta1.Coin]): MsgSend = copy(amount = amount ++ __vs)
    def withAmount(__v: _root_.scala.Seq[cosmos.base.v1beta1.Coin]): MsgSend = copy(amount = __v)
    ...
    def companion: cosmos.bank.v1beta1.MsgSend.type = cosmos.bank.v1beta1.MsgSend
    // @@protoc_insertion_point(GeneratedMessage[cosmos.bank.v1beta1.MsgSend])
}

object MsgSend extends scalapb.GeneratedMessageCompanion[cosmos.bank.v1beta1.MsgSend] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmos.bank.v1beta1.MsgSend] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmos.bank.v1beta1.MsgSend = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmos.bank.v1beta1.MsgSend] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmos.bank.v1beta1.TxProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmos.bank.v1beta1.TxProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = cosmos.bank.v1beta1.MsgSend(
    fromAddress = "",
    toAddress = "",
    amount = _root_.scala.Seq.empty
  )
  implicit class MsgSendLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmos.bank.v1beta1.MsgSend]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmos.bank.v1beta1.MsgSend](_l) {
  ...
  ): _root_.cosmos.bank.v1beta1.MsgSend = _root_.cosmos.bank.v1beta1.MsgSend(
    fromAddress,
    toAddress,
    amount
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[cosmos.bank.v1beta1.MsgSend])
}
