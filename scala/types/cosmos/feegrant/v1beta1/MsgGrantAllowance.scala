...
/** MsgGrantAllowance adds permission for Grantee to spend up to Allowance
  ...
  */
@SerialVersionUID(0L)
final case class MsgGrantAllowance(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[MsgGrantAllowance] {
    @transient
    ...
    def withGranter(__v: _root_.scala.Predef.String): MsgGrantAllowance = copy(granter = __v)
    def withGrantee(__v: _root_.scala.Predef.String): MsgGrantAllowance = copy(grantee = __v)
    def getAllowance: com.google.protobuf.any.Any = allowance.getOrElse(com.google.protobuf.any.Any.defaultInstance)
    def clearAllowance: MsgGrantAllowance = copy(allowance = _root_.scala.None)
    def withAllowance(__v: com.google.protobuf.any.Any): MsgGrantAllowance = copy(allowance = Option(__v))
    ...
    def companion: cosmos.feegrant.v1beta1.MsgGrantAllowance.type = cosmos.feegrant.v1beta1.MsgGrantAllowance
    // @@protoc_insertion_point(GeneratedMessage[cosmos.feegrant.v1beta1.MsgGrantAllowance])
}

object MsgGrantAllowance extends scalapb.GeneratedMessageCompanion[cosmos.feegrant.v1beta1.MsgGrantAllowance] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmos.feegrant.v1beta1.MsgGrantAllowance] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmos.feegrant.v1beta1.MsgGrantAllowance = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmos.feegrant.v1beta1.MsgGrantAllowance] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmos.feegrant.v1beta1.TxProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmos.feegrant.v1beta1.TxProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = cosmos.feegrant.v1beta1.MsgGrantAllowance(
    granter = "",
    grantee = "",
    allowance = _root_.scala.None
  )
  implicit class MsgGrantAllowanceLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmos.feegrant.v1beta1.MsgGrantAllowance]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmos.feegrant.v1beta1.MsgGrantAllowance](_l) {
  ...
  ): _root_.cosmos.feegrant.v1beta1.MsgGrantAllowance = _root_.cosmos.feegrant.v1beta1.MsgGrantAllowance(
    granter,
    grantee,
    allowance
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[cosmos.feegrant.v1beta1.MsgGrantAllowance])
}
