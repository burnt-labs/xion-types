...
/** MsgUndelegate defines a SDK message for performing an undelegation from a
  ...
  */
@SerialVersionUID(0L)
final case class MsgUndelegate(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[MsgUndelegate] {
    @transient
    ...
    def withDelegatorAddress(__v: _root_.scala.Predef.String): MsgUndelegate = copy(delegatorAddress = __v)
    def withValidatorAddress(__v: _root_.scala.Predef.String): MsgUndelegate = copy(validatorAddress = __v)
    def getAmount: cosmos.base.v1beta1.Coin = amount.getOrElse(cosmos.base.v1beta1.Coin.defaultInstance)
    def clearAmount: MsgUndelegate = copy(amount = _root_.scala.None)
    def withAmount(__v: cosmos.base.v1beta1.Coin): MsgUndelegate = copy(amount = Option(__v))
    ...
    def companion: cosmos.staking.v1beta1.MsgUndelegate.type = cosmos.staking.v1beta1.MsgUndelegate
    // @@protoc_insertion_point(GeneratedMessage[cosmos.staking.v1beta1.MsgUndelegate])
}

object MsgUndelegate extends scalapb.GeneratedMessageCompanion[cosmos.staking.v1beta1.MsgUndelegate] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmos.staking.v1beta1.MsgUndelegate] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmos.staking.v1beta1.MsgUndelegate = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmos.staking.v1beta1.MsgUndelegate] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmos.staking.v1beta1.TxProto.javaDescriptor.getMessageTypes().get(8)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmos.staking.v1beta1.TxProto.scalaDescriptor.messages(8)
  ...
  lazy val defaultInstance = cosmos.staking.v1beta1.MsgUndelegate(
    delegatorAddress = "",
    validatorAddress = "",
    amount = _root_.scala.None
  )
  implicit class MsgUndelegateLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmos.staking.v1beta1.MsgUndelegate]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmos.staking.v1beta1.MsgUndelegate](_l) {
  ...
  ): _root_.cosmos.staking.v1beta1.MsgUndelegate = _root_.cosmos.staking.v1beta1.MsgUndelegate(
    delegatorAddress,
    validatorAddress,
    amount
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[cosmos.staking.v1beta1.MsgUndelegate])
}
