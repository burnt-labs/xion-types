...
final case class EpochInfo(
    ...
    def companion: cosmos.epochs.v1beta1.EpochInfo.type = cosmos.epochs.v1beta1.EpochInfo
    // @@protoc_insertion_point(GeneratedMessage[cosmos.epochs.v1beta1.EpochInfo])
}

object EpochInfo extends scalapb.GeneratedMessageCompanion[cosmos.epochs.v1beta1.EpochInfo] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmos.epochs.v1beta1.EpochInfo] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmos.epochs.v1beta1.EpochInfo = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmos.epochs.v1beta1.EpochInfo] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmos.epochs.v1beta1.GenesisProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmos.epochs.v1beta1.GenesisProto.scalaDescriptor.messages(0)
  ...
  lazy val defaultInstance = cosmos.epochs.v1beta1.EpochInfo(
    identifier = "",
  ...
  implicit class EpochInfoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmos.epochs.v1beta1.EpochInfo]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmos.epochs.v1beta1.EpochInfo](_l) {
  ...
  ): _root_.cosmos.epochs.v1beta1.EpochInfo = _root_.cosmos.epochs.v1beta1.EpochInfo(
    identifier,
    startTime,
    duration,
    currentEpoch,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[cosmos.epochs.v1beta1.EpochInfo])
}
