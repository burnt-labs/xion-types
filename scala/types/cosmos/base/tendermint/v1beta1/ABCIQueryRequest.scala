...
/** ABCIQueryRequest defines the request structure for the ABCIQuery gRPC query.
  */
@SerialVersionUID(0L)
final case class ABCIQueryRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ABCIQueryRequest] {
    @transient
    ...
    def withData(__v: _root_.com.google.protobuf.ByteString): ABCIQueryRequest = copy(data = __v)
    def withPath(__v: _root_.scala.Predef.String): ABCIQueryRequest = copy(path = __v)
    def withHeight(__v: _root_.scala.Long): ABCIQueryRequest = copy(height = __v)
    def withProve(__v: _root_.scala.Boolean): ABCIQueryRequest = copy(prove = __v)
    ...
    def companion: cosmos.base.tendermint.v1beta1.ABCIQueryRequest.type = cosmos.base.tendermint.v1beta1.ABCIQueryRequest
    // @@protoc_insertion_point(GeneratedMessage[cosmos.base.tendermint.v1beta1.ABCIQueryRequest])
}

object ABCIQueryRequest extends scalapb.GeneratedMessageCompanion[cosmos.base.tendermint.v1beta1.ABCIQueryRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmos.base.tendermint.v1beta1.ABCIQueryRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmos.base.tendermint.v1beta1.ABCIQueryRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmos.base.tendermint.v1beta1.ABCIQueryRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmos.base.tendermint.v1beta1.QueryProto.javaDescriptor.getMessageTypes().get(15)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmos.base.tendermint.v1beta1.QueryProto.scalaDescriptor.messages(15)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = cosmos.base.tendermint.v1beta1.ABCIQueryRequest(
    data = _root_.com.google.protobuf.ByteString.EMPTY,
    path = "",
    height = 0L,
    prove = false
  )
  implicit class ABCIQueryRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmos.base.tendermint.v1beta1.ABCIQueryRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmos.base.tendermint.v1beta1.ABCIQueryRequest](_l) {
  ...
  ): _root_.cosmos.base.tendermint.v1beta1.ABCIQueryRequest = _root_.cosmos.base.tendermint.v1beta1.ABCIQueryRequest(
    data,
    path,
    height,
    prove
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[cosmos.base.tendermint.v1beta1.ABCIQueryRequest])
}
