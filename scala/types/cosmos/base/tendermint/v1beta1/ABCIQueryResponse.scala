...
/** ABCIQueryResponse defines the response structure for the ABCIQuery gRPC query.
  ...
  */
@SerialVersionUID(0L)
final case class ABCIQueryResponse(
    ...
    proofOps: _root_.scala.Option[cosmos.base.tendermint.v1beta1.ProofOps] = _root_.scala.None,
    height: _root_.scala.Long = 0L,
    codespace: _root_.scala.Predef.String = "",
    unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ABCIQueryResponse] {
    @transient
    ...
    def withCode(__v: _root_.scala.Int): ABCIQueryResponse = copy(code = __v)
    def withLog(__v: _root_.scala.Predef.String): ABCIQueryResponse = copy(log = __v)
    def withInfo(__v: _root_.scala.Predef.String): ABCIQueryResponse = copy(info = __v)
    def withIndex(__v: _root_.scala.Long): ABCIQueryResponse = copy(index = __v)
    def withKey(__v: _root_.com.google.protobuf.ByteString): ABCIQueryResponse = copy(key = __v)
    def withValue(__v: _root_.com.google.protobuf.ByteString): ABCIQueryResponse = copy(value = __v)
    def getProofOps: cosmos.base.tendermint.v1beta1.ProofOps = proofOps.getOrElse(cosmos.base.tendermint.v1beta1.ProofOps.defaultInstance)
    def clearProofOps: ABCIQueryResponse = copy(proofOps = _root_.scala.None)
    def withProofOps(__v: cosmos.base.tendermint.v1beta1.ProofOps): ABCIQueryResponse = copy(proofOps = Option(__v))
    def withHeight(__v: _root_.scala.Long): ABCIQueryResponse = copy(height = __v)
    def withCodespace(__v: _root_.scala.Predef.String): ABCIQueryResponse = copy(codespace = __v)
    ...
    def companion: cosmos.base.tendermint.v1beta1.ABCIQueryResponse.type = cosmos.base.tendermint.v1beta1.ABCIQueryResponse
    // @@protoc_insertion_point(GeneratedMessage[cosmos.base.tendermint.v1beta1.ABCIQueryResponse])
}

object ABCIQueryResponse extends scalapb.GeneratedMessageCompanion[cosmos.base.tendermint.v1beta1.ABCIQueryResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmos.base.tendermint.v1beta1.ABCIQueryResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmos.base.tendermint.v1beta1.ABCIQueryResponse = {
    ...
    var __proofOps: _root_.scala.Option[cosmos.base.tendermint.v1beta1.ProofOps] = _root_.scala.None
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 66 =>
          __proofOps = _root_.scala.Option(__proofOps.fold(_root_.scalapb.LiteParser.readMessage[cosmos.base.tendermint.v1beta1.ProofOps](_input__))(_root_.scalapb.LiteParser.readMessage(_input__, _)))
        case 72 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmos.base.tendermint.v1beta1.ABCIQueryResponse] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      cosmos.base.tendermint.v1beta1.ABCIQueryResponse(
        ...
        proofOps = __fieldsMap.get(scalaDescriptor.findFieldByNumber(8).get).flatMap(_.as[_root_.scala.Option[cosmos.base.tendermint.v1beta1.ProofOps]]),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmos.base.tendermint.v1beta1.QueryProto.javaDescriptor.getMessageTypes().get(16)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmos.base.tendermint.v1beta1.QueryProto.scalaDescriptor.messages(16)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[_] = null
    (__number: @_root_.scala.unchecked) match {
      case 8 => __out = cosmos.base.tendermint.v1beta1.ProofOps
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = cosmos.base.tendermint.v1beta1.ABCIQueryResponse(
    code = 0,
    log = "",
    info = "",
    index = 0L,
  ...
  implicit class ABCIQueryResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmos.base.tendermint.v1beta1.ABCIQueryResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmos.base.tendermint.v1beta1.ABCIQueryResponse](_l) {
    ...
    def proofOps: _root_.scalapb.lenses.Lens[UpperPB, cosmos.base.tendermint.v1beta1.ProofOps] = field(_.getProofOps)((c_, f_) => c_.copy(proofOps = _root_.scala.Option(f_)))
    def optionalProofOps: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Option[cosmos.base.tendermint.v1beta1.ProofOps]] = field(_.proofOps)((c_, f_) => c_.copy(proofOps = f_))
  ...
  def of(
    ...
    proofOps: _root_.scala.Option[cosmos.base.tendermint.v1beta1.ProofOps],
    height: _root_.scala.Long,
    codespace: _root_.scala.Predef.String
  ): _root_.cosmos.base.tendermint.v1beta1.ABCIQueryResponse = _root_.cosmos.base.tendermint.v1beta1.ABCIQueryResponse(
    code,
    log,
    info,
    index,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[cosmos.base.tendermint.v1beta1.ABCIQueryResponse])
}
