...
/** GetBlockByHeightResponse is the response type for the Query/GetBlockByHeight RPC method.
  ...
  */
@SerialVersionUID(0L)
final case class GetBlockByHeightResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[GetBlockByHeightResponse] {
    @transient
    ...
    def clearBlockId: GetBlockByHeightResponse = copy(blockId = _root_.scala.None)
    def withBlockId(__v: tendermint.types.BlockID): GetBlockByHeightResponse = copy(blockId = Option(__v))
    def getBlock: tendermint.types.Block = block.getOrElse(tendermint.types.Block.defaultInstance)
    def clearBlock: GetBlockByHeightResponse = copy(block = _root_.scala.None)
    def withBlock(__v: tendermint.types.Block): GetBlockByHeightResponse = copy(block = Option(__v))
    ...
    def clearSdkBlock: GetBlockByHeightResponse = copy(sdkBlock = _root_.scala.None)
    def withSdkBlock(__v: cosmos.base.tendermint.v1beta1.Block): GetBlockByHeightResponse = copy(sdkBlock = Option(__v))
    ...
    def companion: cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse.type = cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse
    // @@protoc_insertion_point(GeneratedMessage[cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse])
}

object GetBlockByHeightResponse extends scalapb.GeneratedMessageCompanion[cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmos.base.tendermint.v1beta1.QueryProto.javaDescriptor.getMessageTypes().get(6)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmos.base.tendermint.v1beta1.QueryProto.scalaDescriptor.messages(6)
  ...
  lazy val defaultInstance = cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse(
    blockId = _root_.scala.None,
    block = _root_.scala.None,
    sdkBlock = _root_.scala.None
  )
  implicit class GetBlockByHeightResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse](_l) {
  ...
  ): _root_.cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse = _root_.cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse(
    blockId,
    block,
    sdkBlock
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[cosmos.base.tendermint.v1beta1.GetBlockByHeightResponse])
}
