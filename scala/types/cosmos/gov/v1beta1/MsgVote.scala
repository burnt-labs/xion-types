...
final case class MsgVote(
    ...
    def withOption(__v: cosmos.gov.v1beta1.VoteOption): MsgVote = copy(option = __v)
    ...
    def companion: cosmos.gov.v1beta1.MsgVote.type = cosmos.gov.v1beta1.MsgVote
    // @@protoc_insertion_point(GeneratedMessage[cosmos.gov.v1beta1.MsgVote])
}

object MsgVote extends scalapb.GeneratedMessageCompanion[cosmos.gov.v1beta1.MsgVote] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmos.gov.v1beta1.MsgVote] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmos.gov.v1beta1.MsgVote = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmos.gov.v1beta1.MsgVote] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmos.gov.v1beta1.TxProto.javaDescriptor.getMessageTypes().get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmos.gov.v1beta1.TxProto.scalaDescriptor.messages(2)
  ...
  lazy val defaultInstance = cosmos.gov.v1beta1.MsgVote(
    proposalId = 0L,
    voter = "",
    option = cosmos.gov.v1beta1.VoteOption.VOTE_OPTION_UNSPECIFIED
  )
  implicit class MsgVoteLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmos.gov.v1beta1.MsgVote]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmos.gov.v1beta1.MsgVote](_l) {
  ...
  ): _root_.cosmos.gov.v1beta1.MsgVote = _root_.cosmos.gov.v1beta1.MsgVote(
    proposalId,
    voter,
    option
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[cosmos.gov.v1beta1.MsgVote])
}
