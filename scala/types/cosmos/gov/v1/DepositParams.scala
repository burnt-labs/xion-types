...
final case class DepositParams(
    ...
    def companion: cosmos.gov.v1.DepositParams.type = cosmos.gov.v1.DepositParams
    // @@protoc_insertion_point(GeneratedMessage[cosmos.gov.v1.DepositParams])
}

@scala.deprecated(message="Marked as deprecated in proto file", "")
object DepositParams extends scalapb.GeneratedMessageCompanion[cosmos.gov.v1.DepositParams] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmos.gov.v1.DepositParams] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmos.gov.v1.DepositParams = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmos.gov.v1.DepositParams] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmos.gov.v1.GovProto.javaDescriptor.getMessageTypes().get(5)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmos.gov.v1.GovProto.scalaDescriptor.messages(5)
  ...
  lazy val defaultInstance = cosmos.gov.v1.DepositParams(
    minDeposit = _root_.scala.Seq.empty,
    maxDepositPeriod = _root_.scala.None
  )
  implicit class DepositParamsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmos.gov.v1.DepositParams]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmos.gov.v1.DepositParams](_l) {
  ...
  ): _root_.cosmos.gov.v1.DepositParams = _root_.cosmos.gov.v1.DepositParams(
    minDeposit,
    maxDepositPeriod
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[cosmos.gov.v1.DepositParams])
}
