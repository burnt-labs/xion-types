...
final case class QueryVotesRequest(
    ...
    def companion: cosmos.gov.v1.QueryVotesRequest.type = cosmos.gov.v1.QueryVotesRequest
    // @@protoc_insertion_point(GeneratedMessage[cosmos.gov.v1.QueryVotesRequest])
}

object QueryVotesRequest extends scalapb.GeneratedMessageCompanion[cosmos.gov.v1.QueryVotesRequest] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmos.gov.v1.QueryVotesRequest] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmos.gov.v1.QueryVotesRequest = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmos.gov.v1.QueryVotesRequest] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmos.gov.v1.QueryProto.javaDescriptor.getMessageTypes().get(8)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmos.gov.v1.QueryProto.scalaDescriptor.messages(8)
  ...
  lazy val defaultInstance = cosmos.gov.v1.QueryVotesRequest(
    proposalId = 0L,
    pagination = _root_.scala.None
  )
  implicit class QueryVotesRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmos.gov.v1.QueryVotesRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmos.gov.v1.QueryVotesRequest](_l) {
  ...
  ): _root_.cosmos.gov.v1.QueryVotesRequest = _root_.cosmos.gov.v1.QueryVotesRequest(
    proposalId,
    pagination
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[cosmos.gov.v1.QueryVotesRequest])
}
