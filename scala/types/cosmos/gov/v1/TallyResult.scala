...
final case class TallyResult(
    ...
    def companion: cosmos.gov.v1.TallyResult.type = cosmos.gov.v1.TallyResult
    // @@protoc_insertion_point(GeneratedMessage[cosmos.gov.v1.TallyResult])
}

object TallyResult extends scalapb.GeneratedMessageCompanion[cosmos.gov.v1.TallyResult] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[cosmos.gov.v1.TallyResult] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): cosmos.gov.v1.TallyResult = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[cosmos.gov.v1.TallyResult] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = cosmos.gov.v1.GovProto.javaDescriptor.getMessageTypes().get(3)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = cosmos.gov.v1.GovProto.scalaDescriptor.messages(3)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = cosmos.gov.v1.TallyResult(
    yesCount = "",
    abstainCount = "",
    noCount = "",
    noWithVetoCount = ""
  )
  implicit class TallyResultLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, cosmos.gov.v1.TallyResult]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, cosmos.gov.v1.TallyResult](_l) {
  ...
  def of(
    ...
    noCount: _root_.scala.Predef.String,
    noWithVetoCount: _root_.scala.Predef.String
  ): _root_.cosmos.gov.v1.TallyResult = _root_.cosmos.gov.v1.TallyResult(
    yesCount,
    abstainCount,
    noCount,
    noWithVetoCount
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[cosmos.gov.v1.TallyResult])
}
