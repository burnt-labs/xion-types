...
namespace Cosmos.Ics23.V1 {
    ...
    static ProofsReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "DFIGcHJlZml4EhYKBnN1ZmZpeBgDIAEoDFIGc3VmZml4IrYBCglQcm9vZlNw",
            ...
            "CG1heERlcHRoEhsKCW1pbl9kZXB0aBgEIAEoBVIIbWluRGVwdGgi8QEKCUlu",
            "bmVyU3BlYxIfCgtjaGlsZF9vcmRlchgBIAMoBVIKY2hpbGRPcmRlchIdCgpj",
            "aGlsZF9zaXplGAIgASgFUgljaGlsZFNpemUSKgoRbWluX3ByZWZpeF9sZW5n",
            "dGgYAyABKAVSD21pblByZWZpeExlbmd0aBIqChFtYXhfcHJlZml4X2xlbmd0",
            "aBgEIAEoBVIPbWF4UHJlZml4TGVuZ3RoEh8KC2VtcHR5X2NoaWxkGAUgASgM",
            "UgplbXB0eUNoaWxkEisKBGhhc2gYBiABKA4yFy5jb3Ntb3MuaWNzMjMudjEu",
            "SGFzaE9wUgRoYXNoIkMKCkJhdGNoUHJvb2YSNQoHZW50cmllcxgBIAMoCzIb",
            "LmNvc21vcy5pY3MyMy52MS5CYXRjaEVudHJ5UgdlbnRyaWVzIpABCgpCYXRj",
            "aEVudHJ5EjcKBWV4aXN0GAEgASgLMh8uY29zbW9zLmljczIzLnYxLkV4aXN0",
            "ZW5jZVByb29mSABSBWV4aXN0EkAKCG5vbmV4aXN0GAIgASgLMiIuY29zbW9z",
            "LmljczIzLnYxLk5vbkV4aXN0ZW5jZVByb29mSABSCG5vbmV4aXN0QgcKBXBy",
            "b29mIpYBChRDb21wcmVzc2VkQmF0Y2hQcm9vZhI/CgdlbnRyaWVzGAEgAygL",
            "MiUuY29zbW9zLmljczIzLnYxLkNvbXByZXNzZWRCYXRjaEVudHJ5UgdlbnRy",
            "aWVzEj0KDWxvb2t1cF9pbm5lcnMYAiADKAsyGC5jb3Ntb3MuaWNzMjMudjEu",
            "SW5uZXJPcFIMbG9va3VwSW5uZXJzIq4BChRDb21wcmVzc2VkQmF0Y2hFbnRy",
            "eRJBCgVleGlzdBgBIAEoCzIpLmNvc21vcy5pY3MyMy52MS5Db21wcmVzc2Vk",
            "RXhpc3RlbmNlUHJvb2ZIAFIFZXhpc3QSSgoIbm9uZXhpc3QYAiABKAsyLC5j",
            "b3Ntb3MuaWNzMjMudjEuQ29tcHJlc3NlZE5vbkV4aXN0ZW5jZVByb29mSABS",
            "CG5vbmV4aXN0QgcKBXByb29mIoMBChhDb21wcmVzc2VkRXhpc3RlbmNlUHJv",
            "b2YSEAoDa2V5GAEgASgMUgNrZXkSFAoFdmFsdWUYAiABKAxSBXZhbHVlEisK",
            "BGxlYWYYAyABKAsyFy5jb3Ntb3MuaWNzMjMudjEuTGVhZk9wUgRsZWFmEhIK",
            "BHBhdGgYBCADKAVSBHBhdGgirwEKG0NvbXByZXNzZWROb25FeGlzdGVuY2VQ",
            "cm9vZhIQCgNrZXkYASABKAxSA2tleRI9CgRsZWZ0GAIgASgLMikuY29zbW9z",
            "LmljczIzLnYxLkNvbXByZXNzZWRFeGlzdGVuY2VQcm9vZlIEbGVmdBI/CgVy",
            "aWdodBgDIAEoCzIpLmNvc21vcy5pY3MyMy52MS5Db21wcmVzc2VkRXhpc3Rl",
            "bmNlUHJvb2ZSBXJpZ2h0KmUKBkhhc2hPcBILCgdOT19IQVNIEAASCgoGU0hB",
            "MjU2EAESCgoGU0hBNTEyEAISCgoGS0VDQ0FLEAMSDQoJUklQRU1EMTYwEAQS",
            "CwoHQklUQ09JThAFEg4KClNIQTUxMl8yNTYQBiqrAQoITGVuZ3RoT3ASDQoJ",
            "Tk9fUFJFRklYEAASDQoJVkFSX1BST1RPEAESCwoHVkFSX1JMUBACEg8KC0ZJ",
            "WEVEMzJfQklHEAMSEgoORklYRUQzMl9MSVRUTEUQBBIPCgtGSVhFRDY0X0JJ",
            "RxAFEhIKDkZJWEVENjRfTElUVExFEAYSFAoQUkVRVUlSRV8zMl9CWVRFUxAH",
            "EhQKEFJFUVVJUkVfNjRfQllURVMQCEIiWiBnaXRodWIuY29tL2Nvc21vcy9p",
            "Y3MyMy9nbztpY3MyM2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::Cosmos.Ics23.V1.HashOp), typeof(global::Cosmos.Ics23.V1.LengthOp), }, null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::Cosmos.Ics23.V1.ProofSpec), global::Cosmos.Ics23.V1.ProofSpec.Parser, new[]{ "LeafSpec", "InnerSpec", "MaxDepth", "MinDepth" }, null, null, null, null),
  ...
  public enum HashOp {
    ...
    [pbr::OriginalName("KECCAK")] Keccak = 3,
