...
namespace Ibc.Applications.Transfer.V1 {
    ...
    static AuthzReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "djFiZXRhMS9jb2luLnByb3RvIpECCgpBbGxvY2F0aW9uEh8KC3NvdXJjZV9w",
            "b3J0GAEgASgJUgpzb3VyY2VQb3J0EiUKDnNvdXJjZV9jaGFubmVsGAIgASgJ",
            "Ug1zb3VyY2VDaGFubmVsEmwKC3NwZW5kX2xpbWl0GAMgAygLMhkuY29zbW9z",
            "LmJhc2UudjFiZXRhMS5Db2luQjDI3h8Aqt8fKGdpdGh1Yi5jb20vY29zbW9z",
            "L2Nvc21vcy1zZGsvdHlwZXMuQ29pbnNSCnNwZW5kTGltaXQSHQoKYWxsb3df",
            "bGlzdBgEIAMoCVIJYWxsb3dMaXN0Ei4KE2FsbG93ZWRfcGFja2V0X2RhdGEY",
            "BSADKAlSEWFsbG93ZWRQYWNrZXREYXRhIpEBChVUcmFuc2ZlckF1dGhvcml6",
            "YXRpb24SUAoLYWxsb2NhdGlvbnMYASADKAsyKC5pYmMuYXBwbGljYXRpb25z",
            "LnRyYW5zZmVyLnYxLkFsbG9jYXRpb25CBMjeHwBSC2FsbG9jYXRpb25zOibK",
            "tC0iY29zbW9zLmF1dGh6LnYxYmV0YTEuQXV0aG9yaXphdGlvbkI6WjhnaXRo",
            "dWIuY29tL2Nvc21vcy9pYmMtZ28vdjEwL21vZHVsZXMvYXBwcy90cmFuc2Zl",
            "ci90eXBlc2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Ibc.Applications.Transfer.V1.Allocation), global::Ibc.Applications.Transfer.V1.Allocation.Parser, new[]{ "SourcePort", "SourceChannel", "SpendLimit", "AllowList", "AllowedPacketData" }, null, null, null, null),
  ...
  #endif
  {
    ...
    public Allocation(Allocation other) : this() {
      ...
      allowedPacketData_ = other.allowedPacketData_.Clone();
    ...
    /// <summary>Field number for the "allowed_packet_data" field.</summary>
    public const int AllowedPacketDataFieldNumber = 5;
    private static readonly pb::FieldCodec<string> _repeated_allowedPacketData_codec
        = pb::FieldCodec.ForString(42);
    private readonly pbc::RepeatedField<string> allowedPacketData_ = new pbc::RepeatedField<string>();
    /// <summary>
    ...
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<string> AllowedPacketData {
      get { return allowedPacketData_; }
    }
    ...
    public bool Equals(Allocation other) {
      ...
      if(!allowedPacketData_.Equals(other.allowedPacketData_)) return false;
    ...
    public override int GetHashCode() {
      ...
      hash ^= allowedPacketData_.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      allowedPacketData_.WriteTo(output, _repeated_allowedPacketData_codec);
      if (_unknownFields != null) {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      allowedPacketData_.WriteTo(ref output, _repeated_allowedPacketData_codec);
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      size += allowedPacketData_.CalculateSize(_repeated_allowedPacketData_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(Allocation other) {
      ...
      allowedPacketData_.Add(other.allowedPacketData_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 42: {
            allowedPacketData_.AddEntriesFrom(input, _repeated_allowedPacketData_codec);
            break;
          }
        }
      }
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 42: {
            allowedPacketData_.AddEntriesFrom(ref input, _repeated_allowedPacketData_codec);
            break;
          }
        }
      }
