...
@kotlin.jvm.JvmName("-initializequeryEpochInfosResponse")
public inline fun queryEpochInfosResponse(block: cosmos.epochs.v1beta1.QueryEpochInfosResponseKt.Dsl.() -> kotlin.Unit): cosmos.epochs.v1beta1.QueryOuterClass.QueryEpochInfosResponse =
  cosmos.epochs.v1beta1.QueryEpochInfosResponseKt.Dsl._create(cosmos.epochs.v1beta1.QueryOuterClass.QueryEpochInfosResponse.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `cosmos.epochs.v1beta1.QueryEpochInfosResponse`
 */
public object QueryEpochInfosResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmos.epochs.v1beta1.QueryOuterClass.QueryEpochInfosResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: cosmos.epochs.v1beta1.QueryOuterClass.QueryEpochInfosResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): cosmos.epochs.v1beta1.QueryOuterClass.QueryEpochInfosResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmos.epochs.v1beta1.QueryOuterClass.QueryEpochInfosResponse.copy(block: cosmos.epochs.v1beta1.QueryEpochInfosResponseKt.Dsl.() -> kotlin.Unit): cosmos.epochs.v1beta1.QueryOuterClass.QueryEpochInfosResponse =
  cosmos.epochs.v1beta1.QueryEpochInfosResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
