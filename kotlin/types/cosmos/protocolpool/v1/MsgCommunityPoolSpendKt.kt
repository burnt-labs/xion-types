...
public inline fun msgCommunityPoolSpend(block: cosmos.protocolpool.v1.MsgCommunityPoolSpendKt.Dsl.() -> kotlin.Unit): cosmos.protocolpool.v1.Tx.MsgCommunityPoolSpend =
  cosmos.protocolpool.v1.MsgCommunityPoolSpendKt.Dsl._create(cosmos.protocolpool.v1.Tx.MsgCommunityPoolSpend.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `cosmos.protocolpool.v1.MsgCommunityPoolSpend`
 */
public object MsgCommunityPoolSpendKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmos.protocolpool.v1.Tx.MsgCommunityPoolSpend.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: cosmos.protocolpool.v1.Tx.MsgCommunityPoolSpend.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): cosmos.protocolpool.v1.Tx.MsgCommunityPoolSpend = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmos.protocolpool.v1.Tx.MsgCommunityPoolSpend.copy(block: `cosmos.protocolpool.v1`.MsgCommunityPoolSpendKt.Dsl.() -> kotlin.Unit): cosmos.protocolpool.v1.Tx.MsgCommunityPoolSpend =
  `cosmos.protocolpool.v1`.MsgCommunityPoolSpendKt.Dsl._create(this.toBuilder()).apply { block() }._build()
