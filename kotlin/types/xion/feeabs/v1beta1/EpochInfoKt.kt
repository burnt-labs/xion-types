...
public inline fun epochInfo(block: xion.feeabs.v1beta1.EpochInfoKt.Dsl.() -> kotlin.Unit): xion.feeabs.v1beta1.Epoch.EpochInfo =
  xion.feeabs.v1beta1.EpochInfoKt.Dsl._create(xion.feeabs.v1beta1.Epoch.EpochInfo.newBuilder()).apply { block() }._build()
/**
 * ```
 * EpochInfo defines information of a epoch
 * ```
 *
 * Protobuf type `xion.feeabs.v1beta1.EpochInfo`
 */
public object EpochInfoKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: xion.feeabs.v1beta1.Epoch.EpochInfo.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: xion.feeabs.v1beta1.Epoch.EpochInfo.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): xion.feeabs.v1beta1.Epoch.EpochInfo = _builder.build()
    ...
    public var currentEpoch: kotlin.Long
      ...
      get() = _builder.getCurrentEpoch()
      @JvmName("setCurrentEpoch")
      set(value) {
        _builder.setCurrentEpoch(value)
      }
    /**
     * ```
     * current_epoch is the current epoch number, or in other words,
    ...
    public var currentEpochStartTime: com.google.protobuf.Timestamp
      ...
      get() = _builder.getCurrentEpochStartTime()
      @JvmName("setCurrentEpochStartTime")
      set(value) {
        _builder.setCurrentEpochStartTime(value)
      }
    /**
     * ```
     * current_epoch_start_time describes the start time of the current timer
    ...
    public var epochCountingStarted: kotlin.Boolean
      ...
      get() = _builder.getEpochCountingStarted()
      @JvmName("setEpochCountingStarted")
      set(value) {
        _builder.setEpochCountingStarted(value)
      }
    /**
     * ```
     * epoch_counting_started is a boolean, that indicates whether this
    ...
    public var currentEpochStartHeight: kotlin.Long
      ...
      get() = _builder.getCurrentEpochStartHeight()
      @JvmName("setCurrentEpochStartHeight")
      set(value) {
        _builder.setCurrentEpochStartHeight(value)
      }
    /**
     * ```
     * current_epoch_start_height is the block height at which the current epoch
...
@kotlin.jvm.JvmSynthetic
public inline fun xion.feeabs.v1beta1.Epoch.EpochInfo.copy(block: xion.feeabs.v1beta1.EpochInfoKt.Dsl.() -> kotlin.Unit): xion.feeabs.v1beta1.Epoch.EpochInfo =
  xion.feeabs.v1beta1.EpochInfoKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val xion.feeabs.v1beta1.Epoch.EpochInfoOrBuilder.startTimeOrNull: com.google.protobuf.Timestamp?
  get() = if (hasStartTime()) getStartTime() else null

public val xion.feeabs.v1beta1.Epoch.EpochInfoOrBuilder.durationOrNull: com.google.protobuf.Duration?
  get() = if (hasDuration()) getDuration() else null

public val xion.feeabs.v1beta1.Epoch.EpochInfoOrBuilder.currentEpochStartTimeOrNull: com.google.protobuf.Timestamp?
