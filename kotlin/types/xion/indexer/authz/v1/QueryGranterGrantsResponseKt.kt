...
public inline fun queryGranterGrantsResponse(block: xion.indexer.authz.v1.QueryGranterGrantsResponseKt.Dsl.() -> kotlin.Unit): xion.indexer.authz.v1.QueryOuterClass.QueryGranterGrantsResponse =
  xion.indexer.authz.v1.QueryGranterGrantsResponseKt.Dsl._create(xion.indexer.authz.v1.QueryOuterClass.QueryGranterGrantsResponse.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `xion.indexer.authz.v1.QueryGranterGrantsResponse`
 */
public object QueryGranterGrantsResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: xion.indexer.authz.v1.QueryOuterClass.QueryGranterGrantsResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: xion.indexer.authz.v1.QueryOuterClass.QueryGranterGrantsResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): xion.indexer.authz.v1.QueryOuterClass.QueryGranterGrantsResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun xion.indexer.authz.v1.QueryOuterClass.QueryGranterGrantsResponse.copy(block: xion.indexer.authz.v1.QueryGranterGrantsResponseKt.Dsl.() -> kotlin.Unit): xion.indexer.authz.v1.QueryOuterClass.QueryGranterGrantsResponse =
  xion.indexer.authz.v1.QueryGranterGrantsResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val xion.indexer.authz.v1.QueryOuterClass.QueryGranterGrantsResponseOrBuilder.paginationOrNull: cosmos.base.query.v1beta1.Pagination.PageResponse?
