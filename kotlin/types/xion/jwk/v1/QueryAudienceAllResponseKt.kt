...
@kotlin.jvm.JvmName("-initializequeryAudienceAllResponse")
public inline fun queryAudienceAllResponse(block: xion.jwk.v1.QueryAudienceAllResponseKt.Dsl.() -> kotlin.Unit): xion.jwk.v1.QueryOuterClass.QueryAudienceAllResponse =
  xion.jwk.v1.QueryAudienceAllResponseKt.Dsl._create(xion.jwk.v1.QueryOuterClass.QueryAudienceAllResponse.newBuilder()).apply { block() }._build()
/**
 * ```
 * QueryAudienceAllResponse is the response type for querying all audiences
 * ```
 *
 * Protobuf type `xion.jwk.v1.QueryAudienceAllResponse`
 */
public object QueryAudienceAllResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: xion.jwk.v1.QueryOuterClass.QueryAudienceAllResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: xion.jwk.v1.QueryOuterClass.QueryAudienceAllResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): xion.jwk.v1.QueryOuterClass.QueryAudienceAllResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun xion.jwk.v1.QueryOuterClass.QueryAudienceAllResponse.copy(block: xion.jwk.v1.QueryAudienceAllResponseKt.Dsl.() -> kotlin.Unit): xion.jwk.v1.QueryOuterClass.QueryAudienceAllResponse =
  xion.jwk.v1.QueryAudienceAllResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val xion.jwk.v1.QueryOuterClass.QueryAudienceAllResponseOrBuilder.paginationOrNull: cosmos.base.query.v1beta1.Pagination.PageResponse?
