...
@kotlin.jvm.JvmName("-initializequeryDenomsFromCreatorResponse")
public inline fun queryDenomsFromCreatorResponse(block: osmosis.tokenfactory.v1beta1.QueryDenomsFromCreatorResponseKt.Dsl.() -> kotlin.Unit): osmosis.tokenfactory.v1beta1.QueryOuterClass.QueryDenomsFromCreatorResponse =
  osmosis.tokenfactory.v1beta1.QueryDenomsFromCreatorResponseKt.Dsl._create(osmosis.tokenfactory.v1beta1.QueryOuterClass.QueryDenomsFromCreatorResponse.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `osmosis.tokenfactory.v1beta1.QueryDenomsFromCreatorResponse`
 */
public object QueryDenomsFromCreatorResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: osmosis.tokenfactory.v1beta1.QueryOuterClass.QueryDenomsFromCreatorResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: osmosis.tokenfactory.v1beta1.QueryOuterClass.QueryDenomsFromCreatorResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): osmosis.tokenfactory.v1beta1.QueryOuterClass.QueryDenomsFromCreatorResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun osmosis.tokenfactory.v1beta1.QueryOuterClass.QueryDenomsFromCreatorResponse.copy(block: `osmosis.tokenfactory.v1beta1`.QueryDenomsFromCreatorResponseKt.Dsl.() -> kotlin.Unit): osmosis.tokenfactory.v1beta1.QueryOuterClass.QueryDenomsFromCreatorResponse =
  `osmosis.tokenfactory.v1beta1`.QueryDenomsFromCreatorResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
