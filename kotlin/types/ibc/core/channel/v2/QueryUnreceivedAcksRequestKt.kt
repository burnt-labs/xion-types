...
public inline fun queryUnreceivedAcksRequest(block: ibc.core.channel.v2.QueryUnreceivedAcksRequestKt.Dsl.() -> kotlin.Unit): ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksRequest =
  ibc.core.channel.v2.QueryUnreceivedAcksRequestKt.Dsl._create(ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksRequest.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `ibc.core.channel.v2.QueryUnreceivedAcksRequest`
 */
public object QueryUnreceivedAcksRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksRequest.copy(block: `ibc.core.channel.v2`.QueryUnreceivedAcksRequestKt.Dsl.() -> kotlin.Unit): ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksRequest =
  `ibc.core.channel.v2`.QueryUnreceivedAcksRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
