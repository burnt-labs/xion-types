...
public inline fun queryUnreceivedAcksResponse(block: ibc.core.channel.v2.QueryUnreceivedAcksResponseKt.Dsl.() -> kotlin.Unit): ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksResponse =
  ibc.core.channel.v2.QueryUnreceivedAcksResponseKt.Dsl._create(ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksResponse.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `ibc.core.channel.v2.QueryUnreceivedAcksResponse`
 */
public object QueryUnreceivedAcksResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksResponse = _builder.build()
...
@kotlin.jvm.JvmName("clearSequences")
    ...
    public val QueryUnreceivedAcksResponseKt.Dsl.heightOrNull: ibc.core.client.v1.Client.Height?
      get() = _builder.heightOrNull
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksResponse.copy(block: `ibc.core.channel.v2`.QueryUnreceivedAcksResponseKt.Dsl.() -> kotlin.Unit): ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksResponse =
  `ibc.core.channel.v2`.QueryUnreceivedAcksResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val ibc.core.channel.v2.QueryOuterClass.QueryUnreceivedAcksResponseOrBuilder.heightOrNull: ibc.core.client.v1.Client.Height?
