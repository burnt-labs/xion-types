...
class Vote extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>uint64 proposal_id = 1 [json_name = "proposalId", (.gogoproto.jsontag) = "id", (.amino.field_name) = "id", (.amino.dont_omitempty) = true];</code>
     */
     ...
     *
     * Generated from protobuf field <code>repeated .cosmos.gov.v1beta1.WeightedVoteOption options = 4 [json_name = "options", (.gogoproto.nullable) = false, (.cosmos_proto.field_added_in) = "cosmos-sdk 0.43", (.amino.dont_omitempty) = true];</code>
     */
    private $options;
