 ...
 *
 * Generated from protobuf message <code>cosmos.ics23.v1.ProofSpec</code>
 */
class ProofSpec extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.cosmos.ics23.v1.LeafOp leaf_spec = 1 [json_name = "leafSpec"];</code>
     */
    protected $leaf_spec = null;
    /**
     * Generated from protobuf field <code>.cosmos.ics23.v1.InnerSpec inner_spec = 2 [json_name = "innerSpec"];</code>
     */
     ...
     *
     *     @type \Cosmos\Ics23\V1\LeafOp $leaf_spec
     *           any field in the ExistenceProof must be the same as in this spec.
     *           except Prefix, which is just the first bytes of prefix (spec can be longer)
     *     @type \Cosmos\Ics23\V1\InnerSpec $inner_spec
     *     @type int $max_depth
     *           max_depth (if > 0) is the maximum number of InnerOps allowed (mainly for fixed-depth tries)
     *     @type int $min_depth
     *           min_depth (if > 0) is the minimum number of InnerOps allowed (mainly for fixed-depth tries)
    ...
    /**
     * Generated from protobuf field <code>.cosmos.ics23.v1.InnerSpec inner_spec = 2 [json_name = "innerSpec"];</code>
     * @return \Cosmos\Ics23\V1\InnerSpec|null
     */
    ...
    /**
     * Generated from protobuf field <code>.cosmos.ics23.v1.InnerSpec inner_spec = 2 [json_name = "innerSpec"];</code>
     * @param \Cosmos\Ics23\V1\InnerSpec $var
     * @return $this
     */
    public function setInnerSpec($var)
    {
        GPBUtil::checkMessage($var, \Cosmos\Ics23\V1\InnerSpec::class);
        $this->inner_spec = $var;
