 ...
 *
 * Generated from protobuf message <code>cosmos.ics23.v1.InnerSpec</code>
 */
class InnerSpec extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.cosmos.ics23.v1.HashOp hash = 6 [json_name = "hash"];</code>
     */
    protected $hash = 0;
     ...
     *
     *     @type array<int>|\Google\Protobuf\Internal\RepeatedField $child_order
     *           Child order is the ordering of the children node, must count from 0
     *           iavl tree is [0, 1] (left then right)
     *           merk is [0, 2, 1] (left, right, here)
     *     @type int $child_size
