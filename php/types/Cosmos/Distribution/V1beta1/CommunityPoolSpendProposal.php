...
class CommunityPoolSpendProposal extends \Google\Protobuf\Internal\Message
{
    ...
    protected $recipient = '';
    /**
     * Generated from protobuf field <code>repeated .cosmos.base.v1beta1.Coin amount = 4 [json_name = "amount", (.gogoproto.nullable) = false, (.gogoproto.castrepeated) = "github.com/cosmos/cosmos-sdk/types.Coins", (.amino.encoding) = "legacy_coins", (.amino.dont_omitempty) = true];</code>
     */
    private $amount;
