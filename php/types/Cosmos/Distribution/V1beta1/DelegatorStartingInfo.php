...
class DelegatorStartingInfo extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>string stake = 2 [json_name = "stake", (.gogoproto.nullable) = false, (.gogoproto.customtype) = "cosmossdk.io/math.LegacyDec", (.cosmos_proto.scalar) = "cosmos.Dec", (.amino.dont_omitempty) = true];</code>
     */
    protected $stake = '';
    /**
     * Generated from protobuf field <code>uint64 height = 3 [json_name = "height", (.gogoproto.jsontag) = "creation_height", (.amino.field_name) = "creation_height", (.amino.dont_omitempty) = true];</code>
     */
    protected $height = 0;
