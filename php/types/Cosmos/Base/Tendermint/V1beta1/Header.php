...
class Header extends \Google\Protobuf\Internal\Message
{
     ...
     * basic block info
     *
     * Generated from protobuf field <code>.tendermint.version.Consensus version = 1 [json_name = "version", (.gogoproto.nullable) = false, (.amino.dont_omitempty) = true];</code>
     */
    ...
    protected $height = 0;
    /**
     * Generated from protobuf field <code>.google.protobuf.Timestamp time = 4 [json_name = "time", (.gogoproto.nullable) = false, (.gogoproto.stdtime) = true, (.amino.dont_omitempty) = true];</code>
     */
    protected $time = null;
    /**
     * prev block info
     *
     * Generated from protobuf field <code>.tendermint.types.BlockID last_block_id = 5 [json_name = "lastBlockId", (.gogoproto.nullable) = false, (.amino.dont_omitempty) = true];</code>
     */
