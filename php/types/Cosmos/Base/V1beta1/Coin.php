...
class Coin extends \Google\Protobuf\Internal\Message
{
    ...
    protected $denom = '';
    /**
     * Generated from protobuf field <code>string amount = 2 [json_name = "amount", (.gogoproto.nullable) = false, (.gogoproto.customtype) = "cosmossdk.io/math.Int", (.cosmos_proto.scalar) = "cosmos.Int", (.amino.dont_omitempty) = true];</code>
     */
    protected $amount = '';
