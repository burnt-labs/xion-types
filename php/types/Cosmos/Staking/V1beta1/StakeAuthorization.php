...
class StakeAuthorization extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.cosmos.base.v1beta1.Coin max_tokens = 1 [json_name = "maxTokens"];</code>
     */
     ...
     * account.
     *
     * Generated from protobuf field <code>.cosmos.staking.v1beta1.StakeAuthorization.Validators allow_list = 2 [json_name = "allowList", (.amino.oneof_name) = "cosmos-sdk/StakeAuthorization/AllowList"];</code>
     ...
     * deny_list specifies list of validator addresses to whom grantee can not delegate tokens.
     *
     * Generated from protobuf field <code>.cosmos.staking.v1beta1.StakeAuthorization.Validators deny_list = 3 [json_name = "denyList", (.amino.oneof_name) = "cosmos-sdk/StakeAuthorization/DenyList"];</code>
     * @return \Cosmos\Staking\V1beta1\StakeAuthorization\Validators|null
     */
