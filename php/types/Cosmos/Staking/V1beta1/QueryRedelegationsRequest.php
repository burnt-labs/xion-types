...
class QueryRedelegationsRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string src_validator_addr = 2 [json_name = "srcValidatorAddr", (.cosmos_proto.scalar) = "cosmos.ValidatorAddressString"];</code>
     */
    protected $src_validator_addr = '';
    /**
     * dst_validator_addr defines the validator address to redelegate to.
     *
     * Generated from protobuf field <code>string dst_validator_addr = 3 [json_name = "dstValidatorAddr", (.cosmos_proto.scalar) = "cosmos.ValidatorAddressString"];</code>
     */
