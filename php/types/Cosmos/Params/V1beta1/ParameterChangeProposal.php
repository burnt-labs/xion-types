...
class ParameterChangeProposal extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>repeated .cosmos.params.v1beta1.ParamChange changes = 3 [json_name = "changes", (.gogoproto.nullable) = false, (.amino.dont_omitempty) = true];</code>
     */
    private $changes;
