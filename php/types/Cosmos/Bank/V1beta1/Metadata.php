...
class Metadata extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string name = 5 [json_name = "name", (.cosmos_proto.field_added_in) = "cosmos-sdk 0.43"];</code>
     */
    protected $name = '';
    /**
     ...
     *
     * Generated from protobuf field <code>string symbol = 6 [json_name = "symbol", (.cosmos_proto.field_added_in) = "cosmos-sdk 0.43"];</code>
     */
    protected $symbol = '';
    /**
     * URI to a document (on or off-chain) that contains additional information. Optional.
     *
     * Generated from protobuf field <code>string uri = 7 [json_name = "uri", (.gogoproto.customname) = "URI", (.cosmos_proto.field_added_in) = "cosmos-sdk 0.46"];</code>
     */
    protected $uri = '';
    /**
     ...
     *
     * Generated from protobuf field <code>string uri_hash = 8 [json_name = "uriHash", (.gogoproto.customname) = "URIHash", (.cosmos_proto.field_added_in) = "cosmos-sdk 0.46"];</code>
     */
    protected $uri_hash = '';
