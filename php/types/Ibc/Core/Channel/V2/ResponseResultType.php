 ...
 *
 * Protobuf type <code>ibc.core.channel.v2.ResponseResultType</code>
 */
class ResponseResultType
{
     ...
     *
     * Generated from protobuf enum <code>RESPONSE_RESULT_TYPE_FAILURE = 3 [(.gogoproto.enumvalue_customname) = "FAILURE"];</code>
     */
    const RESPONSE_RESULT_TYPE_FAILURE = 3;
    ...
    private static $valueToName = [
        ...
        self::RESPONSE_RESULT_TYPE_FAILURE => 'RESPONSE_RESULT_TYPE_FAILURE',
    ];
