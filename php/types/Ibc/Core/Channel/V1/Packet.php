...
class Packet extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string source_port = 2 [json_name = "sourcePort"];</code>
     */
    protected $source_port = '';
    /**
     * identifies the channel end on the sending chain.
     *
     * Generated from protobuf field <code>string source_channel = 3 [json_name = "sourceChannel"];</code>
     */
    protected $source_channel = '';
    /**
     * identifies the port on the receiving chain.
     *
     * Generated from protobuf field <code>string destination_port = 4 [json_name = "destinationPort"];</code>
     */
    protected $destination_port = '';
    /**
     * identifies the channel end on the receiving chain.
     *
     * Generated from protobuf field <code>string destination_channel = 5 [json_name = "destinationChannel"];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.ibc.core.client.v1.Height timeout_height = 7 [json_name = "timeoutHeight", (.gogoproto.nullable) = false];</code>
     */
    protected $timeout_height = null;
    /**
     * block timestamp (in nanoseconds) after which the packet times out
     *
     * Generated from protobuf field <code>uint64 timeout_timestamp = 8 [json_name = "timeoutTimestamp"];</code>
     */
