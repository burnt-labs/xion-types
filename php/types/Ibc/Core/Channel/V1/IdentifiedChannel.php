 ...
 * identifier fields.
 *
 * Generated from protobuf message <code>ibc.core.channel.v1.IdentifiedChannel</code>
 */
class IdentifiedChannel extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>repeated string connection_hops = 4 [json_name = "connectionHops"];</code>
     */
     ...
     * port identifier
     *
     * Generated from protobuf field <code>string port_id = 6 [json_name = "portId"];</code>
     */
    protected $port_id = '';
    /**
     * channel identifier
     *
     * Generated from protobuf field <code>string channel_id = 7 [json_name = "channelId"];</code>
     */
     ...
     *           counterparty channel end
     *     @type array<string>|\Google\Protobuf\Internal\RepeatedField $connection_hops
     *           list of connection identifiers, in order, along which packets sent on
     *           this channel will travel
     *     @type string $version
     *           opaque channel version, which is agreed upon during the handshake
