...
class GenesisState extends \Google\Protobuf\Internal\Message
{
    ...
    private $connections;
    /**
     * Generated from protobuf field <code>repeated .ibc.core.connection.v1.ConnectionPaths client_connection_paths = 2 [json_name = "clientConnectionPaths", (.gogoproto.nullable) = false];</code>
     */
    private $client_connection_paths;
    /**
     * the sequence for the next generated connection identifier
     *
     * Generated from protobuf field <code>uint64 next_connection_sequence = 3 [json_name = "nextConnectionSequence"];</code>
     */
     ...
     *
     *     @type array<\Ibc\Core\Connection\V1\IdentifiedConnection>|\Google\Protobuf\Internal\RepeatedField $connections
     *     @type array<\Ibc\Core\Connection\V1\ConnectionPaths>|\Google\Protobuf\Internal\RepeatedField $client_connection_paths
    ...
    /**
     * Generated from protobuf field <code>repeated .ibc.core.connection.v1.IdentifiedConnection connections = 1 [json_name = "connections", (.gogoproto.nullable) = false];</code>
     * @param array<\Ibc\Core\Connection\V1\IdentifiedConnection>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .ibc.core.connection.v1.ConnectionPaths client_connection_paths = 2 [json_name = "clientConnectionPaths", (.gogoproto.nullable) = false];</code>
     * @param array<\Ibc\Core\Connection\V1\ConnectionPaths>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
