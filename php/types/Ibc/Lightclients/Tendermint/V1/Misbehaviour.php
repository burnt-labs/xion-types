...
class Misbehaviour extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>string client_id = 1 [json_name = "clientId", deprecated = true];</code>
     * @deprecated
     */
    protected $client_id = '';
    /**
     * Generated from protobuf field <code>.ibc.lightclients.tendermint.v1.Header header_1 = 2 [json_name = "header1", (.gogoproto.customname) = "Header1"];</code>
     */
    protected $header_1 = null;
    /**
     * Generated from protobuf field <code>.ibc.lightclients.tendermint.v1.Header header_2 = 3 [json_name = "header2", (.gogoproto.customname) = "Header2"];</code>
     */
    ...
    {
        if ($this->client_id !== '') {
            @trigger_error('client_id is deprecated.', E_USER_DEPRECATED);
        }
