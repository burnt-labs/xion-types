...
class ClientState extends \Google\Protobuf\Internal\Message
{
    ...
    protected $chain_id = '';
    /**
     * Generated from protobuf field <code>.ibc.lightclients.tendermint.v1.Fraction trust_level = 2 [json_name = "trustLevel", (.gogoproto.nullable) = false];</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.protobuf.Duration trusting_period = 3 [json_name = "trustingPeriod", (.gogoproto.nullable) = false, (.gogoproto.stdduration) = true];</code>
     */
    protected $trusting_period = null;
    /**
     * duration of the staking unbonding period
     *
     * Generated from protobuf field <code>.google.protobuf.Duration unbonding_period = 4 [json_name = "unbondingPeriod", (.gogoproto.nullable) = false, (.gogoproto.stdduration) = true];</code>
     */
    protected $unbonding_period = null;
    /**
     * defines how much new (untrusted) header's Time can drift into the future.
     *
     * Generated from protobuf field <code>.google.protobuf.Duration max_clock_drift = 5 [json_name = "maxClockDrift", (.gogoproto.nullable) = false, (.gogoproto.stdduration) = true];</code>
     */
    protected $max_clock_drift = null;
    /**
     * Block height when the client was frozen due to a misbehaviour
     *
     * Generated from protobuf field <code>.ibc.core.client.v1.Height frozen_height = 6 [json_name = "frozenHeight", (.gogoproto.nullable) = false];</code>
     */
    protected $frozen_height = null;
    /**
     * Latest height the client was updated to
     *
     * Generated from protobuf field <code>.ibc.core.client.v1.Height latest_height = 7 [json_name = "latestHeight", (.gogoproto.nullable) = false];</code>
     */
    protected $latest_height = null;
    /**
     * Proof specifications used in verifying counterparty state
     *
     * Generated from protobuf field <code>repeated .cosmos.ics23.v1.ProofSpec proof_specs = 8 [json_name = "proofSpecs"];</code>
     */
    private $proof_specs;
    /**
     ...
     * "upgradedIBCState"}`
     *
     * Generated from protobuf field <code>repeated string upgrade_path = 9 [json_name = "upgradePath"];</code>
     */
    private $upgrade_path;
    /**
     * allow_update_after_expiry is deprecated
     *
     * Generated from protobuf field <code>bool allow_update_after_expiry = 10 [json_name = "allowUpdateAfterExpiry", deprecated = true];</code>
     * @deprecated
     */
     ...
     *
     * Generated from protobuf field <code>bool allow_update_after_misbehaviour = 11 [json_name = "allowUpdateAfterMisbehaviour", deprecated = true];</code>
     * @deprecated
     */
     ...
     *           Latest height the client was updated to
     *     @type array<\Cosmos\Ics23\V1\ProofSpec>|\Google\Protobuf\Internal\RepeatedField $proof_specs
     *           Proof specifications used in verifying counterparty state
     *     @type array<string>|\Google\Protobuf\Internal\RepeatedField $upgrade_path
     *           Path at which next upgraded client will be committed.
     *           Each element corresponds to the key for a single CommitmentProof in the
     *           chained proof. NOTE: ClientState must stored under
     *           `{upgradePath}/{upgradeHeight}/clientState` ConsensusState must be stored
     ...
     *
     * Generated from protobuf field <code>repeated .cosmos.ics23.v1.ProofSpec proof_specs = 8 [json_name = "proofSpecs"];</code>
     * @param array<\Cosmos\Ics23\V1\ProofSpec>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProofSpecs($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Cosmos\Ics23\V1\ProofSpec::class);
