 ...
 *
 * @deprecated
 * Generated from protobuf message <code>cosmwasm.wasm.v1.StoreAndInstantiateContractProposal</code>
 */
class StoreAndInstantiateContractProposal extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>bool unpin_code = 6 [json_name = "unpinCode"];</code>
     */
    protected $unpin_code = false;
    /**
     * Admin is an optional address that can execute migrations
     *
     * Generated from protobuf field <code>string admin = 7 [json_name = "admin"];</code>
     */
    protected $admin = '';
    /**
     * Label is optional metadata to be stored with a contract instance.
     *
     * Generated from protobuf field <code>string label = 8 [json_name = "label"];</code>
     */
    protected $label = '';
    /**
     * Msg json encoded message to be passed to the contract on instantiation
     *
     * Generated from protobuf field <code>bytes msg = 9 [json_name = "msg", (.gogoproto.casttype) = "RawContractMessage", (.amino.encoding) = "inline_json"];</code>
     */
    protected $msg = '';
    /**
     * Funds coins that are transferred to the contract on instantiation
     *
     * Generated from protobuf field <code>repeated .cosmos.base.v1beta1.Coin funds = 10 [json_name = "funds", (.gogoproto.nullable) = false, (.gogoproto.castrepeated) = "github.com/cosmos/cosmos-sdk/types.Coins", (.amino.encoding) = "legacy_coins", (.amino.dont_omitempty) = true];</code>
     */
    private $funds;
    /**
     * Source is the URL where the code is hosted
     *
     * Generated from protobuf field <code>string source = 11 [json_name = "source"];</code>
     */
    protected $source = '';
    /**
     ...
     *
     * Generated from protobuf field <code>string builder = 12 [json_name = "builder"];</code>
     */
    protected $builder = '';
    /**
     ...
     *
     * Generated from protobuf field <code>bytes code_hash = 13 [json_name = "codeHash"];</code>
     */
    protected $code_hash = '';
