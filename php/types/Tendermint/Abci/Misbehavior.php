...
/**
 * Generated from protobuf message <code>tendermint.abci.Misbehavior</code>
 */
class Misbehavior extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.tendermint.abci.MisbehaviorType type = 1 [json_name = "type"];</code>
     */
    protected $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Tendermint\Abci\MisbehaviorType::class);
        $this->type = $var;
