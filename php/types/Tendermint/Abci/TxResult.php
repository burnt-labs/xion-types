...
class TxResult extends \Google\Protobuf\Internal\Message
{
    ...
    protected $tx = '';
    /**
     * Generated from protobuf field <code>.tendermint.abci.ExecTxResult result = 4 [json_name = "result", (.gogoproto.nullable) = false];</code>
     */
     ...
     *     @type int $index
     *     @type string $tx
     *     @type \Tendermint\Abci\ExecTxResult $result
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.tendermint.abci.ExecTxResult result = 4 [json_name = "result", (.gogoproto.nullable) = false];</code>
     * @return \Tendermint\Abci\ExecTxResult|null
     */
    ...
    /**
     * Generated from protobuf field <code>.tendermint.abci.ExecTxResult result = 4 [json_name = "result", (.gogoproto.nullable) = false];</code>
     * @param \Tendermint\Abci\ExecTxResult $var
     * @return $this
     */
    public function setResult($var)
    {
        GPBUtil::checkMessage($var, \Tendermint\Abci\ExecTxResult::class);
        $this->result = $var;
