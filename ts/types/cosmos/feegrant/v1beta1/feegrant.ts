...
import { AuthzAllowance, AuthzAllowanceProtoMsg, AuthzAllowanceSDKType, ContractsAllowance, ContractsAllowanceProtoMsg, ContractsAllowanceSDKType, MultiAnyAllowance, MultiAnyAllowanceProtoMsg, MultiAnyAllowanceSDKType } from "../../../xion/v1/feegrant";
...
export interface AllowedMsgAllowance {
  ...
  allowance?: BasicAllowance | PeriodicAllowance | AllowedMsgAllowance | AuthzAllowance | ContractsAllowance | MultiAnyAllowance | Any | undefined;
...
export type AllowedMsgAllowanceEncoded = Omit<AllowedMsgAllowance, "allowance"> & {
  /** allowance can be any of basic and periodic fee allowance. */allowance?: BasicAllowanceProtoMsg | PeriodicAllowanceProtoMsg | AllowedMsgAllowanceProtoMsg | AuthzAllowanceProtoMsg | ContractsAllowanceProtoMsg | MultiAnyAllowanceProtoMsg | AnyProtoMsg | undefined;
};
/**
 * AllowedMsgAllowance creates allowance only for specified message types.
...
export interface AllowedMsgAllowanceSDKType {
  $typeUrl?: "/cosmos.feegrant.v1beta1.AllowedMsgAllowance";
  allowance?: BasicAllowanceSDKType | PeriodicAllowanceSDKType | AllowedMsgAllowanceSDKType | AuthzAllowanceSDKType | ContractsAllowanceSDKType | MultiAnyAllowanceSDKType | AnySDKType | undefined;
  allowed_messages: string[];
}
...
export type GrantEncoded = Omit<Grant, "allowance"> & {
  /** allowance can be any of basic, periodic, allowed fee allowance. */allowance?: BasicAllowanceProtoMsg | PeriodicAllowanceProtoMsg | AllowedMsgAllowanceProtoMsg | AuthzAllowanceProtoMsg | ContractsAllowanceProtoMsg | MultiAnyAllowanceProtoMsg | AnyProtoMsg | undefined;
};
/**
 * Grant is stored in the KVStore to record a grant with full context
 * @name GrantAmino
