...
export const StoreKVPair: MessageFns<StoreKVPair> = {
  ...
  fromJSON(object: any): StoreKVPair {
    return {
      storeKey: isSet(object.storeKey)
        ? globalThis.String(object.storeKey)
        : isSet(object.store_key)
        ? globalThis.String(object.store_key)
        : "",
  ...
  fromJSON(object: any): BlockMetadata {
    return {
      ...
      responseFinalizeBlock: isSet(object.responseFinalizeBlock)
        ...
        : isSet(object.response_finalize_block)
