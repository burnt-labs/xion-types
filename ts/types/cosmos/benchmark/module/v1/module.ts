...
export const GeneratorParams = {
  encode(message: GeneratorParams, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.keyMean = reader.uint64() as Long;
          continue;
        case 4:
          if (tag !== 32) {
            break;
          ...
          message.keyStdDev = reader.uint64() as Long;
          continue;
        case 6:
          if (tag !== 48) {
            break;
          ...
          message.valueMean = reader.uint64() as Long;
          continue;
        case 7:
          if (tag !== 56) {
            break;
          ...
          message.valueStdDev = reader.uint64() as Long;
          continue;
        case 8:
          if (tag !== 64) {
            break;
          ...
          message.genesisCount = reader.uint64() as Long;
          continue;
        case 9:
          if (tag !== 77) {
            break;
