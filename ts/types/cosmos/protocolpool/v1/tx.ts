...
export interface Msg {
  ...
  CreateContinuousFund(
    request: DeepPartial<MsgCreateContinuousFund>,
    metadata?: grpc.Metadata,
  ): Promise<MsgCreateContinuousFundResponse>;
  /** CancelContinuousFund defines a method for cancelling continuous fund. */
  CancelContinuousFund(
    request: DeepPartial<MsgCancelContinuousFund>,
    metadata?: grpc.Metadata,
...
export class MsgClientImpl implements Msg {
  ...
  CreateContinuousFund(
    ...
    return this.rpc.unary(MsgCreateContinuousFundDesc, MsgCreateContinuousFund.fromPartial(request), metadata);
  }
  ...
  CancelContinuousFund(
    ...
    return this.rpc.unary(MsgCancelContinuousFundDesc, MsgCancelContinuousFund.fromPartial(request), metadata);
  }
...
export const MsgDesc = { serviceName: "cosmos.protocolpool.v1.Msg" };
...
export const MsgCreateContinuousFundDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return MsgCreateContinuousFund.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = MsgCreateContinuousFundResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
...
export const MsgCancelContinuousFundDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return MsgCancelContinuousFund.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = MsgCancelContinuousFundResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
