...
export const AppOptionsRequest: MessageFns<AppOptionsRequest> = {
...
export const AppOptionsResponse: MessageFns<AppOptionsResponse> = {
  encode(message: AppOptionsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.moduleOptions).forEach(([key, value]: [string, ModuleOptions]) => {
  ...
  fromJSON(object: any): AppOptionsResponse {
    return {
      moduleOptions: isObject(object.moduleOptions)
        ? (globalThis.Object.entries(object.moduleOptions) as [string, any][]).reduce(
          (acc: { [key: string]: ModuleOptions }, [key, value]: [string, any]) => {
            acc[key] = ModuleOptions.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.module_options)
        ? (globalThis.Object.entries(object.module_options) as [string, any][]).reduce(
          (acc: { [key: string]: ModuleOptions }, [key, value]: [string, any]) => {
            acc[key] = ModuleOptions.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: AppOptionsResponse): unknown {
    ...
    if (message.moduleOptions) {
      const entries = globalThis.Object.entries(message.moduleOptions) as [string, ModuleOptions][];
      if (entries.length > 0) {
        obj.moduleOptions = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<AppOptionsResponse>, I>>(object: I): AppOptionsResponse {
    const message = createBaseAppOptionsResponse();
    message.moduleOptions = (globalThis.Object.entries(object.moduleOptions ?? {}) as [string, ModuleOptions][]).reduce(
      (acc: { [key: string]: ModuleOptions }, [key, value]: [string, ModuleOptions]) => {
        if (value !== undefined) {
...
export const AppOptionsResponse_ModuleOptionsEntry: MessageFns<AppOptionsResponse_ModuleOptionsEntry> = {
