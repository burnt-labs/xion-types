...
export const ServiceCommandDescriptor: MessageFns<ServiceCommandDescriptor> = {
  encode(message: ServiceCommandDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.subCommands).forEach(([key, value]: [string, ServiceCommandDescriptor]) => {
  ...
  fromJSON(object: any): ServiceCommandDescriptor {
    return {
      ...
      rpcCommandOptions: globalThis.Array.isArray(object?.rpcCommandOptions)
        ...
        : globalThis.Array.isArray(object?.rpc_command_options)
        ? object.rpc_command_options.map((e: any) => RpcCommandOptions.fromJSON(e))
        : [],
      subCommands: isObject(object.subCommands)
        ? (globalThis.Object.entries(object.subCommands) as [string, any][]).reduce(
          (acc: { [key: string]: ServiceCommandDescriptor }, [key, value]: [string, any]) => {
            acc[key] = ServiceCommandDescriptor.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.sub_commands)
        ? (globalThis.Object.entries(object.sub_commands) as [string, any][]).reduce(
          (acc: { [key: string]: ServiceCommandDescriptor }, [key, value]: [string, any]) => {
            acc[key] = ServiceCommandDescriptor.fromJSON(value);
            return acc;
          },
      ...
      enhanceCustomCommand: isSet(object.enhanceCustomCommand)
        ...
        : isSet(object.enhance_custom_command)
  ...
  toJSON(message: ServiceCommandDescriptor): unknown {
    ...
    if (message.subCommands) {
      const entries = globalThis.Object.entries(message.subCommands) as [string, ServiceCommandDescriptor][];
      if (entries.length > 0) {
        obj.subCommands = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<ServiceCommandDescriptor>, I>>(object: I): ServiceCommandDescriptor {
    ...
    message.subCommands = (globalThis.Object.entries(object.subCommands ?? {}) as [string, ServiceCommandDescriptor][])
      .reduce((acc: { [key: string]: ServiceCommandDescriptor }, [key, value]: [string, ServiceCommandDescriptor]) => {
        if (value !== undefined) {
...
export const RpcCommandOptions: MessageFns<RpcCommandOptions> = {
  encode(message: RpcCommandOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.flagOptions).forEach(([key, value]: [string, FlagOptions]) => {
  ...
  fromJSON(object: any): RpcCommandOptions {
    return {
      rpcMethod: isSet(object.rpcMethod)
        ...
        : isSet(object.rpc_method)
        ? globalThis.String(object.rpc_method)
        : "",
      ...
      suggestFor: globalThis.Array.isArray(object?.suggestFor)
        ...
        : globalThis.Array.isArray(object?.suggest_for)
      ...
      flagOptions: isObject(object.flagOptions)
        ? (globalThis.Object.entries(object.flagOptions) as [string, any][]).reduce(
          (acc: { [key: string]: FlagOptions }, [key, value]: [string, any]) => {
            acc[key] = FlagOptions.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.flag_options)
        ? (globalThis.Object.entries(object.flag_options) as [string, any][]).reduce(
          (acc: { [key: string]: FlagOptions }, [key, value]: [string, any]) => {
            acc[key] = FlagOptions.fromJSON(value);
            return acc;
          },
      ...
      positionalArgs: globalThis.Array.isArray(object?.positionalArgs)
        ...
        : globalThis.Array.isArray(object?.positional_args)
      ...
      govProposal: isSet(object.govProposal)
        ? globalThis.Boolean(object.govProposal)
        : isSet(object.gov_proposal)
        ? globalThis.Boolean(object.gov_proposal)
        : false,
    };
  },
  ...
  toJSON(message: RpcCommandOptions): unknown {
    ...
    if (message.flagOptions) {
      const entries = globalThis.Object.entries(message.flagOptions) as [string, FlagOptions][];
      if (entries.length > 0) {
        obj.flagOptions = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<RpcCommandOptions>, I>>(object: I): RpcCommandOptions {
    ...
    message.flagOptions = (globalThis.Object.entries(object.flagOptions ?? {}) as [string, FlagOptions][]).reduce(
      (acc: { [key: string]: FlagOptions }, [key, value]: [string, FlagOptions]) => {
        if (value !== undefined) {
  ...
  fromJSON(object: any): FlagOptions {
    return {
      ...
      shorthandDeprecated: isSet(object.shorthandDeprecated)
        ? globalThis.String(object.shorthandDeprecated)
        : isSet(object.shorthand_deprecated)
        ? globalThis.String(object.shorthand_deprecated)
        : "",
...
export const PositionalArgDescriptor: MessageFns<PositionalArgDescriptor> = {
  ...
  fromJSON(object: any): PositionalArgDescriptor {
    return {
      protoField: isSet(object.protoField)
        ? globalThis.String(object.protoField)
        : isSet(object.proto_field)
        ? globalThis.String(object.proto_field)
        : "",
