  ...
  fromJSON(object: any): ProofSpec {
    return {
      ...
      maxDepth: isSet(object.maxDepth)
        ...
        : 0,
      minDepth: isSet(object.minDepth)
        ? globalThis.Number(object.minDepth)
        : isSet(object.min_depth)
        ? globalThis.Number(object.min_depth)
        : 0,
    };
  },
  ...
  fromJSON(object: any): InnerSpec {
    return {
      childOrder: globalThis.Array.isArray(object?.childOrder)
        ...
        : globalThis.Array.isArray(object?.child_order)
        ? object.child_order.map((e: any) => globalThis.Number(e))
        : [],
      childSize: isSet(object.childSize)
        ? globalThis.Number(object.childSize)
        : isSet(object.child_size)
        ? globalThis.Number(object.child_size)
        : 0,
      minPrefixLength: isSet(object.minPrefixLength)
        ? globalThis.Number(object.minPrefixLength)
        : isSet(object.min_prefix_length)
        ? globalThis.Number(object.min_prefix_length)
        : 0,
      maxPrefixLength: isSet(object.maxPrefixLength)
        ? globalThis.Number(object.maxPrefixLength)
        : isSet(object.max_prefix_length)
        ? globalThis.Number(object.max_prefix_length)
        : 0,
      emptyChild: isSet(object.emptyChild)
        ? bytesFromBase64(object.emptyChild)
        : isSet(object.empty_child)
  ...
  fromJSON(object: any): CompressedBatchProof {
    return {
      ...
      lookupInners: globalThis.Array.isArray(object?.lookupInners)
        ...
        : globalThis.Array.isArray(object?.lookup_inners)
