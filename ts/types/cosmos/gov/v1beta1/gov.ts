...
export const TallyResult: MessageFns<TallyResult> = {
  ...
  fromJSON(object: any): TallyResult {
    return {
      ...
      noWithVeto: isSet(object.noWithVeto)
        ? globalThis.String(object.noWithVeto)
        : isSet(object.no_with_veto)
        ? globalThis.String(object.no_with_veto)
        : "",
    };
  },
...
function createBaseVote(): Vote {
  return { proposalId: 0n, voter: "", option: 0, options: [] };
}
