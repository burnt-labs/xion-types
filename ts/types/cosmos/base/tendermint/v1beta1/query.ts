...
export interface GetLatestBlockResultsRequest {
}
...
function createBaseGetLatestBlockResultsRequest(): GetLatestBlockResultsRequest {
  return {};
}

export const GetLatestBlockResultsRequest: MessageFns<GetLatestBlockResultsRequest> = {
  encode(_: GetLatestBlockResultsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetLatestBlockResultsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetLatestBlockResultsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): GetLatestBlockResultsRequest {
    return {};
  },

  toJSON(_: GetLatestBlockResultsRequest): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<GetLatestBlockResultsRequest>, I>>(base?: I): GetLatestBlockResultsRequest {
    return GetLatestBlockResultsRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetLatestBlockResultsRequest>, I>>(_: I): GetLatestBlockResultsRequest {
    const message = createBaseGetLatestBlockResultsRequest();
    return message;
  },
};
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.txsResults.push(ExecTxResult.decode(reader, reader.uint32()));
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): GetBlockResultsResponse {
    return {
      ...
      txsResults: globalThis.Array.isArray(object?.txsResults)
        ...
        ? object.txs_results.map((e: any) => ExecTxResult.fromJSON(e))
        : [],
      finalizeBlockEvents: globalThis.Array.isArray(object?.finalizeBlockEvents)
        ...
        : globalThis.Array.isArray(object?.finalize_block_events)
...
export const GetLatestBlockResultsResponse: MessageFns<GetLatestBlockResultsResponse> = {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetLatestBlockResultsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<GetLatestBlockResultsResponse>, I>>(base?: I): GetLatestBlockResultsResponse {
    return GetLatestBlockResultsResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetLatestBlockResultsResponse>, I>>(
    object: I,
...
export interface Service {
  ...
  GetLatestBlockResults(
    request: DeepPartial<GetLatestBlockResultsRequest>,
    metadata?: grpc.Metadata,
  ): Promise<GetLatestBlockResultsResponse>;
...
export class ServiceClientImpl implements Service {
  ...
  constructor(rpc: Rpc) {
    ...
    this.GetLatestBlockResults = this.GetLatestBlockResults.bind(this);
  ...
  GetLatestBlockResults(
    ...
    return this.rpc.unary(
      ServiceGetLatestBlockResultsDesc,
      GetLatestBlockResultsRequest.fromPartial(request),
      metadata,
    );
  }
  ...
  GetBlockResults(
    ...
    return this.rpc.unary(ServiceGetBlockResultsDesc, GetBlockResultsRequest.fromPartial(request), metadata);
  }
}
...
export const ServiceGetLatestBlockResultsDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return GetLatestBlockResultsRequest.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = GetLatestBlockResultsResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
...
export const ServiceGetBlockResultsDesc: UnaryMethodDefinitionish = {
