...
export const GenesisCounterpartyInfo = {
  encode(message: GenesisCounterpartyInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.clientId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GenesisCounterpartyInfo {
