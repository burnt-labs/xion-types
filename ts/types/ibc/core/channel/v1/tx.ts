...
export const MsgChannelCloseConfirm = {
  encode(message: MsgChannelCloseConfirm, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (!message.counterpartyUpgradeSequence.equals(Long.UZERO)) {
...
export const MsgChannelUpgradeTry = {
  ...
  fromJSON(object: any): MsgChannelUpgradeTry {
    return {
      portId: isSet(object.portId) ? globalThis.String(object.portId) : "",
      channelId: isSet(object.channelId) ? globalThis.String(object.channelId) : "",
      proposedUpgradeConnectionHops: globalThis.Array.isArray(object?.proposedUpgradeConnectionHops)
        ? object.proposedUpgradeConnectionHops.map((e: any) => globalThis.String(e))
        : [],
...
export const MsgPruneAcknowledgementsResponse = {
  encode(message: MsgPruneAcknowledgementsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (!message.totalPrunedSequences.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.totalPrunedSequences);
    }
    if (!message.totalRemainingSequences.equals(Long.UZERO)) {
