...
function createBaseMsgSendPacket(): MsgSendPacket {
  return { sourceClient: "", timeoutTimestamp: 0n, payloads: [], signer: "" };
}
...
export interface Msg {
  ...
  SendPacket(request: DeepPartial<MsgSendPacket>, metadata?: grpc.Metadata): Promise<MsgSendPacketResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  SendPacket(request: DeepPartial<MsgSendPacket>, metadata?: grpc.Metadata): Promise<MsgSendPacketResponse> {
    return this.rpc.unary(MsgSendPacketDesc, MsgSendPacket.fromPartial(request), metadata);
  }
...
export const MsgDesc = { serviceName: "ibc.core.channel.v2.Msg" };

export const MsgSendPacketDesc: UnaryMethodDefinitionish = {
  ...
  requestType: {
    serializeBinary() {
      return MsgSendPacket.encode(this).finish();
    },
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = MsgSendPacketResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
