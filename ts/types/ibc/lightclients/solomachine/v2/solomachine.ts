  ...
  fromJSON(object: any): ClientState {
    return {
      ...
      isFrozen: isSet(object.isFrozen)
        ...
        ? globalThis.Boolean(object.is_frozen)
        : false,
      ...
      allowUpdateAfterProposal: isSet(object.allowUpdateAfterProposal)
        ...
        : isSet(object.allow_update_after_proposal)
  ...
  fromJSON(object: any): Header {
    return {
      ...
      newDiversifier: isSet(object.newDiversifier)
        ? globalThis.String(object.newDiversifier)
        : isSet(object.new_diversifier)
        ? globalThis.String(object.new_diversifier)
        : "",
    };
  },
  ...
  encode(message: NextSequenceRecvData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.nextSeqRecv !== 0n) {
      if (BigInt.asUintN(64, message.nextSeqRecv) !== message.nextSeqRecv) {
        throw new globalThis.Error("value provided for field message.nextSeqRecv of type uint64 too large");
      }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.nextSeqRecv = reader.uint64() as bigint;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): NextSequenceRecvData {
    return {
      ...
      nextSeqRecv: isSet(object.nextSeqRecv)
        ? BigInt(object.nextSeqRecv)
        : isSet(object.next_seq_recv)
        ? BigInt(object.next_seq_recv)
        : 0n,
    };
  },
