  ...
  fromJSON(object: any): QueryRawContractStateRequest {
    return {
      ...
      queryData: isSet(object.queryData)
        ...
        : isSet(object.query_data)
        ? bytesFromBase64(object.query_data)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): QueryCodesResponse {
    return {
      codeInfos: globalThis.Array.isArray(object?.codeInfos)
        ...
        : globalThis.Array.isArray(object?.code_infos)
...
export const QueryPinnedCodesResponse: MessageFns<QueryPinnedCodesResponse> = {
  encode(message: QueryPinnedCodesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.codeIds) {
      writer.uint32(8).uint64(v!.toString());
    }
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(18).fork()).join();
    }
  ...
  fromJSON(object: any): QueryBuildAddressRequest {
    return {
      codeHash: isSet(object.codeHash)
        ? globalThis.String(object.codeHash)
        : isSet(object.code_hash)
        ? globalThis.String(object.code_hash)
        : "",
      creatorAddress: isSet(object.creatorAddress)
        ? globalThis.String(object.creatorAddress)
        : isSet(object.creator_address)
      ...
      initArgs: isSet(object.initArgs)
        ? bytesFromBase64(object.initArgs)
        : isSet(object.init_args)
        ? bytesFromBase64(object.init_args)
        : new Uint8Array(0),
    };
  },
