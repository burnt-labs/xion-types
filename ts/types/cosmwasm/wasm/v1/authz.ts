...
export const StoreCodeAuthorization: MessageFns<StoreCodeAuthorization> = {
  encode(message: StoreCodeAuthorization, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.grants) {
      CodeGrant.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const ContractExecutionAuthorization: MessageFns<ContractExecutionAuthorization> = {
  encode(message: ContractExecutionAuthorization, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.grants) {
...
export const ContractMigrationAuthorization: MessageFns<ContractMigrationAuthorization> = {
  encode(message: ContractMigrationAuthorization, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.grants) {
      ContractGrant.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
...
export const CodeGrant: MessageFns<CodeGrant> = {
  encode(message: CodeGrant, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const ContractGrant: MessageFns<ContractGrant> = {
  encode(message: ContractGrant, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.contract !== "") {
...
export const MaxFundsLimit: MessageFns<MaxFundsLimit> = {
  encode(message: MaxFundsLimit, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const AllowAllMessagesFilter: MessageFns<AllowAllMessagesFilter> = {
  encode(_: AllowAllMessagesFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const AcceptedMessageKeysFilter: MessageFns<AcceptedMessageKeysFilter> = {
  encode(message: AcceptedMessageKeysFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const AcceptedMessagesFilter: MessageFns<AcceptedMessagesFilter> = {
  encode(message: AcceptedMessagesFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
