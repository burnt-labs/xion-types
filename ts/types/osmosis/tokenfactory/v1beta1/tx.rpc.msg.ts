...
import {
  ...
  MsgBurn, MsgBurnResponse,
  MsgChangeAdmin, MsgChangeAdminResponse,
  MsgSetDenomMetadata, MsgSetDenomMetadataResponse,
  MsgForceTransfer, MsgForceTransferResponse,
  MsgUpdateParams, MsgUpdateParamsResponse
} from "./tx";
export interface Msg {
  /** CreateDenom creates a new token denom for the creator. */
  createDenom(request: MsgCreateDenom): Promise<MsgCreateDenomResponse>;
  /** Mint mints additional tokens for a denom admin. */
  mint(request: MsgMint): Promise<MsgMintResponse>;
  /** Burn burns tokens for a denom admin. */
  burn(request: MsgBurn): Promise<MsgBurnResponse>;
  /** ChangeAdmin changes the admin for a denom. */
  changeAdmin(request: MsgChangeAdmin): Promise<MsgChangeAdminResponse>;
  /** SetDenomMetadata sets the denom metadata for a denom. */
  setDenomMetadata(request: MsgSetDenomMetadata): Promise<MsgSetDenomMetadataResponse>;
  /** ForceTransfer force transfers tokens between accounts for a denom admin. */
  forceTransfer(request: MsgForceTransfer): Promise<MsgForceTransferResponse>;
  /** UpdateParams updates the tokenfactory module parameters. */
