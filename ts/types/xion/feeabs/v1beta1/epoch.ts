...
export const ExponentialBackoff = {
  encode(message: ExponentialBackoff, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ExponentialBackoff {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.jump = reader.int64() as Long;
          continue;
        case 2:
          if (tag !== 16) {
            break;
          ...
          message.futureEpoch = reader.int64() as Long;
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ExponentialBackoff {
    return {
      ...
      futureEpoch: isSet(object.futureEpoch) ? Long.fromValue(object.futureEpoch) : Long.ZERO,
    };
  },
