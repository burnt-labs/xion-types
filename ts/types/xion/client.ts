...
import * as xionDkimV1TxRegistry from "./dkim/v1/tx.registry";
...
import * as xionZkV1TxRegistry from "./zk/v1/tx.registry";
import * as xionDkimV1TxAmino from "./dkim/v1/tx.amino";
...
import * as xionZkV1TxAmino from "./zk/v1/tx.amino";
export const xionAminoConverters = {
  ...xionDkimV1TxAmino.AminoConverter,
  ...
  ...xionZkV1TxAmino.AminoConverter
};
export const xionProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...xionDkimV1TxRegistry.registry, ...xionFeeabsV1beta1TxRegistry.registry, ...xionJwkV1TxRegistry.registry, ...xionMintV1TxRegistry.registry, ...xionV1TxRegistry.registry, ...xionZkV1TxRegistry.registry];
