...
export const MsgCreateAudienceClaim: MessageFns<MsgCreateAudienceClaim> = {
  encode(message: MsgCreateAudienceClaim, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.admin !== "") {
  ...
  fromJSON(object: any): MsgCreateAudienceClaim {
    return {
      ...
      audHash: isSet(object.audHash)
        ? bytesFromBase64(object.audHash)
        : isSet(object.aud_hash)
        ? bytesFromBase64(object.aud_hash)
        : new Uint8Array(0),
    };
  },
...
export const MsgCreateAudienceClaimResponse: MessageFns<MsgCreateAudienceClaimResponse> = {
  encode(_: MsgCreateAudienceClaimResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgDeleteAudienceClaim: MessageFns<MsgDeleteAudienceClaim> = {
  encode(message: MsgDeleteAudienceClaim, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.admin !== "") {
      writer.uint32(10).string(message.admin);
    }
    if (message.audHash.length !== 0) {
...
export const MsgDeleteAudienceClaimResponse: MessageFns<MsgDeleteAudienceClaimResponse> = {
  encode(_: MsgDeleteAudienceClaimResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgCreateAudience: MessageFns<MsgCreateAudience> = {
  encode(message: MsgCreateAudience, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.admin !== "") {
      writer.uint32(10).string(message.admin);
    }
    if (message.aud !== "") {
...
export const MsgCreateAudienceResponse: MessageFns<MsgCreateAudienceResponse> = {
  encode(message: MsgCreateAudienceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const MsgUpdateAudience: MessageFns<MsgUpdateAudience> = {
  encode(message: MsgUpdateAudience, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.admin !== "") {
      writer.uint32(10).string(message.admin);
    }
    if (message.newAdmin !== "") {
  ...
  fromJSON(object: any): MsgUpdateAudience {
    return {
      ...
      aud: isSet(object.aud) ? globalThis.String(object.aud) : "",
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      newAud: isSet(object.newAud)
        ? globalThis.String(object.newAud)
        : isSet(object.new_aud)
        ? globalThis.String(object.new_aud)
        : "",
    };
  },
...
export const MsgUpdateAudienceResponse: MessageFns<MsgUpdateAudienceResponse> = {
  encode(message: MsgUpdateAudienceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.audience !== undefined) {
      Audience.encode(message.audience, writer.uint32(10).fork()).join();
    }
    return writer;
...
export const MsgDeleteAudience: MessageFns<MsgDeleteAudience> = {
  encode(message: MsgDeleteAudience, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.admin !== "") {
      writer.uint32(10).string(message.admin);
    }
    if (message.aud !== "") {
...
export const MsgDeleteAudienceResponse: MessageFns<MsgDeleteAudienceResponse> = {
  encode(_: MsgDeleteAudienceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
