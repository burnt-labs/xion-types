...
export const QueryWebAuthNVerifyRegisterRequest: MessageFns<QueryWebAuthNVerifyRegisterRequest> = {
  encode(message: QueryWebAuthNVerifyRegisterRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.addr !== "") {
...
export const QueryWebAuthNVerifyRegisterResponse: MessageFns<QueryWebAuthNVerifyRegisterResponse> = {
  encode(message: QueryWebAuthNVerifyRegisterResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const QueryWebAuthNVerifyAuthenticateRequest: MessageFns<QueryWebAuthNVerifyAuthenticateRequest> = {
  encode(message: QueryWebAuthNVerifyAuthenticateRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.addr !== "") {
      writer.uint32(10).string(message.addr);
    }
    if (message.challenge !== "") {
...
export const QueryWebAuthNVerifyAuthenticateResponse: MessageFns<QueryWebAuthNVerifyAuthenticateResponse> = {
  encode(_: QueryWebAuthNVerifyAuthenticateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const QueryPlatformPercentageRequest: MessageFns<QueryPlatformPercentageRequest> = {
  encode(_: QueryPlatformPercentageRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const QueryPlatformMinimumRequest: MessageFns<QueryPlatformMinimumRequest> = {
  encode(_: QueryPlatformMinimumRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const QueryPlatformMinimumResponse: MessageFns<QueryPlatformMinimumResponse> = {
  encode(message: QueryPlatformMinimumResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
