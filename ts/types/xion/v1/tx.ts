...
export const MsgSetPlatformPercentage: MessageFns<MsgSetPlatformPercentage> = {
  encode(message: MsgSetPlatformPercentage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): MsgSetPlatformPercentage {
    return {
      ...
      platformPercentage: isSet(object.platformPercentage)
        ? globalThis.Number(object.platformPercentage)
        : isSet(object.platform_percentage)
        ? globalThis.Number(object.platform_percentage)
        : 0,
    };
  },
...
export const MsgSetPlatformPercentageResponse: MessageFns<MsgSetPlatformPercentageResponse> = {
  encode(_: MsgSetPlatformPercentageResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgSetPlatformMinimum: MessageFns<MsgSetPlatformMinimum> = {
  encode(message: MsgSetPlatformMinimum, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
...
export const MsgSetPlatformMinimumResponse: MessageFns<MsgSetPlatformMinimumResponse> = {
  encode(_: MsgSetPlatformMinimumResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
