...
export class QueryClientImpl implements Query {
  ...
  allowance(request: QueryAllowanceRequest): Promise<QueryAllowanceResponse> {
    ...
    const promise = this.rpc.request("xion.indexer.feegrant.v1.Query", "Allowance", data);
  ...
  allowances(request: QueryAllowancesRequest): Promise<QueryAllowancesResponse> {
    ...
    const promise = this.rpc.request("xion.indexer.feegrant.v1.Query", "Allowances", data);
  ...
  allowancesByGranter(request: QueryAllowancesByGranterRequest): Promise<QueryAllowancesByGranterResponse> {
    ...
    const promise = this.rpc.request("xion.indexer.feegrant.v1.Query", "AllowancesByGranter", data);
