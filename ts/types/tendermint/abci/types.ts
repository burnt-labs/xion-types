  ...
  fromJSON(object: any): Request {
    return {
      ...
      verifyVoteExtension: isSet(object.verifyVoteExtension)
        ...
        : isSet(object.verify_vote_extension)
  ...
  fromJSON(object: any): RequestInfo {
    return {
      ...
      blockVersion: isSet(object.blockVersion)
        ? BigInt(object.blockVersion)
        : isSet(object.block_version)
        ? BigInt(object.block_version)
        : 0n,
      p2pVersion: isSet(object.p2pVersion)
        ? BigInt(object.p2pVersion)
        : isSet(object.p2p_version)
        ? BigInt(object.p2p_version)
        : 0n,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.maxTxBytes = reader.int64() as bigint;
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): RequestFinalizeBlock {
    return {
      ...
      decidedLastCommit: isSet(object.decidedLastCommit)
        ...
        : isSet(object.decided_last_commit)
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.appVersion = reader.uint64() as bigint;
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.lastBlockHeight = reader.int64() as bigint;
          continue;
        }
        case 5: {
          if (tag !== 42) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 3: {
          ...
          message.retainHeight = reader.int64() as bigint;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ResponseFinalizeBlock {
    return {
      ...
      txResults: globalThis.Array.isArray(object?.txResults)
        ...
        : globalThis.Array.isArray(object?.tx_results)
