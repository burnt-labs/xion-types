...
export interface ResourceInfoListProtoMsg {
  typeUrl: "/google.api.servicecontrol.v2.ResourceInfoList";
  value: Uint8Array;
}
/**
 * Message containing resource details in a batch mode.
 * @name ResourceInfoListAmino
 * @package google.api.servicecontrol.v2
 * @see proto type: google.api.servicecontrol.v2.ResourceInfoList
 */
export interface ResourceInfoListAmino {
  /**
   * The resource details.
   */
  resources?: ResourceInfoAmino[];
}
export interface ResourceInfoListAminoMsg {
  type: "/google.api.servicecontrol.v2.ResourceInfoList";
  value: ResourceInfoListAmino;
}
/** Message containing resource details in a batch mode. */
export interface ResourceInfoListSDKType {
  resources: ResourceInfoSDKType[];
}
...
export const ResourceInfoList = {
  typeUrl: "/google.api.servicecontrol.v2.ResourceInfoList",
  encode(message: ResourceInfoList, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    for (const v of message.resources) {
  ...
  fromPartial(object: Partial<ResourceInfoList>): ResourceInfoList {
    const message = createBaseResourceInfoList();
    message.resources = object.resources?.map(e => ResourceInfo.fromPartial(e)) || [];
    return message;
  },
  fromAmino(object: ResourceInfoListAmino): ResourceInfoList {
    const message = createBaseResourceInfoList();
    message.resources = object.resources?.map(e => ResourceInfo.fromAmino(e)) || [];
    return message;
  },
  toAmino(message: ResourceInfoList): ResourceInfoListAmino {
    const obj: any = {};
    if (message.resources) {
      obj.resources = message.resources.map(e => e ? ResourceInfo.toAmino(e) : undefined);
    } else {
  ...
  fromAminoMsg(object: ResourceInfoListAminoMsg): ResourceInfoList {
    return ResourceInfoList.fromAmino(object.value);
  },
  fromProtoMsg(message: ResourceInfoListProtoMsg): ResourceInfoList {
    return ResourceInfoList.decode(message.value);
  },
  toProto(message: ResourceInfoList): Uint8Array {
    return ResourceInfoList.encode(message).finish();
  },
  toProtoMsg(message: ResourceInfoList): ResourceInfoListProtoMsg {
    return {
      typeUrl: "/google.api.servicecontrol.v2.ResourceInfoList",
      value: ResourceInfoList.encode(message).finish()
    };
  }
};