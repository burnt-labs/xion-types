...
export enum ErrorReason {
  ...
  /**
   * MISSING_ORIGIN - The request is denied because origin request header is missing.
   * 
   * Example of an ErrorInfo when
  ...
  MISSING_ORIGIN = 33,
  /**
   * OVERLOADED_CREDENTIALS - The request is denied because the request contains more than one credential
...
export function errorReasonFromJSON(object: any): ErrorReason {
  switch (object) {
    ...
    case 33:
    case "MISSING_ORIGIN":
      return ErrorReason.MISSING_ORIGIN;
    case 34:
    case "OVERLOADED_CREDENTIALS":
      return ErrorReason.OVERLOADED_CREDENTIALS;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function errorReasonToJSON(object: ErrorReason): string {
  switch (object) {
    ...
    case ErrorReason.MISSING_ORIGIN:
      return "MISSING_ORIGIN";
    case ErrorReason.OVERLOADED_CREDENTIALS:
