 ...
 * @package google.api.servicemanagement.v1
 * @see proto type: google.api.servicemanagement.v1.EnableServiceResponse
 */
export interface EnableServiceResponseAmino {}
export interface EnableServiceResponseAminoMsg {
  type: "/google.api.servicemanagement.v1.EnableServiceResponse";
...
export const EnableServiceResponse = {
  typeUrl: "/google.api.servicemanagement.v1.EnableServiceResponse",
  encode(_: EnableServiceResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
  ...
  fromPartial(_: Partial<EnableServiceResponse>): EnableServiceResponse {
    const message = createBaseEnableServiceResponse();
    return message;
  },
  fromAmino(_: EnableServiceResponseAmino): EnableServiceResponse {
    const message = createBaseEnableServiceResponse();
    return message;
  },
  toAmino(_: EnableServiceResponse): EnableServiceResponseAmino {
    const obj: any = {};
    return obj;
  },
