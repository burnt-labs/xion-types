...
import { Publishing, PublishingAmino, PublishingSDKType } from "./client";
...
export const Service = {
  ...
  fromPartial(object: Partial<Service>): Service {
    ...
    message.publishing = object.publishing !== undefined && object.publishing !== null ? Publishing.fromPartial(object.publishing) : undefined;
  ...
  fromAmino(object: ServiceAmino): Service {
    ...
    if (object.publishing !== undefined && object.publishing !== null) {
      message.publishing = Publishing.fromAmino(object.publishing);
    }
  ...
  toAmino(message: Service): ServiceAmino {
    ...
    obj.publishing = message.publishing ? Publishing.toAmino(message.publishing) : undefined;
