...
export const MsgRegisterAccount: MessageFns<MsgRegisterAccount> = {
  encode(message: MsgRegisterAccount, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
...
export const MsgRegisterAccountResponse: MessageFns<MsgRegisterAccountResponse> = {
  encode(message: MsgRegisterAccountResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
...
export const MsgDesc = { serviceName: "abstractaccount.v1.Msg" };
...
export const MsgRegisterAccountDesc: UnaryMethodDefinitionish = {
  ...
  responseType: {
    deserializeBinary(data: Uint8Array) {
      const value = MsgRegisterAccountResponse.decode(data);
      return {
        ...value,
        toObject() {
          return value;
