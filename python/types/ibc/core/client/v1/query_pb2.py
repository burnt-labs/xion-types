...
from ibc.core.commitment.v2 import commitment_pb2 as ibc_dot_core_dot_commitment_dot_v2_dot_commitment__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_QUERY'].methods_by_name['ClientCreator']._loaded_options = None
