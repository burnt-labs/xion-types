...
from xion_types.cosmos.distribution.v1beta1 import distribution_pb2 as cosmos_dot_distribution_dot_v1beta1_dot_distribution__pb2
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_QUERYVALIDATORHISTORICALREWARDSREQUEST'].fields_by_name['validator_address']._options = None
  _globals['_QUERYVALIDATORHISTORICALREWARDSREQUEST'].fields_by_name['validator_address']._serialized_options = b'\322\264-\035cosmos.ValidatorAddressString'
  _globals['_QUERYVALIDATORHISTORICALREWARDSRESPONSE'].fields_by_name['rewards']._options = None
  _globals['_QUERYVALIDATORHISTORICALREWARDSRESPONSE'].fields_by_name['rewards']._serialized_options = b'\310\336\037\000\250\347\260*\001'
  _globals['_QUERYVALIDATORCURRENTREWARDSREQUEST'].fields_by_name['validator_address']._options = None
  _globals['_QUERYVALIDATORCURRENTREWARDSREQUEST'].fields_by_name['validator_address']._serialized_options = b'\322\264-\035cosmos.ValidatorAddressString'
  _globals['_QUERYVALIDATORCURRENTREWARDSRESPONSE'].fields_by_name['rewards']._options = None
  _globals['_QUERYVALIDATORCURRENTREWARDSRESPONSE'].fields_by_name['rewards']._serialized_options = b'\310\336\037\000\250\347\260*\001'
  _globals['_QUERYDELEGATORSTARTINGINFOREQUEST'].fields_by_name['delegator_address']._options = None
  _globals['_QUERYDELEGATORSTARTINGINFOREQUEST'].fields_by_name['delegator_address']._serialized_options = b'\322\264-\024cosmos.AddressString'
  _globals['_QUERYDELEGATORSTARTINGINFOREQUEST'].fields_by_name['validator_address']._options = None
  _globals['_QUERYDELEGATORSTARTINGINFOREQUEST'].fields_by_name['validator_address']._serialized_options = b'\322\264-\035cosmos.ValidatorAddressString'
  _globals['_QUERYDELEGATORSTARTINGINFORESPONSE'].fields_by_name['starting_info']._options = None
  _globals['_QUERYDELEGATORSTARTINGINFORESPONSE'].fields_by_name['starting_info']._serialized_options = b'\310\336\037\000\250\347\260*\001'
  ...
  _globals['_QUERY'].methods_by_name['ValidatorHistoricalRewards']._options = None
  _globals['_QUERY'].methods_by_name['ValidatorHistoricalRewards']._serialized_options = b'\202\323\344\223\002Y\022W/cosmos/distribution/v1beta1/validators/{validator_address}/historical_rewards/{period}'
  _globals['_QUERY'].methods_by_name['ValidatorCurrentRewards']._options = None
  _globals['_QUERY'].methods_by_name['ValidatorCurrentRewards']._serialized_options = b'\202\323\344\223\002M\022K/cosmos/distribution/v1beta1/validators/{validator_address}/current_rewards'
  _globals['_QUERY'].methods_by_name['DelegatorStartingInfo']._options = None
  _globals['_QUERY'].methods_by_name['DelegatorStartingInfo']._serialized_options = b'\202\323\344\223\002_\022]/cosmos/distribution/v1beta1/delegators/{delegator_address}/starting_info/{validator_address}'
  ...
  _globals['_QUERYVALIDATORHISTORICALREWARDSREQUEST']._serialized_start=3193
  _globals['_QUERYVALIDATORHISTORICALREWARDSREQUEST']._serialized_end=3337
  _globals['_QUERYVALIDATORHISTORICALREWARDSRESPONSE']._serialized_start=3340
  _globals['_QUERYVALIDATORHISTORICALREWARDSRESPONSE']._serialized_end=3475
  _globals['_QUERYVALIDATORCURRENTREWARDSREQUEST']._serialized_start=3477
  _globals['_QUERYVALIDATORCURRENTREWARDSREQUEST']._serialized_end=3594
  _globals['_QUERYVALIDATORCURRENTREWARDSRESPONSE']._serialized_start=3597
  _globals['_QUERYVALIDATORCURRENTREWARDSRESPONSE']._serialized_end=3726
  _globals['_QUERYDELEGATORSTARTINGINFOREQUEST']._serialized_start=3729
  _globals['_QUERYDELEGATORSTARTINGINFOREQUEST']._serialized_end=3915
  _globals['_QUERYDELEGATORSTARTINGINFORESPONSE']._serialized_start=3918
  _globals['_QUERYDELEGATORSTARTINGINFORESPONSE']._serialized_end=4054
  _globals['_QUERY']._serialized_start=4057
  _globals['_QUERY']._serialized_end=7072
