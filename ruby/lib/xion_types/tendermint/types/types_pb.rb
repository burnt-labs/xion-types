...
begin
  ...
  imports = [
    ["tendermint.crypto.Proof", "tendermint/crypto/proof.proto"],
...
module Tendermint
  module Types
    ...
    ExtendedCommit = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("tendermint.types.ExtendedCommit").msgclass
    ExtendedCommitSig = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("tendermint.types.ExtendedCommitSig").msgclass
