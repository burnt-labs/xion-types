...
begin
  ...
  imports = [
    ["ibc.core.channel.v1.Channel", "ibc/core/channel/v1/channel.proto"],
...
module Ibc
  module Core
    module Channel
      module V1
        MsgChannelOpenInit = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelOpenInit").msgclass
        MsgChannelOpenInitResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelOpenInitResponse").msgclass
        MsgChannelOpenTry = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelOpenTry").msgclass
        MsgChannelOpenTryResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelOpenTryResponse").msgclass
        MsgChannelOpenAck = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelOpenAck").msgclass
        MsgChannelOpenAckResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelOpenAckResponse").msgclass
        MsgChannelOpenConfirm = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelOpenConfirm").msgclass
        MsgChannelOpenConfirmResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelOpenConfirmResponse").msgclass
        MsgChannelCloseInit = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelCloseInit").msgclass
        MsgChannelCloseInitResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelCloseInitResponse").msgclass
        MsgChannelCloseConfirm = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelCloseConfirm").msgclass
        MsgChannelCloseConfirmResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgChannelCloseConfirmResponse").msgclass
        MsgRecvPacket = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgRecvPacket").msgclass
        MsgRecvPacketResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgRecvPacketResponse").msgclass
        MsgTimeout = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgTimeout").msgclass
        MsgTimeoutResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgTimeoutResponse").msgclass
        MsgTimeoutOnClose = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgTimeoutOnClose").msgclass
        MsgTimeoutOnCloseResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgTimeoutOnCloseResponse").msgclass
        MsgAcknowledgement = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgAcknowledgement").msgclass
        MsgAcknowledgementResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.MsgAcknowledgementResponse").msgclass
        ResponseResultType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("ibc.core.channel.v1.ResponseResultType").enummodule
      end
    end
  end
end
