...
module Cosmos
  module Gov
    module V1beta1
      WeightedVoteOption = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1beta1.WeightedVoteOption").msgclass
      TextProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1beta1.TextProposal").msgclass
      Deposit = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1beta1.Deposit").msgclass
      Proposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1beta1.Proposal").msgclass
      TallyResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1beta1.TallyResult").msgclass
      Vote = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1beta1.Vote").msgclass
      DepositParams = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1beta1.DepositParams").msgclass
      VotingParams = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1beta1.VotingParams").msgclass
      TallyParams = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1beta1.TallyParams").msgclass
      VoteOption = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1beta1.VoteOption").enummodule
      ProposalStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1beta1.ProposalStatus").enummodule
    end
  end
end
