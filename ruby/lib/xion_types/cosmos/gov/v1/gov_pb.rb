...
module Cosmos
  module Gov
    module V1
      WeightedVoteOption = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1.WeightedVoteOption").msgclass
      Deposit = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1.Deposit").msgclass
      Proposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1.Proposal").msgclass
      TallyResult = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1.TallyResult").msgclass
      Vote = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1.Vote").msgclass
      DepositParams = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1.DepositParams").msgclass
      VotingParams = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1.VotingParams").msgclass
      TallyParams = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1.TallyParams").msgclass
      Params = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1.Params").msgclass
      VoteOption = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1.VoteOption").enummodule
      ProposalStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.gov.v1.ProposalStatus").enummodule
    end
  end
end
