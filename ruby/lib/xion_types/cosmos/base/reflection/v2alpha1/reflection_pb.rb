...
module Cosmos
  module Base
    module Reflection
      module V2alpha1
        AppDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.AppDescriptor").msgclass
        TxDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.TxDescriptor").msgclass
        AuthnDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.AuthnDescriptor").msgclass
        SigningModeDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.SigningModeDescriptor").msgclass
        ChainDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.ChainDescriptor").msgclass
        CodecDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.CodecDescriptor").msgclass
        InterfaceDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.InterfaceDescriptor").msgclass
        InterfaceImplementerDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.InterfaceImplementerDescriptor").msgclass
        InterfaceAcceptingMessageDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.InterfaceAcceptingMessageDescriptor").msgclass
        ConfigurationDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.ConfigurationDescriptor").msgclass
        MsgDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.MsgDescriptor").msgclass
        GetAuthnDescriptorRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetAuthnDescriptorRequest").msgclass
        GetAuthnDescriptorResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetAuthnDescriptorResponse").msgclass
        GetChainDescriptorRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetChainDescriptorRequest").msgclass
        GetChainDescriptorResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetChainDescriptorResponse").msgclass
        GetCodecDescriptorRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetCodecDescriptorRequest").msgclass
        GetCodecDescriptorResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetCodecDescriptorResponse").msgclass
        GetConfigurationDescriptorRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorRequest").msgclass
        GetConfigurationDescriptorResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetConfigurationDescriptorResponse").msgclass
        GetQueryServicesDescriptorRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetQueryServicesDescriptorRequest").msgclass
        GetQueryServicesDescriptorResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetQueryServicesDescriptorResponse").msgclass
        GetTxDescriptorRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetTxDescriptorRequest").msgclass
        GetTxDescriptorResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.GetTxDescriptorResponse").msgclass
        QueryServicesDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.QueryServicesDescriptor").msgclass
        QueryServiceDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.QueryServiceDescriptor").msgclass
        QueryMethodDescriptor = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.base.reflection.v2alpha1.QueryMethodDescriptor").msgclass
      end
    end
  end
end
