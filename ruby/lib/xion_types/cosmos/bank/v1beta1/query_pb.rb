...
module Cosmos
  module Bank
    module V1beta1
      ...
      QueryDenomMetadataByQueryStringRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.bank.v1beta1.QueryDenomMetadataByQueryStringRequest").msgclass
      QueryDenomMetadataByQueryStringResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.bank.v1beta1.QueryDenomMetadataByQueryStringResponse").msgclass
      ...
      QueryDenomOwnersByQueryRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.bank.v1beta1.QueryDenomOwnersByQueryRequest").msgclass
      QueryDenomOwnersByQueryResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.bank.v1beta1.QueryDenomOwnersByQueryResponse").msgclass
