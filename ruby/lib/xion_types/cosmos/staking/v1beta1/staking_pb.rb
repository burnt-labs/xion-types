...
begin
  ...
  imports = [
    ...
    ["tendermint.abci.ValidatorUpdate", "tendermint/abci/types.proto"],
  ]
...
module Cosmos
  module Staking
    module V1beta1
      HistoricalInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.HistoricalInfo").msgclass
      CommissionRates = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.CommissionRates").msgclass
      Commission = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.Commission").msgclass
      Description = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.Description").msgclass
      Validator = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.Validator").msgclass
      ValAddresses = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.ValAddresses").msgclass
      DVPair = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.DVPair").msgclass
      DVPairs = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.DVPairs").msgclass
      DVVTriplet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.DVVTriplet").msgclass
      DVVTriplets = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.DVVTriplets").msgclass
      Delegation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.Delegation").msgclass
      UnbondingDelegation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.UnbondingDelegation").msgclass
      UnbondingDelegationEntry = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.UnbondingDelegationEntry").msgclass
      RedelegationEntry = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.RedelegationEntry").msgclass
      Redelegation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.Redelegation").msgclass
      Params = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.Params").msgclass
      DelegationResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.DelegationResponse").msgclass
      RedelegationEntryResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.RedelegationEntryResponse").msgclass
      RedelegationResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.RedelegationResponse").msgclass
      Pool = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.Pool").msgclass
      ValidatorUpdates = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.ValidatorUpdates").msgclass
      BondStatus = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.BondStatus").enummodule
      Infraction = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.Infraction").enummodule
    end
  end
end
