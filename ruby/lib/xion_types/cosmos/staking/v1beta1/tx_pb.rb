...
begin
  ...
  imports = [
    ["cosmos.staking.v1beta1.Description", "cosmos/staking/v1beta1/staking.proto"],
...
module Cosmos
  module Staking
    module V1beta1
      MsgCreateValidator = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgCreateValidator").msgclass
      MsgCreateValidatorResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgCreateValidatorResponse").msgclass
      MsgEditValidator = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgEditValidator").msgclass
      MsgEditValidatorResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgEditValidatorResponse").msgclass
      MsgDelegate = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgDelegate").msgclass
      MsgDelegateResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgDelegateResponse").msgclass
      MsgBeginRedelegate = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgBeginRedelegate").msgclass
      MsgBeginRedelegateResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgBeginRedelegateResponse").msgclass
      MsgUndelegate = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgUndelegate").msgclass
      MsgUndelegateResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgUndelegateResponse").msgclass
      MsgCancelUnbondingDelegation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgCancelUnbondingDelegation").msgclass
      MsgCancelUnbondingDelegationResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgCancelUnbondingDelegationResponse").msgclass
      MsgUpdateParams = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgUpdateParams").msgclass
      MsgUpdateParamsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.staking.v1beta1.MsgUpdateParamsResponse").msgclass
    end
  end
end
