...
module Cosmos
  module Mint
    module V1beta1
      MsgUpdateParams = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.mint.v1beta1.MsgUpdateParams").msgclass
      MsgUpdateParamsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.mint.v1beta1.MsgUpdateParamsResponse").msgclass
    end
  end
end
