...
begin
  ...
  imports = [
    ...
    ["cosmos.distribution.v1beta1.ValidatorAccumulatedCommission", "cosmos/distribution/v1beta1/distribution.proto"],
  ]
...
module Cosmos
  module Distribution
    module V1beta1
      DelegatorWithdrawInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.distribution.v1beta1.DelegatorWithdrawInfo").msgclass
      ValidatorOutstandingRewardsRecord = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.distribution.v1beta1.ValidatorOutstandingRewardsRecord").msgclass
      ValidatorAccumulatedCommissionRecord = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.distribution.v1beta1.ValidatorAccumulatedCommissionRecord").msgclass
      ValidatorHistoricalRewardsRecord = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.distribution.v1beta1.ValidatorHistoricalRewardsRecord").msgclass
      ValidatorCurrentRewardsRecord = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.distribution.v1beta1.ValidatorCurrentRewardsRecord").msgclass
      DelegatorStartingInfoRecord = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.distribution.v1beta1.DelegatorStartingInfoRecord").msgclass
      ValidatorSlashEventRecord = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.distribution.v1beta1.ValidatorSlashEventRecord").msgclass
      GenesisState = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmos.distribution.v1beta1.GenesisState").msgclass
    end
  end
end
