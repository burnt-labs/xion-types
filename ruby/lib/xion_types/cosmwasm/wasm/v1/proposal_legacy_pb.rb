...
begin
  ...
  imports = [
    ["cosmwasm.wasm.v1.AccessConfig", "cosmwasm/wasm/v1/types.proto"],
...
module Cosmwasm
  module Wasm
    module V1
      StoreCodeProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.StoreCodeProposal").msgclass
      InstantiateContractProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.InstantiateContractProposal").msgclass
      InstantiateContract2Proposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.InstantiateContract2Proposal").msgclass
      MigrateContractProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.MigrateContractProposal").msgclass
      SudoContractProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.SudoContractProposal").msgclass
      ExecuteContractProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.ExecuteContractProposal").msgclass
      UpdateAdminProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.UpdateAdminProposal").msgclass
      ClearAdminProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.ClearAdminProposal").msgclass
      PinCodesProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.PinCodesProposal").msgclass
      UnpinCodesProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.UnpinCodesProposal").msgclass
      AccessConfigUpdate = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.AccessConfigUpdate").msgclass
      UpdateInstantiateConfigProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.UpdateInstantiateConfigProposal").msgclass
      StoreAndInstantiateContractProposal = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.StoreAndInstantiateContractProposal").msgclass
    end
  end
end
