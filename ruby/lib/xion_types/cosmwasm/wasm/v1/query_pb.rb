...
begin
  ...
  imports = [
    ["cosmwasm.wasm.v1.ContractInfo", "cosmwasm/wasm/v1/types.proto"],
...
module Cosmwasm
  module Wasm
    module V1
      QueryContractInfoRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryContractInfoRequest").msgclass
      QueryContractInfoResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryContractInfoResponse").msgclass
      QueryContractHistoryRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryContractHistoryRequest").msgclass
      QueryContractHistoryResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryContractHistoryResponse").msgclass
      QueryContractsByCodeRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryContractsByCodeRequest").msgclass
      QueryContractsByCodeResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryContractsByCodeResponse").msgclass
      QueryAllContractStateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryAllContractStateRequest").msgclass
      QueryAllContractStateResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryAllContractStateResponse").msgclass
      QueryRawContractStateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryRawContractStateRequest").msgclass
      QueryRawContractStateResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryRawContractStateResponse").msgclass
      QuerySmartContractStateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QuerySmartContractStateRequest").msgclass
      QuerySmartContractStateResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QuerySmartContractStateResponse").msgclass
      QueryCodeRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryCodeRequest").msgclass
      QueryCodeInfoRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryCodeInfoRequest").msgclass
      QueryCodeInfoResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryCodeInfoResponse").msgclass
      CodeInfoResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.CodeInfoResponse").msgclass
      QueryCodeResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryCodeResponse").msgclass
      QueryCodesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryCodesRequest").msgclass
      QueryCodesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryCodesResponse").msgclass
      QueryPinnedCodesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryPinnedCodesRequest").msgclass
      QueryPinnedCodesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryPinnedCodesResponse").msgclass
      QueryParamsRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryParamsRequest").msgclass
      QueryParamsResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryParamsResponse").msgclass
      QueryContractsByCreatorRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryContractsByCreatorRequest").msgclass
      QueryContractsByCreatorResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryContractsByCreatorResponse").msgclass
      QueryWasmLimitsConfigRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryWasmLimitsConfigRequest").msgclass
      QueryWasmLimitsConfigResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryWasmLimitsConfigResponse").msgclass
      QueryBuildAddressRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryBuildAddressRequest").msgclass
      QueryBuildAddressResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("cosmwasm.wasm.v1.QueryBuildAddressResponse").msgclass
    end
  end
end
