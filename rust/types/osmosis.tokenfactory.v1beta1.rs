...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct QueryDenomsFromAdminRequest {
    #[prost(string, tag="1")]
    pub admin: ::prost::alloc::string::String,
}
impl ::prost::Name for QueryDenomsFromAdminRequest {
const NAME: &'static str = "QueryDenomsFromAdminRequest";
const PACKAGE: &'static str = "osmosis.tokenfactory.v1beta1";
fn full_name() -> ::prost::alloc::string::String {
                ::prost::alloc::format!("osmosis.tokenfactory.v1beta1.{}", Self::NAME)
            }}
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct QueryDenomsFromAdminResponse {
    #[prost(string, repeated, tag="1")]
    pub denoms: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
impl ::prost::Name for QueryDenomsFromAdminResponse {
const NAME: &'static str = "QueryDenomsFromAdminResponse";
const PACKAGE: &'static str = "osmosis.tokenfactory.v1beta1";
fn full_name() -> ::prost::alloc::string::String {
                ::prost::alloc::format!("osmosis.tokenfactory.v1beta1.{}", Self::NAME)
            }}
