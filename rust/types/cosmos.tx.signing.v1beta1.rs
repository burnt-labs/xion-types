...
const PACKAGE: &'static str = "cosmos.tx.signing.v1beta1";
fn full_name() -> ::prost::alloc::string::String {
                ::prost::alloc::format!("cosmos.tx.signing.v1beta1.SignatureDescriptor.Data.{}", Self::NAME)
            }}
...
const PACKAGE: &'static str = "cosmos.tx.signing.v1beta1";
fn full_name() -> ::prost::alloc::string::String {
                ::prost::alloc::format!("cosmos.tx.signing.v1beta1.SignatureDescriptor.{}", Self::NAME)
            }}
}
