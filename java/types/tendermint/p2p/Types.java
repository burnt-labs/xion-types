  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        DefaultNodeInfo.class.getName());
    }
    // Use DefaultNodeInfo.newBuilder() to construct.
    private DefaultNodeInfo(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(defaultNodeId_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, defaultNodeId_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(listenAddr_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 3, listenAddr_);
      }
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(moniker_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 7, moniker_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(defaultNodeId_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, defaultNodeId_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(listenAddr_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(3, listenAddr_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(network_)) {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(moniker_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(7, moniker_);
      }
      if (((bitField0_ & 0x00000002) != 0)) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 66: {
                input.readMessage(
                    internalGetOtherFieldBuilder().getBuilder(),
                    extensionRegistry);
      ...
      public tendermint.p2p.Types.DefaultNodeInfoOther.Builder getOtherBuilder() {
        bitField0_ |= 0x00000080;
        onChanged();
        return internalGetOtherFieldBuilder().getBuilder();
      }
      /**
       * <code>.tendermint.p2p.DefaultNodeInfoOther other = 8 [json_name = "other", (.gogoproto.nullable) = false];</code>
       */
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        DefaultNodeInfoOther.class.getName());
    }
    // Use DefaultNodeInfoOther.newBuilder() to construct.
    private DefaultNodeInfoOther(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(txIndex_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, txIndex_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(rpcAddress_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, rpcAddress_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(txIndex_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, txIndex_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(rpcAddress_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, rpcAddress_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
