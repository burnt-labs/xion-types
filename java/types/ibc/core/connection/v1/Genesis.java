    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
          ...
          internalGetClientConnectionPathsFieldBuilder();
      ...
      private void buildPartialRepeatedFields(ibc.core.connection.v1.Genesis.GenesisState result) {
        if (connectionsBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0)) {
      ...
      private void buildPartial0(ibc.core.connection.v1.Genesis.GenesisState result) {
          ...
          if (!other.clientConnectionPaths_.isEmpty()) {
            if (clientConnectionPathsBuilder_.isEmpty()) {
              ...
              clientConnectionPathsBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetClientConnectionPathsFieldBuilder() : null;
            } else {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                ibc.core.connection.v1.Connection.ConnectionPaths m =
                    input.readMessage(
                        ibc.core.connection.v1.Connection.ConnectionPaths.parser(),
                        extensionRegistry);
                if (clientConnectionPathsBuilder_ == null) {
                  ensureClientConnectionPathsIsMutable();
      ...
      public ibc.core.connection.v1.Connection.ConnectionPaths.Builder getClientConnectionPathsBuilder(
          int index) {
        return internalGetClientConnectionPathsFieldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .ibc.core.connection.v1.ConnectionPaths client_connection_paths = 2 [json_name = "clientConnectionPaths", (.gogoproto.nullable) = false];</code>
       */
      ...
      public ibc.core.connection.v1.Connection.ConnectionPaths.Builder addClientConnectionPathsBuilder() {
        return internalGetClientConnectionPathsFieldBuilder().addBuilder(
      ...
      public java.util.List<ibc.core.connection.v1.Connection.ConnectionPaths.Builder> 
        ...
        return internalGetClientConnectionPathsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ...
          internalGetClientConnectionPathsFieldBuilder() {
        if (clientConnectionPathsBuilder_ == null) {
          clientConnectionPathsBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
              ibc.core.connection.v1.Connection.ConnectionPaths, ibc.core.connection.v1.Connection.ConnectionPaths.Builder, ibc.core.connection.v1.Connection.ConnectionPathsOrBuilder>(
