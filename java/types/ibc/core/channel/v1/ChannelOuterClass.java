...
public final class ChannelOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      ChannelOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < connectionHops_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 4, connectionHops_.getRaw(i));
      }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        IdentifiedChannel.class.getName());
    }
    // Use IdentifiedChannel.newBuilder() to construct.
    private IdentifiedChannel(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(portId_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 6, portId_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(portId_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(6, portId_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(channelId_)) {
  ...
  private static final long serialVersionUID = 0L;
    ...
    private Counterparty(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourcePort_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, sourcePort_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourceChannel_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 3, sourceChannel_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(destinationPort_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 4, destinationPort_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(destinationChannel_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 5, destinationChannel_);
      }
      if (!data_.isEmpty()) {
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourcePort_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, sourcePort_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourceChannel_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(3, sourceChannel_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(destinationPort_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(4, destinationPort_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(destinationChannel_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(5, destinationChannel_);
      }
      if (!data_.isEmpty()) {
        size += com.google.protobuf.CodedOutputStream
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(ibc.core.channel.v1.ChannelOuterClass.PacketId result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.portId_ = portId_;
        }
  ...
  public interface AcknowledgementOrBuilder extends
    ...
    ibc.core.channel.v1.ChannelOuterClass.Acknowledgement.ResponseCase getResponseCase();
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (responseCase_ == 22) {
        com.google.protobuf.GeneratedMessage.writeString(output, 22, response_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (responseCase_ == 22) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(22, response_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ibc.core.channel.v1.ChannelOuterClass.internal_static_ibc_core_channel_v1_Timeout_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return ibc.core.channel.v1.ChannelOuterClass.internal_static_ibc_core_channel_v1_Timeout_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ibc.core.channel.v1.ChannelOuterClass.Timeout.class, ibc.core.channel.v1.ChannelOuterClass.Timeout.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof ibc.core.channel.v1.ChannelOuterClass.Timeout)) {
        return super.equals(obj);
      }
      ibc.core.channel.v1.ChannelOuterClass.Timeout other = (ibc.core.channel.v1.ChannelOuterClass.Timeout) obj;
    ...
    public static ibc.core.channel.v1.ChannelOuterClass.Timeout parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static ibc.core.channel.v1.ChannelOuterClass.Timeout parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ibc.core.channel.v1.ChannelOuterClass.Timeout parseFrom(
    ...
    public static ibc.core.channel.v1.ChannelOuterClass.Timeout parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseWithIOException(PARSER, input);
    }
    ...
    public static ibc.core.channel.v1.ChannelOuterClass.Timeout parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static ibc.core.channel.v1.ChannelOuterClass.Timeout parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static Builder newBuilder(ibc.core.channel.v1.ChannelOuterClass.Timeout prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        ibc.core.channel.v1.ChannelOuterClass.TimeoutOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ibc.core.channel.v1.ChannelOuterClass.internal_static_ibc_core_channel_v1_Timeout_descriptor;
      }
      ...
      // Construct using ibc.core.channel.v1.ChannelOuterClass.Timeout.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public ibc.core.channel.v1.ChannelOuterClass.Timeout getDefaultInstanceForType() {
        return ibc.core.channel.v1.ChannelOuterClass.Timeout.getDefaultInstance();
      }

      @java.lang.Override
      public ibc.core.channel.v1.ChannelOuterClass.Timeout build() {
        ibc.core.channel.v1.ChannelOuterClass.Timeout result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public ibc.core.channel.v1.ChannelOuterClass.Timeout buildPartial() {
        ibc.core.channel.v1.ChannelOuterClass.Timeout result = new ibc.core.channel.v1.ChannelOuterClass.Timeout(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(ibc.core.channel.v1.ChannelOuterClass.Timeout result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ibc.core.channel.v1.ChannelOuterClass.Timeout) {
          return mergeFrom((ibc.core.channel.v1.ChannelOuterClass.Timeout)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(ibc.core.channel.v1.ChannelOuterClass.Timeout other) {
        if (other == ibc.core.channel.v1.ChannelOuterClass.Timeout.getDefaultInstance()) return this;
        if (other.hasHeight()) {
    ...
    private static final ibc.core.channel.v1.ChannelOuterClass.Timeout DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ibc.core.channel.v1.ChannelOuterClass.Timeout();
    }

    public static ibc.core.channel.v1.ChannelOuterClass.Timeout getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
