...
public final class Cosmos {
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 3,
        /* suffix= */ "",
        ScalarDescriptor.class.getName());
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(cosmos_proto.Cosmos.ScalarDescriptor result) {
  ...
  static {
    ...
    methodAddedIn.internalInit(descriptor.getExtensions().get(0));
    implementsInterface.internalInit(descriptor.getExtensions().get(1));
    messageAddedIn.internalInit(descriptor.getExtensions().get(2));
    acceptsInterface.internalInit(descriptor.getExtensions().get(3));
    scalar.internalInit(descriptor.getExtensions().get(4));
    fieldAddedIn.internalInit(descriptor.getExtensions().get(5));
    declareInterface.internalInit(descriptor.getExtensions().get(6));
    declareScalar.internalInit(descriptor.getExtensions().get(7));
    fileAddedIn.internalInit(descriptor.getExtensions().get(8));
