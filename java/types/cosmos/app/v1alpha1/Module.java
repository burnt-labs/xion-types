...
public final class Module {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(goImport_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, goImport_);
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(goImport_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, goImport_);
      }
      for (int i = 0; i < usePackage_.size(); i++) {
    ...
    public static final class Builder extends
            ...
            if (usePackageBuilder_.isEmpty()) {
              ...
              usePackageBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetUsePackageFieldBuilder() : null;
            } else {
          ...
          if (!other.canMigrateFrom_.isEmpty()) {
            if (canMigrateFromBuilder_.isEmpty()) {
              ...
              canMigrateFromBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetCanMigrateFromFieldBuilder() : null;
            } else {
      ...
      public cosmos.app.v1alpha1.Module.PackageReference.Builder getUsePackageBuilder(
          int index) {
        return internalGetUsePackageFieldBuilder().getBuilder(index);
      }
      /**
       * <pre>
       * use_package refers to a protobuf package that this module
      ...
      public cosmos.app.v1alpha1.Module.PackageReference.Builder addUsePackageBuilder() {
        return internalGetUsePackageFieldBuilder().addBuilder(
      ...
      public java.util.List<cosmos.app.v1alpha1.Module.PackageReference.Builder> 
        ...
        return internalGetUsePackageFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ...
          internalGetUsePackageFieldBuilder() {
        if (usePackageBuilder_ == null) {
          usePackageBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
              cosmos.app.v1alpha1.Module.PackageReference, cosmos.app.v1alpha1.Module.PackageReference.Builder, cosmos.app.v1alpha1.Module.PackageReferenceOrBuilder>(
                  usePackage_,
      ...
      public cosmos.app.v1alpha1.Module.MigrateFromInfo.Builder getCanMigrateFromBuilder(
          int index) {
        return internalGetCanMigrateFromFieldBuilder().getBuilder(index);
      }
      /**
       * <pre>
       * can_migrate_from defines which module versions this module can migrate
      ...
      public cosmos.app.v1alpha1.Module.MigrateFromInfo.Builder addCanMigrateFromBuilder() {
        return internalGetCanMigrateFromFieldBuilder().addBuilder(
      ...
      public java.util.List<cosmos.app.v1alpha1.Module.MigrateFromInfo.Builder> 
        ...
        return internalGetCanMigrateFromFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ...
          internalGetCanMigrateFromFieldBuilder() {
        if (canMigrateFromBuilder_ == null) {
          canMigrateFromBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
              cosmos.app.v1alpha1.Module.MigrateFromInfo, cosmos.app.v1alpha1.Module.MigrateFromInfo.Builder, cosmos.app.v1alpha1.Module.MigrateFromInfoOrBuilder>(
                  canMigrateFrom_,
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        PackageReference.class.getName());
    }
    // Use PackageReference.newBuilder() to construct.
    private PackageReference(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        MigrateFromInfo.class.getName());
    }
    // Use MigrateFromInfo.newBuilder() to construct.
    private MigrateFromInfo(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
