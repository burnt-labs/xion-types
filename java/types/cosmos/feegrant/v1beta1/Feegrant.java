...
public final class Feegrant {
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        BasicAllowance.class.getName());
    }
    // Use BasicAllowance.newBuilder() to construct.
    private BasicAllowance(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        PeriodicAllowance.class.getName());
    }
    // Use PeriodicAllowance.newBuilder() to construct.
    private PeriodicAllowance(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
          ...
          internalGetPeriodSpendLimitFieldBuilder();
          internalGetPeriodCanSpendFieldBuilder();
          internalGetPeriodResetFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
          ...
          if (!other.periodSpendLimit_.isEmpty()) {
            if (periodSpendLimitBuilder_.isEmpty()) {
              ...
              periodSpendLimitBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetPeriodSpendLimitFieldBuilder() : null;
            } else {
          ...
          if (!other.periodCanSpend_.isEmpty()) {
            if (periodCanSpendBuilder_.isEmpty()) {
              ...
              periodCanSpendBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetPeriodCanSpendFieldBuilder() : null;
            } else {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 42: {
                input.readMessage(
                    internalGetPeriodResetFieldBuilder().getBuilder(),
                    extensionRegistry);
      ...
      public cosmos.base.v1beta1.CoinOuterClass.Coin.Builder getPeriodSpendLimitBuilder(
          int index) {
        return internalGetPeriodSpendLimitFieldBuilder().getBuilder(index);
      }
      /**
       * <pre>
       * period_spend_limit specifies the maximum number of coins that can be spent
      ...
      public cosmos.base.v1beta1.CoinOuterClass.Coin.Builder addPeriodSpendLimitBuilder() {
        return internalGetPeriodSpendLimitFieldBuilder().addBuilder(
            cosmos.base.v1beta1.CoinOuterClass.Coin.getDefaultInstance());
      }
      /**
       * <pre>
      ...
      public java.util.List<cosmos.base.v1beta1.CoinOuterClass.Coin.Builder> 
        ...
        return internalGetPeriodSpendLimitFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          cosmos.base.v1beta1.CoinOuterClass.Coin, cosmos.base.v1beta1.CoinOuterClass.Coin.Builder, cosmos.base.v1beta1.CoinOuterClass.CoinOrBuilder> 
          internalGetPeriodSpendLimitFieldBuilder() {
        if (periodSpendLimitBuilder_ == null) {
          periodSpendLimitBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
              cosmos.base.v1beta1.CoinOuterClass.Coin, cosmos.base.v1beta1.CoinOuterClass.Coin.Builder, cosmos.base.v1beta1.CoinOuterClass.CoinOrBuilder>(
                  periodSpendLimit_,
      ...
      public cosmos.base.v1beta1.CoinOuterClass.Coin.Builder getPeriodCanSpendBuilder(
          int index) {
        return internalGetPeriodCanSpendFieldBuilder().getBuilder(index);
      }
      /**
       * <pre>
       * period_can_spend is the number of coins left to be spent before the period_reset time
      ...
      public cosmos.base.v1beta1.CoinOuterClass.Coin.Builder addPeriodCanSpendBuilder() {
        return internalGetPeriodCanSpendFieldBuilder().addBuilder(
            cosmos.base.v1beta1.CoinOuterClass.Coin.getDefaultInstance());
      }
      /**
       * <pre>
      ...
      public java.util.List<cosmos.base.v1beta1.CoinOuterClass.Coin.Builder> 
        ...
        return internalGetPeriodCanSpendFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          cosmos.base.v1beta1.CoinOuterClass.Coin, cosmos.base.v1beta1.CoinOuterClass.Coin.Builder, cosmos.base.v1beta1.CoinOuterClass.CoinOrBuilder> 
          internalGetPeriodCanSpendFieldBuilder() {
        if (periodCanSpendBuilder_ == null) {
          periodCanSpendBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
              cosmos.base.v1beta1.CoinOuterClass.Coin, cosmos.base.v1beta1.CoinOuterClass.Coin.Builder, cosmos.base.v1beta1.CoinOuterClass.CoinOrBuilder>(
                  periodCanSpend_,
      ...
      public com.google.protobuf.Timestamp.Builder getPeriodResetBuilder() {
        bitField0_ |= 0x00000010;
        onChanged();
        return internalGetPeriodResetFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * period_reset is the time at which this period resets and a new one begins,
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          internalGetPeriodResetFieldBuilder() {
        if (periodResetBuilder_ == null) {
          periodResetBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              com.google.protobuf.Timestamp, com.google.protobuf.Timestamp.Builder, com.google.protobuf.TimestampOrBuilder>(
                  getPeriodReset(),
                  getParentForChildren(),
                  isClean());
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        AllowedMsgAllowance.class.getName());
    }
    // Use AllowedMsgAllowance.newBuilder() to construct.
    private AllowedMsgAllowance(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < allowedMessages_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, allowedMessages_.getRaw(i));
      }
      getUnknownFields().writeTo(output);
    }
  ...
  private static final long serialVersionUID = 0L;
    ...
    private Grant(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    private Grant() {
      granter_ = "";
