...
public final class QueryOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(subspace_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, subspace_);
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(subspace_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, subspace_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(key_)) {
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(cosmos.params.v1beta1.QueryOuterClass.QueryParamsRequest result) {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(cosmos.params.v1beta1.QueryOuterClass.QueryParamsResponse result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                input.readMessage(
                    internalGetParamFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
      ...
      public Builder mergeParam(cosmos.params.v1beta1.Params.ParamChange value) {
        if (paramBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0) &&
            param_ != null &&
            param_ != cosmos.params.v1beta1.Params.ParamChange.getDefaultInstance()) {
      ...
      public cosmos.params.v1beta1.Params.ParamChange.Builder getParamBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetParamFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * param defines the queried parameter.
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        QuerySubspacesRequest.class.getName());
    }
    // Use QuerySubspacesRequest.newBuilder() to construct.
    private QuerySubspacesRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        QuerySubspacesResponse.class.getName());
    }
    // Use QuerySubspacesResponse.newBuilder() to construct.
    private QuerySubspacesResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(cosmos.params.v1beta1.QueryOuterClass.QuerySubspacesResponse result) {
        if (subspacesBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0)) {
      ...
      private void buildPartial0(cosmos.params.v1beta1.QueryOuterClass.QuerySubspacesResponse result) {
        int from_bitField0_ = bitField0_;
      }
            ...
            if (subspacesBuilder_.isEmpty()) {
              ...
              subspacesBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   internalGetSubspacesFieldBuilder() : null;
            } else {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                cosmos.params.v1beta1.QueryOuterClass.Subspace m =
                    input.readMessage(
                        cosmos.params.v1beta1.QueryOuterClass.Subspace.parser(),
                        extensionRegistry);
                if (subspacesBuilder_ == null) {
                  ensureSubspacesIsMutable();
                  subspaces_.add(m);
      ...
      public cosmos.params.v1beta1.QueryOuterClass.Subspace.Builder getSubspacesBuilder(
          int index) {
        return internalGetSubspacesFieldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .cosmos.params.v1beta1.Subspace subspaces = 1 [json_name = "subspaces"];</code>
       */
      ...
      public cosmos.params.v1beta1.QueryOuterClass.Subspace.Builder addSubspacesBuilder() {
        return internalGetSubspacesFieldBuilder().addBuilder(
      ...
      public java.util.List<cosmos.params.v1beta1.QueryOuterClass.Subspace.Builder> 
        ...
        return internalGetSubspacesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ...
          internalGetSubspacesFieldBuilder() {
        if (subspacesBuilder_ == null) {
          subspacesBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
              cosmos.params.v1beta1.QueryOuterClass.Subspace, cosmos.params.v1beta1.QueryOuterClass.Subspace.Builder, cosmos.params.v1beta1.QueryOuterClass.SubspaceOrBuilder>(
                  subspaces_,
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        Subspace.class.getName());
    }
    // Use Subspace.newBuilder() to construct.
    private Subspace(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    private Subspace() {
      subspace_ = "";
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(cosmos.params.v1beta1.QueryOuterClass.Subspace result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.subspace_ = subspace_;
        }
