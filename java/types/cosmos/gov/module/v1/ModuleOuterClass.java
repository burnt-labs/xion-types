...
public final class ModuleOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return cosmos.gov.module.v1.ModuleOuterClass.internal_static_cosmos_gov_module_v1_Module_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return cosmos.gov.module.v1.ModuleOuterClass.internal_static_cosmos_gov_module_v1_Module_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              cosmos.gov.module.v1.ModuleOuterClass.Module.class, cosmos.gov.module.v1.ModuleOuterClass.Module.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof cosmos.gov.module.v1.ModuleOuterClass.Module)) {
        return super.equals(obj);
      }
      cosmos.gov.module.v1.ModuleOuterClass.Module other = (cosmos.gov.module.v1.ModuleOuterClass.Module) obj;
    ...
    public static cosmos.gov.module.v1.ModuleOuterClass.Module parseFrom(
    ...
    public static cosmos.gov.module.v1.ModuleOuterClass.Module parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static cosmos.gov.module.v1.ModuleOuterClass.Module parseFrom(
    ...
    public static cosmos.gov.module.v1.ModuleOuterClass.Module parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static cosmos.gov.module.v1.ModuleOuterClass.Module parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static cosmos.gov.module.v1.ModuleOuterClass.Module parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessage
    ...
    public static Builder newBuilder(cosmos.gov.module.v1.ModuleOuterClass.Module prototype) {
    ...
    public static final class Builder extends
        ...
        cosmos.gov.module.v1.ModuleOuterClass.ModuleOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return cosmos.gov.module.v1.ModuleOuterClass.internal_static_cosmos_gov_module_v1_Module_descriptor;
      }
      ...
      // Construct using cosmos.gov.module.v1.ModuleOuterClass.Module.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public cosmos.gov.module.v1.ModuleOuterClass.Module getDefaultInstanceForType() {
        return cosmos.gov.module.v1.ModuleOuterClass.Module.getDefaultInstance();
      }

      @java.lang.Override
      public cosmos.gov.module.v1.ModuleOuterClass.Module build() {
        cosmos.gov.module.v1.ModuleOuterClass.Module result = buildPartial();
      ...
      @java.lang.Override
      public cosmos.gov.module.v1.ModuleOuterClass.Module buildPartial() {
        cosmos.gov.module.v1.ModuleOuterClass.Module result = new cosmos.gov.module.v1.ModuleOuterClass.Module(this);
        if (bitField0_ != 0) { buildPartial0(result); }
        onBuilt();
        return result;
      }

      private void buildPartial0(cosmos.gov.module.v1.ModuleOuterClass.Module result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof cosmos.gov.module.v1.ModuleOuterClass.Module) {
          return mergeFrom((cosmos.gov.module.v1.ModuleOuterClass.Module)other);
        } else {
      ...
      public Builder mergeFrom(cosmos.gov.module.v1.ModuleOuterClass.Module other) {
        if (other == cosmos.gov.module.v1.ModuleOuterClass.Module.getDefaultInstance()) return this;
    ...
    private static final cosmos.gov.module.v1.ModuleOuterClass.Module DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new cosmos.gov.module.v1.ModuleOuterClass.Module();
    }

    public static cosmos.gov.module.v1.ModuleOuterClass.Module getDefaultInstance() {
