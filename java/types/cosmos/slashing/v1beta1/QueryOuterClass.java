...
public final class QueryOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(cosmos.slashing.v1beta1.QueryOuterClass.QueryParamsResponse result) {
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        QuerySigningInfoRequest.class.getName());
    }
    // Use QuerySigningInfoRequest.newBuilder() to construct.
    private QuerySigningInfoRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(consAddress_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, consAddress_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(consAddress_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, consAddress_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(cosmos.slashing.v1beta1.QueryOuterClass.QuerySigningInfoRequest result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        QuerySigningInfoResponse.class.getName());
    }
    // Use QuerySigningInfoResponse.newBuilder() to construct.
    private QuerySigningInfoResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
                .alwaysUseFieldBuilders) {
          internalGetValSigningInfoFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
      ...
      private void buildPartial0(cosmos.slashing.v1beta1.QueryOuterClass.QuerySigningInfoResponse result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                input.readMessage(
                    internalGetValSigningInfoFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
      ...
      public Builder mergeValSigningInfo(cosmos.slashing.v1beta1.Slashing.ValidatorSigningInfo value) {
        if (valSigningInfoBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0) &&
            valSigningInfo_ != null &&
            valSigningInfo_ != cosmos.slashing.v1beta1.Slashing.ValidatorSigningInfo.getDefaultInstance()) {
      ...
      public cosmos.slashing.v1beta1.Slashing.ValidatorSigningInfo.Builder getValSigningInfoBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetValSigningInfoFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * val_signing_info is the signing info of requested val cons address
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          internalGetValSigningInfoFieldBuilder() {
        if (valSigningInfoBuilder_ == null) {
          valSigningInfoBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              cosmos.slashing.v1beta1.Slashing.ValidatorSigningInfo, cosmos.slashing.v1beta1.Slashing.ValidatorSigningInfo.Builder, cosmos.slashing.v1beta1.Slashing.ValidatorSigningInfoOrBuilder>(
                  getValSigningInfo(),
                  getParentForChildren(),
                  isClean());
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        QuerySigningInfosRequest.class.getName());
    }
    // Use QuerySigningInfosRequest.newBuilder() to construct.
    private QuerySigningInfosRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(cosmos.slashing.v1beta1.QueryOuterClass.QuerySigningInfosRequest result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) != 0)) {
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        QuerySigningInfosResponse.class.getName());
    }
    // Use QuerySigningInfosResponse.newBuilder() to construct.
    private QuerySigningInfosResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(cosmos.slashing.v1beta1.QueryOuterClass.QuerySigningInfosResponse result) {
        if (infoBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0)) {
      ...
      private void buildPartial0(cosmos.slashing.v1beta1.QueryOuterClass.QuerySigningInfosResponse result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                cosmos.slashing.v1beta1.Slashing.ValidatorSigningInfo m =
                    input.readMessage(
                        cosmos.slashing.v1beta1.Slashing.ValidatorSigningInfo.parser(),
                        extensionRegistry);
                if (infoBuilder_ == null) {
                  ensureInfoIsMutable();
                  info_.add(m);
