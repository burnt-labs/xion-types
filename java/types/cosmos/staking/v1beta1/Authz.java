  ...
  public enum AuthorizationType
    ...
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        AuthorizationType.class.getName());
    }
    /**
     * <pre>
     * AUTHORIZATION_TYPE_UNSPECIFIED specifies an unknown authorization type
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        StakeAuthorization.class.getName());
    }
    // Use StakeAuthorization.newBuilder() to construct.
    private StakeAuthorization(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    private static final long serialVersionUID = 0L;
      static {
        com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
          ...
          /* patch= */ 1,
          /* suffix= */ "",
          Validators.class.getName());
      }
      // Use Validators.newBuilder() to construct.
      private Validators(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
      private Validators() {
        address_ =
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage
          ...
          internalGetMaxTokensFieldBuilder();
        }
      }
      @java.lang.Override
      public Builder clear() {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10: {
                input.readMessage(
                    internalGetMaxTokensFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
              case 18: {
                input.readMessage(
                    internalGetAllowListFieldBuilder().getBuilder(),
                    extensionRegistry);
                validatorsCase_ = 2;
                break;
              } // case 18
              case 26: {
                input.readMessage(
                    internalGetDenyListFieldBuilder().getBuilder(),
                    extensionRegistry);
                validatorsCase_ = 3;
                break;
              } // case 26
      ...
      public cosmos.base.v1beta1.CoinOuterClass.Coin.Builder getMaxTokensBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetMaxTokensFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * max_tokens specifies the maximum amount of tokens can be delegate to a validator. If it is
      ...
      private com.google.protobuf.SingleFieldBuilder<
          ...
          internalGetMaxTokensFieldBuilder() {
        if (maxTokensBuilder_ == null) {
          maxTokensBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              cosmos.base.v1beta1.CoinOuterClass.Coin, cosmos.base.v1beta1.CoinOuterClass.Coin.Builder, cosmos.base.v1beta1.CoinOuterClass.CoinOrBuilder>(
                  getMaxTokens(),
      ...
      private com.google.protobuf.SingleFieldBuilder<
        ...
        if (allowListBuilder_ == null) {
          ...
          allowListBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              cosmos.staking.v1beta1.Authz.StakeAuthorization.Validators, cosmos.staking.v1beta1.Authz.StakeAuthorization.Validators.Builder, cosmos.staking.v1beta1.Authz.StakeAuthorization.ValidatorsOrBuilder>(
      ...
      public cosmos.staking.v1beta1.Authz.StakeAuthorization.Validators.Builder getDenyListBuilder() {
        return internalGetDenyListFieldBuilder().getBuilder();
      }
      /**
       * <pre>
       * deny_list specifies list of validator addresses to whom grantee can not delegate tokens.
      ...
      private com.google.protobuf.SingleFieldBuilder<
          cosmos.staking.v1beta1.Authz.StakeAuthorization.Validators, cosmos.staking.v1beta1.Authz.StakeAuthorization.Validators.Builder, cosmos.staking.v1beta1.Authz.StakeAuthorization.ValidatorsOrBuilder> 
          internalGetDenyListFieldBuilder() {
        if (denyListBuilder_ == null) {
          if (!(validatorsCase_ == 3)) {
            validators_ = cosmos.staking.v1beta1.Authz.StakeAuthorization.Validators.getDefaultInstance();
          }
          denyListBuilder_ = new com.google.protobuf.SingleFieldBuilder<
              cosmos.staking.v1beta1.Authz.StakeAuthorization.Validators, cosmos.staking.v1beta1.Authz.StakeAuthorization.Validators.Builder, cosmos.staking.v1beta1.Authz.StakeAuthorization.ValidatorsOrBuilder>(
                  (cosmos.staking.v1beta1.Authz.StakeAuthorization.Validators) validators_,
                  getParentForChildren(),
                  isClean());
