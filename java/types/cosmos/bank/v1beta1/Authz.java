...
public final class Authz {
  ...
  public interface SendAuthorizationOrBuilder extends
     ...
     * </pre>
     *
     * <code>repeated string allow_list = 2 [json_name = "allowList", (.cosmos_proto.scalar) = "cosmos.AddressString", (.cosmos_proto.field_added_in) = "cosmos-sdk 0.47"];</code>
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        SendAuthorization.class.getName());
    }
    // Use SendAuthorization.newBuilder() to construct.
    private SendAuthorization(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < allowList_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, allowList_.getRaw(i));
      }
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(cosmos.bank.v1beta1.Authz.SendAuthorization result) {
        if (spendLimitBuilder_ == null) {
      ...
      private void buildPartial0(cosmos.bank.v1beta1.Authz.SendAuthorization result) {
