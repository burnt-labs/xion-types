...
class GenesisState final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.gov.v1.GenesisState) */ {
 public:
 ...
 private:
  ...
  static const ::google::protobuf::internal::TcParseTable<4, 9, 7, 55, 2> _table_;
...
inline std::string* GenesisState::mutable_constitution() {
