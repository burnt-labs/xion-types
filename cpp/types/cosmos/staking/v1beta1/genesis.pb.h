...
class GenesisState final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.staking.v1beta1.GenesisState) */ {
 public:
  ...
  ::google::protobuf::RepeatedPtrField< ::cosmos::staking::v1beta1::LastValidatorPower >*
  ...
  const ::google::protobuf::RepeatedPtrField< ::cosmos::staking::v1beta1::LastValidatorPower >&
  ...
  ::google::protobuf::RepeatedPtrField< ::cosmos::staking::v1beta1::Delegation >*
      mutable_delegations();
  private:
  ...
  const ::google::protobuf::RepeatedPtrField< ::cosmos::staking::v1beta1::Delegation >&
      delegations() const;
  ...
  ::google::protobuf::RepeatedPtrField< ::cosmos::staking::v1beta1::Redelegation >*
  ...
  const ::google::protobuf::RepeatedPtrField< ::cosmos::staking::v1beta1::Redelegation >&
      redelegations() const;
...
class LastValidatorPower final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.staking.v1beta1.LastValidatorPower) */ {
 public:
  inline LastValidatorPower() : LastValidatorPower(nullptr) {}
  ~LastValidatorPower() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR LastValidatorPower(::google::protobuf::internal::ConstantInitialized);
  ...
  LastValidatorPower* New(::google::protobuf::Arena* arena = nullptr) const final {
