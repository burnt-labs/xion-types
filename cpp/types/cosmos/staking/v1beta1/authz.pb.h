...
class StakeAuthorization_Validators final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.staking.v1beta1.StakeAuthorization.Validators) */ {
 public:
  inline StakeAuthorization_Validators() : StakeAuthorization_Validators(nullptr) {}
  ~StakeAuthorization_Validators() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR StakeAuthorization_Validators(::google::protobuf::internal::ConstantInitialized);
  ...
  StakeAuthorization_Validators* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class StakeAuthorization final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.staking.v1beta1.StakeAuthorization) */ {
 public:
  inline StakeAuthorization() : StakeAuthorization(nullptr) {}
  ~StakeAuthorization() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR StakeAuthorization(::google::protobuf::internal::ConstantInitialized);
  ...
  StakeAuthorization* New(::google::protobuf::Arena* arena = nullptr) const final {
 ...
 private:
  ...
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<1, 4, 3, 0, 2> _table_;
  template <typename T> friend class ::google::protobuf::Arena::InternalHelper;
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  struct Impl_ {
...
inline ::google::protobuf::RepeatedPtrField<std::string>* StakeAuthorization_Validators::mutable_address() {
