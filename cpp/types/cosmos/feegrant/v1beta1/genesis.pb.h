...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_2ffeegrant_2fv1beta1_2fgenesis_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_2ffeegrant_2fv1beta1_2fgenesis_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_cosmos_2ffeegrant_2fv1beta1_2fgenesis_2eproto
...
struct TableStruct_cosmos_2ffeegrant_2fv1beta1_2fgenesis_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_cosmos_2ffeegrant_2fv1beta1_2fgenesis_2eproto;
namespace cosmos {
namespace feegrant {
namespace v1beta1 {
class GenesisState;
...
class GenesisState final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.feegrant.v1beta1.GenesisState) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "cosmos.feegrant.v1beta1.GenesisState";
  }
  protected:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_cosmos_2ffeegrant_2fv1beta1_2fgenesis_2eproto;
};
...
// repeated .cosmos.feegrant.v1beta1.Grant allowances = 1 [json_name = "allowances", (.gogoproto.nullable) = false, (.amino.dont_omitempty) = true];
inline int GenesisState::_internal_allowances_size() const {
  return _internal_allowances().size();
}
inline int GenesisState::allowances_size() const {
  return _internal_allowances_size();
}
inline ::cosmos::feegrant::v1beta1::Grant* GenesisState::mutable_allowances(int index) {
  // @@protoc_insertion_point(field_mutable:cosmos.feegrant.v1beta1.GenesisState.allowances)
  return _internal_mutable_allowances()->Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::cosmos::feegrant::v1beta1::Grant >*
GenesisState::mutable_allowances() {
  // @@protoc_insertion_point(field_mutable_list:cosmos.feegrant.v1beta1.GenesisState.allowances)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _internal_mutable_allowances();
}
inline const ::cosmos::feegrant::v1beta1::Grant& GenesisState::allowances(int index) const {
  // @@protoc_insertion_point(field_get:cosmos.feegrant.v1beta1.GenesisState.allowances)
    return _internal_allowances().Get(index);
}
inline ::cosmos::feegrant::v1beta1::Grant* GenesisState::add_allowances() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::cosmos::feegrant::v1beta1::Grant* _add = _internal_mutable_allowances()->Add();
  // @@protoc_insertion_point(field_add:cosmos.feegrant.v1beta1.GenesisState.allowances)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField< ::cosmos::feegrant::v1beta1::Grant >&
GenesisState::allowances() const {
  // @@protoc_insertion_point(field_list:cosmos.feegrant.v1beta1.GenesisState.allowances)
  return _internal_allowances();
}
inline const ::google::protobuf::RepeatedPtrField<::cosmos::feegrant::v1beta1::Grant>&
GenesisState::_internal_allowances() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.allowances_;
}
inline ::google::protobuf::RepeatedPtrField<::cosmos::feegrant::v1beta1::Grant>*
GenesisState::_internal_mutable_allowances() {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return &_impl_.allowances_;
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_cosmos_2ffeegrant_2fv1beta1_2fgenesis_2eproto_2epb_2eh
