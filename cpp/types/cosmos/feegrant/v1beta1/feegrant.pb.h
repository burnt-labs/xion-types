...
class BasicAllowance final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.feegrant.v1beta1.BasicAllowance) */ {
 public:
  inline BasicAllowance() : BasicAllowance(nullptr) {}
  ~BasicAllowance() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR BasicAllowance(::google::protobuf::internal::ConstantInitialized);
  ...
  BasicAllowance* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class PeriodicAllowance final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.feegrant.v1beta1.PeriodicAllowance) */ {
 public:
  inline PeriodicAllowance() : PeriodicAllowance(nullptr) {}
  ~PeriodicAllowance() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR PeriodicAllowance(::google::protobuf::internal::ConstantInitialized);
  ...
  PeriodicAllowance* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class AllowedMsgAllowance final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.feegrant.v1beta1.AllowedMsgAllowance) */ {
 public:
  inline AllowedMsgAllowance() : AllowedMsgAllowance(nullptr) {}
  ~AllowedMsgAllowance() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR AllowedMsgAllowance(::google::protobuf::internal::ConstantInitialized);
  ...
  AllowedMsgAllowance* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class Grant final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.feegrant.v1beta1.Grant) */ {
 public:
...
inline const ::google::protobuf::Timestamp& BasicAllowance::expiration() const {
...
inline ::google::protobuf::Timestamp* BasicAllowance::mutable_expiration() {
...
inline void PeriodicAllowance::set_allocated_basic(::cosmos::feegrant::v1beta1::BasicAllowance* value) {
  ...
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (message_arena == nullptr) {
    delete reinterpret_cast<::cosmos::feegrant::v1beta1::BasicAllowance*>(_impl_.basic_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::cosmos::feegrant::v1beta1::BasicAllowance*>(value));
    if (message_arena != submessage_arena) {
      value = ::google::protobuf::internal::GetOwnedMessage(message_arena, value, submessage_arena);
    }
    _impl_._has_bits_[0] |= 0x00000001u;
...
inline const ::google::protobuf::Duration& PeriodicAllowance::period() const {
...
inline ::google::protobuf::Duration* PeriodicAllowance::mutable_period() {
...
inline const ::google::protobuf::Timestamp& PeriodicAllowance::period_reset() const {
...
inline ::google::protobuf::Timestamp* PeriodicAllowance::mutable_period_reset() {
...
inline const ::google::protobuf::Any& AllowedMsgAllowance::allowance() const {
...
inline ::google::protobuf::Any* AllowedMsgAllowance::mutable_allowance() {
...
inline ::google::protobuf::RepeatedPtrField<std::string>* AllowedMsgAllowance::mutable_allowed_messages() {
...
inline const ::google::protobuf::Any& Grant::allowance() const {
...
inline ::google::protobuf::Any* Grant::mutable_allowance() {
  ::google::protobuf::Any* _msg = _internal_mutable_allowance();
