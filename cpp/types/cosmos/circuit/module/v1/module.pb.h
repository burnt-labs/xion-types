...
#ifndef cosmos_2fcircuit_2fmodule_2fv1_2fmodule_2eproto_2epb_2eh
#define cosmos_2fcircuit_2fmodule_2fv1_2fmodule_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_cosmos_2fcircuit_2fmodule_2fv1_2fmodule_2eproto
...
struct TableStruct_cosmos_2fcircuit_2fmodule_2fv1_2fmodule_2eproto {
...
/* @@protoc_insertion_point(class_definition:cosmos.circuit.module.v1.Module) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "cosmos.circuit.module.v1.Module"; }
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_cosmos_2fcircuit_2fmodule_2fv1_2fmodule_2eproto;
};
...
inline const std::string& Module::authority() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:cosmos.circuit.module.v1.Module.authority)
...
inline PROTOBUF_ALWAYS_INLINE void Module::set_authority(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cosmos.circuit.module.v1.Module.authority)
}
inline std::string* Module::mutable_authority() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_authority();
  // @@protoc_insertion_point(field_mutable:cosmos.circuit.module.v1.Module.authority)
  return _s;
}
...
inline std::string* Module::release_authority() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:cosmos.circuit.module.v1.Module.authority)
...
inline void Module::set_allocated_authority(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cosmos.circuit.module.v1.Module.authority)
}
...
#endif  // cosmos_2fcircuit_2fmodule_2fv1_2fmodule_2eproto_2epb_2eh
