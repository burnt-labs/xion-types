...
#ifndef cosmos_2fauthz_2fv1beta1_2fgenesis_2eproto_2epb_2eh
#define cosmos_2fauthz_2fv1beta1_2fgenesis_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:cosmos.authz.v1beta1.GenesisState) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "cosmos.authz.v1beta1.GenesisState"; }
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::cosmos::authz::v1beta1::GrantAuthorization>* mutable_authorization();

  private:
  const ::google::protobuf::RepeatedPtrField<::cosmos::authz::v1beta1::GrantAuthorization>& _internal_authorization() const;
  ::google::protobuf::RepeatedPtrField<::cosmos::authz::v1beta1::GrantAuthorization>* _internal_mutable_authorization();
  public:
  ...
  const ::google::protobuf::RepeatedPtrField<::cosmos::authz::v1beta1::GrantAuthorization>& authorization() const;
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::protobuf::RepeatedPtrField< ::cosmos::authz::v1beta1::GrantAuthorization > authorization_;
...
inline int GenesisState::_internal_authorization_size() const {
  return _internal_authorization().size();
}
...
inline ::google::protobuf::RepeatedPtrField<::cosmos::authz::v1beta1::GrantAuthorization>* GenesisState::mutable_authorization()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::cosmos::authz::v1beta1::GrantAuthorization* GenesisState::add_authorization() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::cosmos::authz::v1beta1::GrantAuthorization* _add = _internal_mutable_authorization()->Add();
  // @@protoc_insertion_point(field_add:cosmos.authz.v1beta1.GenesisState.authorization)
  return _add;
}
inline const ::google::protobuf::RepeatedPtrField<::cosmos::authz::v1beta1::GrantAuthorization>& GenesisState::authorization() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
#endif  // cosmos_2fauthz_2fv1beta1_2fgenesis_2eproto_2epb_2eh
