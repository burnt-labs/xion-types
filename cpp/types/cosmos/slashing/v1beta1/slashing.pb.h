...
class ValidatorSigningInfo final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.slashing.v1beta1.ValidatorSigningInfo) */ {
 public:
  inline ValidatorSigningInfo() : ValidatorSigningInfo(nullptr) {}
  ~ValidatorSigningInfo() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ValidatorSigningInfo(::google::protobuf::internal::ConstantInitialized);
  ...
  ValidatorSigningInfo* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class Params final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.slashing.v1beta1.Params) */ {
 public:
...
inline const ::google::protobuf::Timestamp& ValidatorSigningInfo::jailed_until() const {
...
inline ::google::protobuf::Timestamp* ValidatorSigningInfo::mutable_jailed_until() {
...
inline const ::google::protobuf::Duration& Params::downtime_jail_duration() const {
...
inline ::google::protobuf::Duration* Params::mutable_downtime_jail_duration() {
