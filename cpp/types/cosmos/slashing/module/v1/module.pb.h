...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_2fslashing_2fmodule_2fv1_2fmodule_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_2fslashing_2fmodule_2fv1_2fmodule_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_cosmos_2fslashing_2fmodule_2fv1_2fmodule_2eproto
...
struct TableStruct_cosmos_2fslashing_2fmodule_2fv1_2fmodule_2eproto {
...
class Module final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.slashing.module.v1.Module) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "cosmos.slashing.module.v1.Module";
  }
  protected:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_cosmos_2fslashing_2fmodule_2fv1_2fmodule_2eproto;
};
...
inline const std::string& Module::authority() const {
  // @@protoc_insertion_point(field_get:cosmos.slashing.module.v1.Module.authority)
...
inline PROTOBUF_ALWAYS_INLINE void Module::set_authority(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:cosmos.slashing.module.v1.Module.authority)
}
inline std::string* Module::mutable_authority() {
  std::string* _s = _internal_mutable_authority();
  // @@protoc_insertion_point(field_mutable:cosmos.slashing.module.v1.Module.authority)
  return _s;
}
...
inline std::string* Module::release_authority() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:cosmos.slashing.module.v1.Module.authority)
...
inline void Module::set_allocated_authority(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:cosmos.slashing.module.v1.Module.authority)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_cosmos_2fslashing_2fmodule_2fv1_2fmodule_2eproto_2epb_2eh
