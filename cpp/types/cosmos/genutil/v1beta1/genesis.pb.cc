...
const ::uint32_t
    TableStruct_cosmos_2fgenutil_2fv1beta1_2fgenesis_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_cosmos_2fgenutil_2fv1beta1_2fgenesis_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_cosmos_2fgenutil_2fv1beta1_2fgenesis_2eproto = {
    false,
    false,
    256,
...
inline PROTOBUF_NDEBUG_INLINE GenesisState::Impl_::Impl_(
    ...
    const Impl_& from, const ::cosmos::genutil::v1beta1::GenesisState& from_msg)
      : gen_txs_{visibility, arena, from.gen_txs_},
        _cached_size_{0} {}
...
constexpr auto GenesisState::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(GenesisState, _impl_.gen_txs_) +
          decltype(GenesisState::_impl_.gen_txs_)::
...
const ::_pbi::TcParseTable<0, 1, 0, 0, 2> GenesisState::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::cosmos::genutil::v1beta1::GenesisState>(),  // to_prefetch
...
// @@protoc_insertion_point(message_clear_start:cosmos.genutil.v1beta1.GenesisState)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* GenesisState::_InternalSerialize(
          ...
          // repeated bytes gen_txs = 1 [json_name = "genTxs", (.gogoproto.jsontag) = "gentxs", (.gogoproto.casttype) = "encoding/json.RawMessage", (.amino.field_name) = "gentxs", (.amino.dont_omitempty) = true];
          for (int i = 0, n = this_._internal_gen_txs_size(); i < n; ++i) {
            const auto& s = this_._internal_gen_txs().Get(i);
          ...
          ::_pbi::Prefetch5LinesFrom7Lines(&this_);
           {
            ...
            {
              total_size +=
                  1 * ::google::protobuf::internal::FromIntSize(this_._internal_gen_txs().size());
              for (int i = 0, n = this_._internal_gen_txs().size(); i < n; ++i) {
                total_size += ::google::protobuf::internal::WireFormatLite::BytesSize(
                    this_._internal_gen_txs().Get(i));
              }
            }
          }
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_cosmos_2fgenutil_2fv1beta1_2fgenesis_2eproto),
         ::std::false_type{});
