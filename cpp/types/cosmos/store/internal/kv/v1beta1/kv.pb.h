...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_2fstore_2finternal_2fkv_2fv1beta1_2fkv_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_2fstore_2finternal_2fkv_2fv1beta1_2fkv_2eproto_2epb_2eh
...
class Pairs final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.store.internal.kv.v1beta1.Pairs) */ {
 public:
  inline Pairs() : Pairs(nullptr) {}
  ~Pairs() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR Pairs(::google::protobuf::internal::ConstantInitialized);
  ...
  static ::absl::string_view FullMessageName() {
    return "cosmos.store.internal.kv.v1beta1.Pairs";
  }
  protected:
  ...
  ::google::protobuf::RepeatedPtrField< ::cosmos::store::internal::kv::v1beta1::Pair >*
      mutable_pairs();
  private:
  ...
  const ::google::protobuf::RepeatedPtrField< ::cosmos::store::internal::kv::v1beta1::Pair >&
      pairs() const;
...
class Pair final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.store.internal.kv.v1beta1.Pair) */ {
 public:
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "cosmos.store.internal.kv.v1beta1.Pair";
  }
  protected:
...
inline ::cosmos::store::internal::kv::v1beta1::Pair* Pairs::add_pairs() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_cosmos_2fstore_2finternal_2fkv_2fv1beta1_2fkv_2eproto_2epb_2eh
