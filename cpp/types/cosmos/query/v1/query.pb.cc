...
const char descriptor_table_protodef_cosmos_2fquery_2fv1_2fquery_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    ...
    "*Z(github.com/cosmos/cosmos-sdk/types/qu"
    "eryb\006proto3"
};
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_cosmos_2fquery_2fv1_2fquery_2eproto = {
    false,
    false,
    211,
...
PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 ::_pbi::
        ExtensionIdentifier<::google::protobuf::MethodOptions, ::_pbi::PrimitiveTypeTraits< bool >,
                            8, false>
            module_query_safe(kModuleQuerySafeFieldNumber, false);
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_cosmos_2fquery_2fv1_2fquery_2eproto),
        ::_pbi::ExtensionSet::RegisterExtension(
            &::google::protobuf::MethodOptions::default_instance(), 11110001, 8,
            false, false),
         ::std::false_type{});
