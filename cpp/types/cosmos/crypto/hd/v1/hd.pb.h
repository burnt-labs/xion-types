...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_2fcrypto_2fhd_2fv1_2fhd_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_2fcrypto_2fhd_2fv1_2fhd_2eproto_2epb_2eh
...
class BIP44Params final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.crypto.hd.v1.BIP44Params) */ {
 public:
  inline BIP44Params() : BIP44Params(nullptr) {}
  ~BIP44Params() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR BIP44Params(::google::protobuf::internal::ConstantInitialized);

  BIP44Params(const BIP44Params& from);
  BIP44Params(BIP44Params&& from) noexcept
    : BIP44Params() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(BIP44Params& a, BIP44Params& b) {
    a.Swap(&b);
  }
  ...
  BIP44Params* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<BIP44Params>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const BIP44Params& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const BIP44Params& from) {
    BIP44Params::MergeImpl(*this, from);
  }
  private:
  ...
  static ::absl::string_view FullMessageName() {
    return "cosmos.crypto.hd.v1.BIP44Params";
  }
  protected:
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_cosmos_2fcrypto_2fhd_2fv1_2fhd_2eproto_2epb_2eh
