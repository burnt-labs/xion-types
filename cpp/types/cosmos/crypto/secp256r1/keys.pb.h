...
#ifndef GOOGLE_PROTOBUF_INCLUDED_cosmos_2fcrypto_2fsecp256r1_2fkeys_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_cosmos_2fcrypto_2fsecp256r1_2fkeys_2eproto_2epb_2eh
...
class PubKey final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.crypto.secp256r1.PubKey) */ {
 public:
  inline PubKey() : PubKey(nullptr) {}
  ~PubKey() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR PubKey(::google::protobuf::internal::ConstantInitialized);
  ...
  PubKey* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class PrivKey final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.crypto.secp256r1.PrivKey) */ {
 public:
  inline PrivKey() : PrivKey(nullptr) {}
  ~PrivKey() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR PrivKey(::google::protobuf::internal::ConstantInitialized);
  ...
  PrivKey* New(::google::protobuf::Arena* arena = nullptr) const final {
...
inline std::string* PrivKey::mutable_secret() {
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_cosmos_2fcrypto_2fsecp256r1_2fkeys_2eproto_2epb_2eh
