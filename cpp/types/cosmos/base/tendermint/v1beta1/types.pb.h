...
class Block final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.base.tendermint.v1beta1.Block) */ {
 public:
...
class Header final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.base.tendermint.v1beta1.Header) */ {
 public:
 ...
 private:
  ...
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<4, 14, 3, 78, 2> _table_;
  template <typename T> friend class ::google::protobuf::Arena::InternalHelper;
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  struct Impl_ {
...
inline void Block::set_allocated_header(::cosmos::base::tendermint::v1beta1::Header* value) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast<::cosmos::base::tendermint::v1beta1::Header*>(_impl_.header_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena =
        ::google::protobuf::Arena::InternalGetOwningArena(reinterpret_cast<::cosmos::base::tendermint::v1beta1::Header*>(value));
