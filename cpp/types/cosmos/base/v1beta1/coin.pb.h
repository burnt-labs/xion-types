...
class Coin final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.base.v1beta1.Coin) */ {
 public:
  inline Coin() : Coin(nullptr) {}
  ~Coin() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR Coin(::google::protobuf::internal::ConstantInitialized);
  ...
  Coin* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class DecCoin final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.base.v1beta1.DecCoin) */ {
 public:
  inline DecCoin() : DecCoin(nullptr) {}
  ~DecCoin() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR DecCoin(::google::protobuf::internal::ConstantInitialized);
  ...
  DecCoin* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class IntProto final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.base.v1beta1.IntProto) */ {
 public:
  inline IntProto() : IntProto(nullptr) {}
  ~IntProto() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR IntProto(::google::protobuf::internal::ConstantInitialized);
  ...
  IntProto* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class DecProto final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.base.v1beta1.DecProto) */ {
 public:
  inline DecProto() : DecProto(nullptr) {}
  ~DecProto() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR DecProto(::google::protobuf::internal::ConstantInitialized);
  ...
  DecProto* New(::google::protobuf::Arena* arena = nullptr) const final {
