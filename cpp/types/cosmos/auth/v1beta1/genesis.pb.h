...
#ifndef cosmos_2fauth_2fv1beta1_2fgenesis_2eproto_2epb_2eh
#define cosmos_2fauth_2fv1beta1_2fgenesis_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:cosmos.auth.v1beta1.GenesisState) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "cosmos.auth.v1beta1.GenesisState"; }
...
inline const ::cosmos::auth::v1beta1::Params& GenesisState::params() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:cosmos.auth.v1beta1.GenesisState.params)
  return _internal_params();
}
inline void GenesisState::unsafe_arena_set_allocated_params(::cosmos::auth::v1beta1::Params* value) {
...
inline ::cosmos::auth::v1beta1::Params* GenesisState::mutable_params() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline void GenesisState::set_allocated_params(::cosmos::auth::v1beta1::Params* value) {
...
inline ::google::protobuf::Any* GenesisState::mutable_accounts(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::google::protobuf::RepeatedPtrField<::google::protobuf::Any>* GenesisState::mutable_accounts()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable_list:cosmos.auth.v1beta1.GenesisState.accounts)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  return _internal_mutable_accounts();
}
inline const ::google::protobuf::Any& GenesisState::accounts(int index) const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:cosmos.auth.v1beta1.GenesisState.accounts)
  return _internal_accounts().Get(index);
}
inline ::google::protobuf::Any* GenesisState::add_accounts() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline const ::google::protobuf::RepeatedPtrField<::google::protobuf::Any>& GenesisState::accounts() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
#endif  // cosmos_2fauth_2fv1beta1_2fgenesis_2eproto_2epb_2eh
