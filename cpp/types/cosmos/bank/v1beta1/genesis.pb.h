...
class GenesisState final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.bank.v1beta1.GenesisState) */ {
 public:
  ...
  ::google::protobuf::RepeatedPtrField< ::cosmos::bank::v1beta1::Balance >*
      mutable_balances();
  private:
  ...
  const ::google::protobuf::RepeatedPtrField< ::cosmos::bank::v1beta1::Balance >&
      balances() const;
...
class Balance final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos.bank.v1beta1.Balance) */ {
 public:
