...
class MsgIBCSend final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmwasm.wasm.v1.MsgIBCSend) */ {
 public:
  inline MsgIBCSend() : MsgIBCSend(nullptr) {}
  ~MsgIBCSend() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR MsgIBCSend(::google::protobuf::internal::ConstantInitialized);
  ...
  MsgIBCSend* New(::google::protobuf::Arena* arena = nullptr) const final {
 ...
 private:
  ...
  static const ::google::protobuf::internal::TcParseTable<3, 4, 0, 43, 2> _table_;
...
class MsgIBCSendResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmwasm.wasm.v1.MsgIBCSendResponse) */ {
 public:
  inline MsgIBCSendResponse() : MsgIBCSendResponse(nullptr) {}
  ~MsgIBCSendResponse() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR MsgIBCSendResponse(::google::protobuf::internal::ConstantInitialized);
  ...
  MsgIBCSendResponse* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class MsgIBCWriteAcknowledgementResponse final :
    public ::google::protobuf::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:cosmwasm.wasm.v1.MsgIBCWriteAcknowledgementResponse) */ {
 public:
  inline MsgIBCWriteAcknowledgementResponse() : MsgIBCWriteAcknowledgementResponse(nullptr) {}
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR MsgIBCWriteAcknowledgementResponse(::google::protobuf::internal::ConstantInitialized);

  MsgIBCWriteAcknowledgementResponse(const MsgIBCWriteAcknowledgementResponse& from);
  MsgIBCWriteAcknowledgementResponse(MsgIBCWriteAcknowledgementResponse&& from) noexcept
  ...
  friend void swap(MsgIBCWriteAcknowledgementResponse& a, MsgIBCWriteAcknowledgementResponse& b) {
    a.Swap(&b);
  }
  ...
  MsgIBCWriteAcknowledgementResponse* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<MsgIBCWriteAcknowledgementResponse>(arena);
  }
  ...
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() {
    return "cosmwasm.wasm.v1.MsgIBCWriteAcknowledgementResponse";
  }
  protected:
...
class MsgIBCCloseChannel final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmwasm.wasm.v1.MsgIBCCloseChannel) */ {
 public:
  inline MsgIBCCloseChannel() : MsgIBCCloseChannel(nullptr) {}
  ~MsgIBCCloseChannel() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR MsgIBCCloseChannel(::google::protobuf::internal::ConstantInitialized);
  ...
  MsgIBCCloseChannel* New(::google::protobuf::Arena* arena = nullptr) const final {
