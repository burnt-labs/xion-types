...
#ifndef GOOGLE_PROTOBUF_INCLUDED_xion_2fmint_2fv1_2fmint_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_xion_2fmint_2fv1_2fmint_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_xion_2fmint_2fv1_2fmint_2eproto
...
struct TableStruct_xion_2fmint_2fv1_2fmint_2eproto {
...
class Minter final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:xion.mint.v1.Minter) */ {
 public:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_xion_2fmint_2fv1_2fmint_2eproto;
};// -------------------------------------------------------------------

class Params final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:xion.mint.v1.Params) */ {
 public:
 ...
 private:
  ...
  friend class ::google::protobuf::internal::TcParser;
  static const ::google::protobuf::internal::TcParseTable<3, 6, 0, 96, 2> _table_;
  template <typename T> friend class ::google::protobuf::Arena::InternalHelper;
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  struct Impl_ {
...
inline const std::string& Minter::inflation() const {
  // @@protoc_insertion_point(field_get:xion.mint.v1.Minter.inflation)
...
inline PROTOBUF_ALWAYS_INLINE void Minter::set_inflation(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:xion.mint.v1.Minter.inflation)
}
inline std::string* Minter::mutable_inflation() {
  std::string* _s = _internal_mutable_inflation();
  // @@protoc_insertion_point(field_mutable:xion.mint.v1.Minter.inflation)
  return _s;
}
...
inline std::string* Minter::release_inflation() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:xion.mint.v1.Minter.inflation)
...
inline void Minter::set_allocated_inflation(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:xion.mint.v1.Minter.inflation)
}
...
inline const std::string& Minter::annual_provisions() const {
  // @@protoc_insertion_point(field_get:xion.mint.v1.Minter.annual_provisions)
...
inline PROTOBUF_ALWAYS_INLINE void Minter::set_annual_provisions(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:xion.mint.v1.Minter.annual_provisions)
}
inline std::string* Minter::mutable_annual_provisions() {
  std::string* _s = _internal_mutable_annual_provisions();
  // @@protoc_insertion_point(field_mutable:xion.mint.v1.Minter.annual_provisions)
  return _s;
}
...
inline std::string* Minter::release_annual_provisions() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:xion.mint.v1.Minter.annual_provisions)
...
inline void Minter::set_allocated_annual_provisions(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xion.mint.v1.Minter.annual_provisions)
}
...
inline const std::string& Params::mint_denom() const {
  // @@protoc_insertion_point(field_get:xion.mint.v1.Params.mint_denom)
...
inline PROTOBUF_ALWAYS_INLINE void Params::set_mint_denom(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:xion.mint.v1.Params.mint_denom)
}
inline std::string* Params::mutable_mint_denom() {
  std::string* _s = _internal_mutable_mint_denom();
  // @@protoc_insertion_point(field_mutable:xion.mint.v1.Params.mint_denom)
  return _s;
}
...
inline std::string* Params::release_mint_denom() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:xion.mint.v1.Params.mint_denom)
...
inline void Params::set_allocated_mint_denom(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xion.mint.v1.Params.mint_denom)
}
...
inline const std::string& Params::inflation_rate_change() const {
  // @@protoc_insertion_point(field_get:xion.mint.v1.Params.inflation_rate_change)
...
inline PROTOBUF_ALWAYS_INLINE void Params::set_inflation_rate_change(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:xion.mint.v1.Params.inflation_rate_change)
}
inline std::string* Params::mutable_inflation_rate_change() {
  std::string* _s = _internal_mutable_inflation_rate_change();
  // @@protoc_insertion_point(field_mutable:xion.mint.v1.Params.inflation_rate_change)
  return _s;
}
...
inline std::string* Params::release_inflation_rate_change() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:xion.mint.v1.Params.inflation_rate_change)
...
inline void Params::set_allocated_inflation_rate_change(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xion.mint.v1.Params.inflation_rate_change)
}
...
inline const std::string& Params::inflation_max() const {
  // @@protoc_insertion_point(field_get:xion.mint.v1.Params.inflation_max)
...
inline PROTOBUF_ALWAYS_INLINE void Params::set_inflation_max(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:xion.mint.v1.Params.inflation_max)
}
inline std::string* Params::mutable_inflation_max() {
  std::string* _s = _internal_mutable_inflation_max();
  // @@protoc_insertion_point(field_mutable:xion.mint.v1.Params.inflation_max)
  return _s;
}
...
inline std::string* Params::release_inflation_max() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:xion.mint.v1.Params.inflation_max)
...
inline void Params::set_allocated_inflation_max(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xion.mint.v1.Params.inflation_max)
}
...
inline const std::string& Params::inflation_min() const {
  // @@protoc_insertion_point(field_get:xion.mint.v1.Params.inflation_min)
...
inline PROTOBUF_ALWAYS_INLINE void Params::set_inflation_min(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:xion.mint.v1.Params.inflation_min)
}
inline std::string* Params::mutable_inflation_min() {
  std::string* _s = _internal_mutable_inflation_min();
  // @@protoc_insertion_point(field_mutable:xion.mint.v1.Params.inflation_min)
  return _s;
}
...
inline std::string* Params::release_inflation_min() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:xion.mint.v1.Params.inflation_min)
...
inline void Params::set_allocated_inflation_min(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xion.mint.v1.Params.inflation_min)
}
...
inline const std::string& Params::goal_bonded() const {
  // @@protoc_insertion_point(field_get:xion.mint.v1.Params.goal_bonded)
...
inline PROTOBUF_ALWAYS_INLINE void Params::set_goal_bonded(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:xion.mint.v1.Params.goal_bonded)
}
inline std::string* Params::mutable_goal_bonded() {
  std::string* _s = _internal_mutable_goal_bonded();
  // @@protoc_insertion_point(field_mutable:xion.mint.v1.Params.goal_bonded)
  return _s;
}
...
inline std::string* Params::release_goal_bonded() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:xion.mint.v1.Params.goal_bonded)
...
inline void Params::set_allocated_goal_bonded(std::string* value) {
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:xion.mint.v1.Params.goal_bonded)
}
...
inline ::uint64_t Params::blocks_per_year() const {
  // @@protoc_insertion_point(field_get:xion.mint.v1.Params.blocks_per_year)
  return _internal_blocks_per_year();
}
inline void Params::set_blocks_per_year(::uint64_t value) {
  _internal_set_blocks_per_year(value);
  // @@protoc_insertion_point(field_set:xion.mint.v1.Params.blocks_per_year)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_xion_2fmint_2fv1_2fmint_2eproto_2epb_2eh
