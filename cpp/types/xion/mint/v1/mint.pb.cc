...
const ::uint32_t
    TableStruct_xion_2fmint_2fv1_2fmint_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_xion_2fmint_2fv1_2fmint_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_xion_2fmint_2fv1_2fmint_2eproto = {
    false,
    false,
    820,
...
inline PROTOBUF_NDEBUG_INLINE Minter::Impl_::Impl_(
    ...
    const Impl_& from, const ::xion::mint::v1::Minter& from_msg)
...
const ::_pbi::TcParseTable<1, 2, 0, 54, 2> Minter::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::xion::mint::v1::Minter>(),  // to_prefetch
...
inline PROTOBUF_NDEBUG_INLINE Params::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::xion::mint::v1::Params& from_msg)
...
const ::_pbi::TcParseTable<3, 6, 0, 96, 2> Params::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::xion::mint::v1::Params>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_xion_2fmint_2fv1_2fmint_2eproto),
         ::std::false_type{});
