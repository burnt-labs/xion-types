...
inline void GenesisState::SharedDtor() {
  ...
  _impl_.recv_sequences_.~RepeatedPtrField();
  _impl_.ack_sequences_.~RepeatedPtrField();
}
...
::uint8_t* GenesisState::_InternalSerialize(
  ...
  for (unsigned i = 0,
    ...
    const auto& repfield = this->_internal_recv_sequences().Get(i);
    target = ::google::protobuf::internal::WireFormatLite::
  ...
  for (unsigned i = 0,
    ...
    const auto& repfield = this->_internal_ack_sequences().Get(i);
    target = ::google::protobuf::internal::WireFormatLite::
