...
const ::uint32_t
    TableStruct_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fhost_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        ...
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::ibc::applications::interchain_accounts::host::v1::QueryRequest, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::ibc::applications::interchain_accounts::host::v1::QueryRequest, _impl_.path_),
        PROTOBUF_FIELD_OFFSET(::ibc::applications::interchain_accounts::host::v1::QueryRequest, _impl_.data_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::ibc::applications::interchain_accounts::host::v1::Params)},
        {10, -1, -1, sizeof(::ibc::applications::interchain_accounts::host::v1::QueryRequest)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::ibc::applications::interchain_accounts::host::v1::_Params_default_instance_._instance,
    &::ibc::applications::interchain_accounts::host::v1::_QueryRequest_default_instance_._instance,
};
const char descriptor_table_protodef_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fhost_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fhost_2eproto = {
    false,
    false,
    330,
...
inline PROTOBUF_NDEBUG_INLINE Params::Impl_::Impl_(
    ...
    const Impl_& from, const ::ibc::applications::interchain_accounts::host::v1::Params& from_msg)
      : allow_messages_{visibility, arena, from.allow_messages_},
        _cached_size_{0} {}
...
Params::Params(
  ...
  _impl_.host_enabled_ = from._impl_.host_enabled_;
...
constexpr auto Params::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(Params, _impl_.allow_messages_) +
          decltype(Params::_impl_.allow_messages_)::
...
const ::_pbi::TcParseTable<1, 2, 0, 74, 2> Params::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    ::_pbi::TcParser::GetTable<::ibc::applications::interchain_accounts::host::v1::Params>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // repeated string allow_messages = 2 [json_name = "allowMessages"];
    {::_pbi::TcParser::FastUR1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(Params, _impl_.allow_messages_)}},
    // bool host_enabled = 1 [json_name = "hostEnabled"];
    {::_pbi::TcParser::SingularVarintNoZag1<bool, offsetof(Params, _impl_.host_enabled_), 63>(),
     {8, 63, 0, PROTOBUF_FIELD_OFFSET(Params, _impl_.host_enabled_)}},
  }}, {{
    65535, 65535
  }}, {{
    // bool host_enabled = 1 [json_name = "hostEnabled"];
    {PROTOBUF_FIELD_OFFSET(Params, _impl_.host_enabled_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kBool)},
    // repeated string allow_messages = 2 [json_name = "allowMessages"];
    {PROTOBUF_FIELD_OFFSET(Params, _impl_.allow_messages_), 0, 0,
...
// @@protoc_insertion_point(message_clear_start:ibc.applications.interchain_accounts.host.v1.Params)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* Params::_InternalSerialize(
          ...
          // bool host_enabled = 1 [json_name = "hostEnabled"];
          if (this_._internal_host_enabled() != 0) {
            target = stream->EnsureSpace(target);
            target = ::_pbi::WireFormatLite::WriteBoolToArray(
                1, this_._internal_host_enabled(), target);
          }

          // repeated string allow_messages = 2 [json_name = "allowMessages"];
          for (int i = 0, n = this_._internal_allow_messages_size(); i < n; ++i) {
            const auto& s = this_._internal_allow_messages().Get(i);
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                s.data(), static_cast<int>(s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "ibc.applications.interchain_accounts.host.v1.Params.allow_messages");
          ...
          ::_pbi::Prefetch5LinesFrom7Lines(&this_);
           {
            ...
            {
              total_size +=
                  1 * ::google::protobuf::internal::FromIntSize(this_._internal_allow_messages().size());
              for (int i = 0, n = this_._internal_allow_messages().size(); i < n; ++i) {
                total_size += ::google::protobuf::internal::WireFormatLite::StringSize(
                    this_._internal_allow_messages().Get(i));
              }
            }
          }
           {
...
void Params::InternalSwap(Params* PROTOBUF_RESTRICT other) {
  ...
  _impl_.allow_messages_.InternalSwap(&other->_impl_.allow_messages_);
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:ibc.applications.interchain_accounts.host.v1.QueryRequest)
}
inline PROTOBUF_NDEBUG_INLINE QueryRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::ibc::applications::interchain_accounts::host::v1::QueryRequest& from_msg)
...
QueryRequest::QueryRequest(
  ...
  // @@protoc_insertion_point(copy_constructor:ibc.applications.interchain_accounts.host.v1.QueryRequest)
}
inline PROTOBUF_NDEBUG_INLINE QueryRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
QueryRequest::~QueryRequest() {
  // @@protoc_insertion_point(destructor:ibc.applications.interchain_accounts.host.v1.QueryRequest)
  SharedDtor(*this);
}
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<1, 2, 0, 70, 2> QueryRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    2, 8,  // max_field_number, fast_idx_mask
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::ibc::applications::interchain_accounts::host::v1::QueryRequest>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // bytes data = 2 [json_name = "data"];
    {::_pbi::TcParser::FastBS1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(QueryRequest, _impl_.data_)}},
    // string path = 1 [json_name = "path"];
    {::_pbi::TcParser::FastUS1,
     {10, 63, 0, PROTOBUF_FIELD_OFFSET(QueryRequest, _impl_.path_)}},
  }}, {{
    65535, 65535
  }}, {{
    // string path = 1 [json_name = "path"];
    {PROTOBUF_FIELD_OFFSET(QueryRequest, _impl_.path_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // bytes data = 2 [json_name = "data"];
    {PROTOBUF_FIELD_OFFSET(QueryRequest, _impl_.data_), 0, 0,
...
// @@protoc_insertion_point(message_clear_start:ibc.applications.interchain_accounts.host.v1.QueryRequest)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* QueryRequest::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:ibc.applications.interchain_accounts.host.v1.QueryRequest)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          if (!this_._internal_path().empty()) {
            ...
            ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
                _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "ibc.applications.interchain_accounts.host.v1.QueryRequest.path");
          ...
          // @@protoc_insertion_point(serialize_to_array_end:ibc.applications.interchain_accounts.host.v1.QueryRequest)
          return target;
        }
        ...
        ::size_t QueryRequest::ByteSizeLong() const {
          const QueryRequest& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:ibc.applications.interchain_accounts.host.v1.QueryRequest)
          ::size_t total_size = 0;
...
void QueryRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:ibc.applications.interchain_accounts.host.v1.QueryRequest)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:ibc.applications.interchain_accounts.host.v1.QueryRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fhost_2eproto),
         ::std::false_type{});
