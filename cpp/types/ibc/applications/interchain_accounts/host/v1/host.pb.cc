...
static ::_pb::Metadata file_level_metadata_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fhost_2eproto[2];
...
::uint8_t* Params::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_allow_messages_size(); i < n; ++i) {
    const auto& s = this->_internal_allow_messages().Get(i);
...
// @@protoc_insertion_point(message_byte_size_start:ibc.applications.interchain_accounts.host.v1.Params)
  ...
  // repeated string allow_messages = 2 [json_name = "allowMessages"];
  total_size += 1 * ::google::protobuf::internal::FromIntSize(_internal_allow_messages().size());
...
QueryRequest::QueryRequest(const QueryRequest& from) : ::google::protobuf::Message() {
...
const ::google::protobuf::Message::ClassData QueryRequest::_class_data_ = {
    ::google::protobuf::Message::CopyWithSourceCheck,
    QueryRequest::MergeImpl
};
const ::google::protobuf::Message::ClassData*QueryRequest::GetClassData() const { return &_class_data_; }


void QueryRequest::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
...
PROTOBUF_NOINLINE bool QueryRequest::IsInitialized() const {
  return true;
}
...
::google::protobuf::Metadata QueryRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fhost_2eproto_getter, &descriptor_table_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fhost_2eproto_once,
      file_level_metadata_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fhost_2eproto[1]);
}
