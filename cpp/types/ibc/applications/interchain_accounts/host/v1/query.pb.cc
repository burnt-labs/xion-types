...
const ::uint32_t
    TableStruct_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fquery_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fquery_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fquery_2eproto = {
    false,
    false,
    609,
...
const ::_pbi::TcParseTable<0, 0, 0, 0, 2> QueryParamsRequest::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::ibc::applications::interchain_accounts::host::v1::QueryParamsRequest>(),  // to_prefetch
...
inline PROTOBUF_NDEBUG_INLINE QueryParamsResponse::Impl_::Impl_(
    ...
    const Impl_& from, const ::ibc::applications::interchain_accounts::host::v1::QueryParamsResponse& from_msg)
...
const ::_pbi::TcParseTable<0, 1, 1, 0, 2> QueryParamsResponse::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::ibc::applications::interchain_accounts::host::v1::QueryParamsResponse>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_ibc_2fapplications_2finterchain_5faccounts_2fhost_2fv1_2fquery_2eproto),
         ::std::false_type{});
