...
class MsgTransfer final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ibc.applications.transfer.v1.MsgTransfer) */ {
 public:
  inline MsgTransfer() : MsgTransfer(nullptr) {}
  ~MsgTransfer() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR MsgTransfer(::google::protobuf::internal::ConstantInitialized);
  ...
  MsgTransfer* New(::google::protobuf::Arena* arena = nullptr) const final {
 ...
 private:
  ...
  static const ::google::protobuf::internal::TcParseTable<4, 9, 2, 108, 2> _table_;
...
class MsgTransferResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ibc.applications.transfer.v1.MsgTransferResponse) */ {
 public:
  inline MsgTransferResponse() : MsgTransferResponse(nullptr) {}
  ~MsgTransferResponse() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR MsgTransferResponse(::google::protobuf::internal::ConstantInitialized);
  ...
  MsgTransferResponse* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class MsgUpdateParams final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ibc.applications.transfer.v1.MsgUpdateParams) */ {
 public:
...
class MsgUpdateParamsResponse final :
    public ::google::protobuf::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:ibc.applications.transfer.v1.MsgUpdateParamsResponse) */ {
 public:
...
inline std::string* MsgTransfer::mutable_encoding() {
