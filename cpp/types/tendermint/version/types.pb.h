...
class App final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tendermint.version.App) */ {
 public:
...
class Consensus final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tendermint.version.Consensus) */ {
 public:
  inline Consensus() : Consensus(nullptr) {}
  ~Consensus() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR Consensus(::google::protobuf::internal::ConstantInitialized);
  ...
  Consensus* New(::google::protobuf::Arena* arena = nullptr) const final {
