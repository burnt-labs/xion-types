...
PublicKey::PublicKey(const PublicKey& from) : ::google::protobuf::Message() {
...
const char* PublicKey::_InternalParse(
...
const ::google::protobuf::Message::ClassData PublicKey::_class_data_ = {
    ::google::protobuf::Message::CopyWithSourceCheck,
    PublicKey::MergeImpl
};
const ::google::protobuf::Message::ClassData*PublicKey::GetClassData() const { return &_class_data_; }


void PublicKey::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
...
PROTOBUF_NOINLINE bool PublicKey::IsInitialized() const {
  return true;
}
