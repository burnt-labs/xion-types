...
class InterfaceDescriptor final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos_proto.InterfaceDescriptor) */ {
 public:
...
class ScalarDescriptor final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cosmos_proto.ScalarDescriptor) */ {
 public:
  inline ScalarDescriptor() : ScalarDescriptor(nullptr) {}
  ~ScalarDescriptor() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR ScalarDescriptor(::google::protobuf::internal::ConstantInitialized);
  ...
  ScalarDescriptor* New(::google::protobuf::Arena* arena = nullptr) const final {
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable ::google::protobuf::internal::CachedSize _field_type_cached_byte_size_;
    ::google::protobuf::internal::ArenaStringPtr name_;
    ::google::protobuf::internal::ArenaStringPtr description_;
    mutable ::google::protobuf::internal::CachedSize _cached_size_;
    PROTOBUF_TSAN_DECLARE_MEMBER
...
inline const ::google::protobuf::RepeatedField<int>& ScalarDescriptor::_internal_field_type() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
